...
if data.actor_user_id == UserCheck and tonumber(TheFRADM) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if not Redis:get(TheFRADM.."gdbye"..data.chat_id) then
if data.actor_user_id == UserCheck and tonumber(TheFRADM) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if data.new_chat_member.member_id.user_id == tonumber(TheFRADM) or data.old_chat_member.member_id.user_id == tonumber(TheFRADM) then
...
--code start
if Redis:sismember(TheFRADM..'Black:listBan:',chat_id) then ---check if ban
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheFRADM..'FRADM:Num:Add:Bot') or 0)) then
send(chat_id,0,'• عدد الاعضاء قليل لا يمكن تفعيل القروب\n يجب ان يكون اكثر من '..Redis:get(TheFRADM..'FRADM:Num:Add:Bot'),"md",true)
bot.leaveChat(chat_id)
end---end check if count is true
if not Redis:get(TheFRADM.."FRADM:BotFree") then
return send(chat_id,0,"\n⇜ الوضع الخدمي تم تعطيله من قبل مطور البوت ","md",true)  
end
if not Redis:sismember(TheFRADM.."FRADM:ChekBotAdd", chat_id) then ---done active
...
-----
Redis:set(TheFRADM.."FRADM:Alzwag:Chat"..chat_id,"true")
Redis:set(TheFRADM.."FRADM:Aldel:Chat"..chat_id,"true")
Redis:set(TheFRADM.."NSFW:"..chat_id,"true")
Redis:set(TheFRADM..'tagallgroup'..chat_id,'open') 
Redis:set(TheFRADM.."FRADM:Status:Link"..chat_id,true) 
Redis:set(TheFRADM.."FRADM:Status:Games"..chat_id,true) 
Redis:set(TheFRADM.."replayallbot"..chat_id,true)
Redis:set(TheFRADM.."rebomsg"..chat_id,true)
Redis:set(TheFRADM.."FRADM:AlThther:Chat"..chat_id,"true")
Redis:set(TheFRADM.."FRADM:Status:Welcome"..chat_id,true) 
Redis:set(TheFRADM.."FRADM:AlThther:Chat"..chat_id,"true")
Redis:set(TheFRADM..'tagall@all'..chat_id,'open') 
Redis:set(TheFRADM.."FRADM:Status:IdPhoto"..chat_id,true) 
Redis:del(TheFRADM.."spammkick"..chat_id)
Redis:set(TheFRADM.."FRADM:Lock:edit"..chat_id,true) 
Redis:sadd(TheFRADM.."FRADM:ChekBotAdd",chat_id)
Redis:set(TheFRADM.."FRADM:Status:Id"..chat_id,true)
Redis:set(TheFRADM.."FRADM:Status:Reply"..chat_id,true)
Redis:set(TheFRADM.."FRADM:Status:ReplySudo"..chat_id,true)
Redis:set(TheFRADM.."FRADM:Status:BanId"..chat_id,true)
Redis:set(TheFRADM.."FRADM:Status:SetId"..chat_id,true) 
-----
...
Redis:sadd(TheFRADM.."FRADM:TheBasicsQ:Group"..chat_id ,v.member_id.user_id) 
else
Redis:sadd(TheFRADM.."FRADM:Addictive:Group"..chat_id ,v.member_id.user_id) 
end
end
end
-----
...
local inget = Redis:get(TheFRADM..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(TheFRADM..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(TheFRADM..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:srem(TheFRADM.."FRADM:ChekBotAdd",'-100'..data.supergroup.id)
...
Redis:sadd(TheFRADM.."FRADM:all:sticker"..msg.chat_id, msg.id)
Redis:scard(TheFRADM.."FRADM:all:sticker"..msg.chat_id)  
end
if msg.content.video_note or msg.content.video then
Redis:sadd(TheFRADM.."FRADM:all:video"..msg.chat_id, msg.id)
Redis:scard(TheFRADM.."FRADM:all:video"..msg.chat_id)  
end
if msg.content.document then
Redis:sadd(TheFRADM.."FRADM:all:docu"..msg.chat_id, msg.id)
Redis:scard(TheFRADM.."FRADM:all:docu"..msg.chat_id)  
end
if msg.content.audio then
Redis:sadd(TheFRADM.."FRADM:all:audio"..msg.chat_id, msg.id)
Redis:scard(TheFRADM.."FRADM:all:audio"..msg.chat_id)  
end
if msg.content.voice_note then
Redis:sadd(TheFRADM.."FRADM:all:voice"..msg.chat_id, msg.id)
Redis:scard(TheFRADM.."FRADM:all:voice"..msg.chat_id)  
end
if msg.content.photo then
Redis:sadd(TheFRADM.."FRADM:all:photo"..msg.chat_id, msg.id)
Redis:scard(TheFRADM.."FRADM:all:photo"..msg.chat_id)  
end
if msg.content.animation then
Redis:sadd(TheFRADM.."FRADM:all:anim"..msg.chat_id, msg.id)
Redis:scard(TheFRADM.."FRADM:all:anim"..msg.chat_id)  
end
if msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
Redis:sadd(TheFRADM.."FRADM:allM"..msg.chat_id, msg.id)
if Redis:get(TheFRADM.."FRADM:Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(TheFRADM.."FRADM:allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(TheFRADM.."FRADM:allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(TheFRADM.."FRADM:allM"..msg.chat_id)
...
Redis:del(TheFRADM.."FRADM:allM"..msg.chat_id)
end
end
end
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
...
if idPhoto == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheFRADM.."FRADM:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheFRADM.."FRADM:Lock:tagservr"..data.message.chat_id) then
bot.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender_user_id) == tonumber(TheFRADM) then
return false
end
if chat_type(data.message.chat_id) == "GroupBot" and Redis:sismember(TheFRADM.."FRADM:ChekBotAdd",data.message.chat_id) then
 msg = data.message
...
if tonumber(msg.sender_id.user_id) == tonumber(TheFRADM) then
print('This is reply for Bot')
return false
end
if msg.sender_id.luatele == "messageSenderChat" then
if Redis:sismember(TheFRADM.."FRADM:SilentGroup:Group"..msg_chat_id,msg.sender_id.chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if Redis:get(TheFRADM.."FRADM:Lock:SenderChat"..msg_chat_id) then
local m = Redis:get(TheFRADM.."chadmin"..msg_chat_id) 
...
elseif Redis:sismember(TheFRADM.."FRADM:DevelopersQ:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️️'
elseif Redis:sismember(TheFRADM.."FRADM:Developers:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(TheFRADM.."FRADM:MalekAsase:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 444
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheFRADM.."FRADM:TheBasicsQ:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheFRADM.."FRADM:TheBasics:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheFRADM.."FRADM:Originators:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(TheFRADM.."FRADM:Managers:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(TheFRADM.."FRADM:Addictive:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(TheFRADM.."FRADM:Distinguished:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:Vip:Group:Reply"..msg.chat_id) or 'مميز'
elseif tonumber(msg.sender_id.user_id) == tonumber(TheFRADM) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheFRADM..'FRADM:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(TheFRADM.."FRADM:Mempar:Group:Reply"..msg.chat_id) or 'عضو'
end  
...
if Message_Edit.sender_id.user_id == TheFRADM then
...
data.The_Controller = 1
elseif Redis:sismember(TheFRADM.."FRADM:DevelopersQ:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(TheFRADM.."FRADM:Developers:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(TheFRADM.."FRADM:TheBasicsQ:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(TheFRADM.."FRADM:TheBasics:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(TheFRADM.."FRADM:Originators:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(TheFRADM.."FRADM:Managers:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(TheFRADM.."FRADM:Addictive:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(TheFRADM.."FRADM:Distinguished:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender_id.user_id) == tonumber(TheFRADM) then
...
local monsha = Redis:smembers(TheFRADM.."FRADM:TheBasicsQ:Group"..data.chat_id) 
Redis:incr(TheFRADM..'FRADM:Num:Message:Edit'..data.chat_id..Message_Edit.sender_id.user_id)
if Message_Edit.content.luatele == "messageText" then
if Redis:get(TheFRADM.."FRADM:Lock:edittext"..data.chat_id) then
if not data.Distinguished then
bot.deleteMessages(data.chat_id,{[1]= data.message_id})
if Redis:get(TheFRADM..'FRADM:AlThther:Chat'..data.chat_id)  then
local UserInfo = bot.getUser(Message_Edit.sender_id.user_id)
...
if not data.Originators and Message_Edit.sender_id.user_id ~= tonumber(TheFRADM) then
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheFRADM.."FRADM:Lock:edit"..data.chat_id) then
if #monsha ~= 0 then 
...
data.The_Controller = 1
elseif Redis:sismember(TheFRADM.."FRADM:DevelopersQ:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(TheFRADM.."FRADM:Developers:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(TheFRADM.."FRADM:TheBasicsQ:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(TheFRADM.."FRADM:TheBasics:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(TheFRADM.."FRADM:Originators:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(TheFRADM.."FRADM:Managers:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(TheFRADM.."FRADM:Addictive:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(TheFRADM.."FRADM:Distinguished:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(TheFRADM) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
local get = Redis:get(TheFRADM..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(TheFRADM..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(TheFRADM..IdUser..ChatId.."num")
if math then
...
Redis:del(TheFRADM..IdUser..ChatId.."num")
else
bot.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(TheFRADM..IdUser..ChatId.."num",gxx)
...
local chat_id = Redis:get(TheFRADM.."hms:"..anubis[2].."chat_id")
local to_id = Redis:get(TheFRADM.."hms:"..anubis[2].."to")
local msg_id = Redis:get(TheFRADM.."hms:"..anubis[2].."msg_id")
...
Redis:del(TheFRADM.."hms:"..anubis[1])
end
end
if Text and Text:match('(.*)hms_no(.*)') then
local anubis = {Text:match('(.*)hms_no(.*)')}
if tonumber(IdUser) == tonumber(anubis[1]) then
Redis:del(TheFRADM.."hms:"..anubis[2].."chat_id")
Redis:del(TheFRADM.."hms:"..anubis[2].."to")
Redis:del(TheFRADM.."hms:"..anubis[2].."msg_id")
Redis:del(TheFRADM.."hms:"..anubis[1])
...
local hmsa = Redis:get(TheFRADM.."hms:"..anubis[3].."text:")
...
var(UserId)
Redis:set(TheFRADM.."zogte"..ChatId..UserId[1],UserId[2])
Redis:set(TheFRADM.."zogte"..ChatId..UserId[2],UserId[1])
Redis:sadd(TheFRADM.."zogatall"..ChatId,UserId[1])
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(TheFRADM.."zogte"..ChatId..UserId[1])
Redis:del(TheFRADM.."zogte"..ChatId..UserId[2])
Redis:srem(TheFRADM.."zogatall"..ChatId,UserId[1])
local UserInfo = bot.getUser(UserId[1])
...
Redis:srem(TheFRADM.."FRADM:Distinguished:Group"..ChatId,IdUser)
Redis:srem(TheFRADM.."FRADM:Addictive:Group"..ChatId,IdUser)
Redis:srem(TheFRADM.."FRADM:Managers:Group"..ChatId,IdUser)
Redis:srem(TheFRADM.."FRADM:Originators:Group"..ChatId,IdUser)
Redis:srem(TheFRADM.."FRADM:TheBasics:Group"..ChatId,IdUser)
Redis:srem(TheFRADM.."FRADM:Developers:Groups",IdUser) 
Redis:srem(TheFRADM.."FRADM:TheBasicsQ:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TheFRADM.."FRADM:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(TheFRADM.."FRADM:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(TheFRADM.."FRADM:TheBasics:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(TheFRADM.."FRADM:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(TheFRADM.."FRADM:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(TheFRADM.."FRADM:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TheFRADM.."FRADM:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(TheFRADM.."FRADM:Managers:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(TheFRADM.."FRADM:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(TheFRADM.."FRADM:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TheFRADM.."FRADM:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(TheFRADM.."FRADM:Addictive:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(TheFRADM.."FRADM:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(TheFRADM.."FRADM:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(TheFRADM.."FRADM:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(TheFRADM.."FRADM:Distinguished:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(TheFRADM.."FRADM:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(TheFRADM.."FRADM:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(TheFRADM.."FRADM:Originators:Group"..ChatId,UserId[2])
Redis:srem(TheFRADM.."FRADM:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(TheFRADM.."FRADM:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(TheFRADM.."FRADM:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(TheFRADM.."FRADM:BanGroup:Group"..ChatId,UserId[2])
bot.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
if not data.Originators and not Redis:get(TheFRADM.."FRADM:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(TheFRADM.."FRADM:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(TheFRADM.."FRADM:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
if Text and Text:match('/keyhzr') then
local list = Redis:smembers(TheFRADM..'List_hzr'..ChatId) 
nameko = list[#list]
playerhzr = Redis:get(TheFRADM..'playerhzr'..ChatId)
klmahzr = Redis:get(TheFRADM..'klmahzr'..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM.."FRADM:Command:Reids:Group:Del"..ChatId..":"..IdUser)
Redis:del(TheFRADM.."FRADM:Command:Reids:Group"..ChatId..":"..IdUser)
Redis:del(TheFRADM.."FRADM:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."FRADM:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."FRADM:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."FRADM:Set:On"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:array"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:On"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Rd:mz"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Onmzch"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Rdmzch"..IdUser..":"..ChatId)
Redis:del(TheFRADM.."Set:Manager:rd:inline3am"..IdUser..":"..ChatId)
...
if Redis:get(TheFRADM..'Set:arrayy'..IdUser..':'..ChatId) == 'true1' then
Redis:del(TheFRADM..'Set:arrayy'..IdUser..':'..ChatId)
...
if Redis:get(TheFRADM..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(TheFRADM..'Set:array'..IdUser..':'..ChatId)
edit(ChatId,Msg_id,"⇜ تم حفظ الردود ", 'md', true, false, reply_markup)
else
edit(ChatId,Msg_id,"⇜ تم تنفيذ الامر سابقاًً", 'md', true, false, reply_markup)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM.."trfeh"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM.."spammkick"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM.."kadmeat"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM.."knele"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM.."brjj"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM..'lock_geamsAudio1'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM..'lock_geamsAudio'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM..'tagall@all'..ChatId,'open')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheFRADM..'lock_chengname'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM.."trfeh"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM.."spammkick"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM.."kadmeat"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM.."knele"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM.."brjj"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM..'lock_geamsAudio1'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM..'lock_geamsAudio'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM..'tagall@all'..ChatId,'close')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheFRADM..'lock_chengname'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:incrby(TheFRADM.."FRADM:Num:Add:Games"..ChatId..IdUser,3)  
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(TheFRADM.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(TheFRADM.."meza:type"..meza_name, "photo")
Redis:sadd(TheFRADM.."meza:names:", meza_name)
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(TheFRADM.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(TheFRADM.."meza:type"..meza_name, "video")
Redis:sadd(TheFRADM.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(TheFRADM.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(TheFRADM.."meza:type"..meza_name, "audio")
Redis:sadd(TheFRADM.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(TheFRADM.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(TheFRADM.."meza:type"..meza_name, "animation")
Redis:sadd(TheFRADM.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(TheFRADM.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(TheFRADM.."meza:type"..meza_name, "sticker")
Redis:sadd(TheFRADM.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
if Text == '/joineloceagin' then
local list = Redis:smembers(TheFRADM..'loce:list'..ChatId) 
...
Redis:set(TheFRADM..'loce:listset1'..ChatId,xxffxx1)
Redis:srem(TheFRADM..'loce:list'..ChatId,name1)
Redis:incrby(TheFRADM.."FRADM:Num:Add:Games"..ChatId..name1,3)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local get1 = Redis:get(TheFRADM..'loce:listset'..ChatId)
local get2 = Redis:get(TheFRADM..'loce:listset1'..ChatId)

Redis:del(TheFRADM..'loce:list'..ChatId) 
Redis:del(TheFRADM..'loce:listset'..ChatId)
Redis:del(TheFRADM..'loce:listset1'..ChatId)
return edit(ChatId,Msg_id,get1..'\n'..get2..'\n'..xxffxx1..'\n', 'md', true)
end
if Text == '/joineloce' then
if not Redis:sismember(TheFRADM..'loce:list'..ChatId,IdUser) then 
Redis:sadd(TheFRADM..'loce:list'..ChatId,IdUser)
local list = Redis:smembers(TheFRADM..'loce:list'..ChatId) 
if #list == 3 then
name1 = list[math.random(#list)]
local UserInfo1 = bot.getUser(name1)
...
Redis:set(TheFRADM..'loce:listset'..ChatId,xxffxx1)
Redis:srem(TheFRADM..'loce:list'..ChatId,name1)
Redis:incrby(TheFRADM.."FRADM:Num:Add:Games"..ChatId..name1,5)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(TheFRADM..'rolet:list'..ChatId)
name = list[math.random(#list)]
local UserInfo = bot.getUser(name)
local Teext = '- ['..UserInfo.first_name..'](tg://user?id='..name..')'
Redis:srem(TheFRADM..'rolet:list'..ChatId,name)
if #list == 1 then
Redis:srem(TheFRADM..'rolet:list'..ChatId,name)
Redis:incrby(TheFRADM.."FRADM:Num:Add:Games"..ChatId..IdUser,10)  
...
if not Redis:sismember(TheFRADM..'rolet:list'..ChatId,IdUser) then 
Redis:sadd(TheFRADM..'rolet:list'..ChatId,IdUser)
local list = Redis:smembers(TheFRADM..'rolet:list'..ChatId) 
if #list == 3 then
...
Redis:sadd(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,GetUserReply[1]) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(GetUserReply[1])
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply[1]..')'
Redis:sadd(TheFRADM.."FRADM:BanGroup:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(TheFRADM.."FRADM:Distinguished:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(TheFRADM.."FRADM:BanGroup:Group"..ChatId,GetUserReply[1]) 
Redis:srem(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,GetUserReply[1]) 
...
if Redis:sismember(TheFRADM.."FRADM:Num:okiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(TheFRADM.."FRADM:Num:okiktm"..ChatId, IdUser)  
local list = Redis:smembers(TheFRADM.."FRADM:Num:okiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(TheFRADM.."FRADM:Num:okiktm"..ChatId)
...
Redis:sadd(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,GetUserReply) 
end
...
local UserInfo = bot.getUser(GetUserReply)
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply..')'
if Redis:sismember(TheFRADM.."FRADM:Num:noiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(TheFRADM.."FRADM:Num:noiktm"..ChatId, IdUser)  
local list = Redis:smembers(TheFRADM.."FRADM:Num:noiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(TheFRADM.."FRADM:Num:noiktm"..ChatId)
Redis:srem(TheFRADM.."FRADM:SilentGroup:Group"..ChatId,GetUserReply) 
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    ...
    Redis:set(TheFRADM..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(TheFRADM..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(TheFRADM..ChatId..IdUser.."zkrf:", "zeng")
...
if name == "✂" then
Redis:incrby(TheFRADM.."FRADM:Num:Add:Games"..ChatId..IdUser, 1)  
...
if Redis:get(TheFRADM.."zwag_request:"..Data[1]) then
...
ballancee = Redis:get(TheFRADM.."boob"..zwg_id) or 0
ballanceea = Redis:get(TheFRADM.."boob"..zwga_id) or 0
zogtea = ballanceea + ballanceekkk
zeugh = ballancee - tonumber(coniss)
Redis:set(TheFRADM.."boob"..zwg_id , math.floor(zeugh))
Redis:sadd(TheFRADM.."roogg1",zwg_id)
Redis:sadd(TheFRADM.."roogga1",zwga_id)
Redis:set(TheFRADM.."roog1"..zwg_id,zwg_id)
Redis:set(TheFRADM.."rooga1"..zwg_id,zwga_id)
Redis:set(TheFRADM.."roogte1"..zwga_id,zwga_id)
Redis:set(TheFRADM.."rahr1"..zwg_id,tonumber(coniss))
Redis:set(TheFRADM.."rahr1"..zwga_id,tonumber(coniss))
Redis:set(TheFRADM.."roog1"..zwga_id,zwg_id)
Redis:set(TheFRADM.."rahrr1"..zwg_id,math.floor(ballanceekkk))
Redis:set(TheFRADM.."rooga1"..zwga_id,zwga_id)
Redis:set(TheFRADM.."rahrr1"..zwga_id,math.floor(ballanceekkk))
...
Redis:del(TheFRADM.."zwag_request:"..UserId[1])
Redis:del(TheFRADM.."zwag_request:"..UserId[2])
...
if Redis:ttl(TheFRADM.."deletbank" .. 111) >= 1036800 then
day = "13 يوم"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 950400 then
day = "12 يوم"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 864000 then
day = "11 يوم"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 777600 then
day = "10 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 691200 then
day = "9 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 604800 then
day = "8 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 518400 then
day = "7 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 432000 then
day = "6 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 345600 then
day = "5 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 259200 then
day = "4 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 172800 then
day = "3 ايام"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) >= 86400 then
day = "يومان"
elseif Redis:ttl(TheFRADM.."deletbank" .. 111) <= 86400 then
day = "يوم واحد"
else
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
local bank_users = Redis:smembers(TheFRADM.."ownernade")
...
local mony = Redis:get(TheFRADM.."nokatnade"..v) or 0
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(TheFRADM.."lkbnade"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
kk = kk:gsub("#[%a%d_]+",'')
local mony = v[1]
local doltebank = Redis:get(TheFRADM.."doltebank"..v[2]) or " "
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
local bank_users = Redis:smembers(TheFRADM.."ownerfram")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheFRADM.."toplvfarm"..v) or 0
table.insert(mony_listd, {tonumber(mony) , v})
end
table.sort(mony_listd, function(a, b) return a[1] > b[1] end)
num = 1
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(TheFRADM.."namefram"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
Redis:set(TheFRADM..data.sender_user_id.."first_name:", F_Name)
...
ballancee = Redis:get(TheFRADM.."tabbroat"..data.sender_user_id) or 0
local bank_users = Redis:smembers(TheFRADM.."taza")
if #bank_users == 0 then
...
tabr_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheFRADM.."tabbroat"..v)
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
  local zwag_users = Redis:smembers(TheFRADM.."roogg1")
  ...
  local mahr = Redis:get(TheFRADM.."rahr1"..v)
  local zwga = Redis:get(TheFRADM.."rooga1"..v)
...
"30)"
  ...
  local zwga_name = bot.getUser(v[3]).first_name or Redis:get(TheFRADM..v[3].."first_name:") or "لا يوجد اسم"
...
kk = kk:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(TheFRADM.."doltebank"..v[2]) or " "
local doltebankz = Redis:get(TheFRADM.."doltebank"..v[3]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
...
zrfee = Redis:get(TheFRADM.."rrfff"..data.sender_user_id) or 0
local ty_users = Redis:smembers(TheFRADM.."rrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(TheFRADM.."rrfff"..v)
...
ballancee = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local bank_users = Redis:smembers(TheFRADM.."booob")
if #bank_users == 0 then
return send(ChatId,Msg_id,"⇜ لا يوجد حسابات في البنك","md",true)
end
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheFRADM.."boob"..v)
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
doltebank = "🇸🇾"
Redis:set(TheFRADM.."doltebank"..data.sender_user_id,doltebank)
cccall = Redis:get(TheFRADM.."boobb"..data.sender_user_id)
ccctype = Redis:get(TheFRADM.."bbobb"..data.sender_user_id)
shakse = Redis:get(TheFRADM.."shkse"..data.sender_user_id)
if shakse == "طيبة" then
shakseshakse = "طيبة 😇"
else
shakseshakse = "شريرة 😈"
...
Redis:del(TheFRADM..'SetChannelVip'..IdUser)
...
Redis:set(TheFRADM..'SetChannelVip'..IdUser,true)
...
if Redis:get(TheFRADM..'SetChannelVip'..IdUser) then 
if text =='الغاء' then 
...
Redis:del(TheFRADM..'SetChannelVip'..IdUser)
Redis:set(TheFRADM..'SOFI:Channel:Vip'..IdUser,text)
...
Redis:del(TheFRADM..'SOFI:Channel:Vip'..IdUser)
Text = "⇜ تم حذف قناتك"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
shakse = "طيبة"
Redis:set(TheFRADM.."shkse"..data.sender_user_id,shakse)
ttshakse = '⇜ اختر دولتك'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
Redis:set(TheFRADM.."bobna"..data.sender_user_id,news)
Redis:set(TheFRADM.."boob"..data.sender_user_id,balas)
Redis:set(TheFRADM.."boobb"..data.sender_user_id,creditcc)
Redis:set(TheFRADM.."bbobb"..data.sender_user_id,mast)
Redis:set(TheFRADM.."boballname"..creditcc,news)
Redis:set(TheFRADM.."boballbalc"..creditcc,balas)
Redis:set(TheFRADM.."boballcc"..creditcc,creditcc)
Redis:set(TheFRADM.."boballban"..creditcc,mast)
Redis:set(TheFRADM.."boballid"..creditcc,banid)
Redis:sadd(TheFRADM.."booob",data.sender_user_id)
...
Redis:set(TheFRADM.."bobna"..data.sender_user_id,news)
Redis:set(TheFRADM.."boob"..data.sender_user_id,balas)
Redis:set(TheFRADM.."boobb"..data.sender_user_id,creditvi)
Redis:set(TheFRADM.."bbobb"..data.sender_user_id,visssa)
Redis:set(TheFRADM.."boballname"..creditvi,news)
Redis:set(TheFRADM.."boballbalc"..creditvi,balas)
Redis:set(TheFRADM.."boballcc"..creditvi,creditvi)
Redis:set(TheFRADM.."boballban"..creditvi,visssa)
Redis:set(TheFRADM.."boballid"..creditvi,banid)
Redis:sadd(TheFRADM.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
Redis:set(TheFRADM.."bobna"..data.sender_user_id,news)
Redis:set(TheFRADM.."boob"..data.sender_user_id,balas)
Redis:set(TheFRADM.."boobb"..data.sender_user_id,creditex)
Redis:set(TheFRADM.."bbobb"..data.sender_user_id,exprs)
Redis:set(TheFRADM.."boballname"..creditex,news)
Redis:set(TheFRADM.."boballbalc"..creditex,balas)
Redis:set(TheFRADM.."boballcc"..creditex,creditex)
Redis:set(TheFRADM.."boballban"..creditex,exprs)
Redis:set(TheFRADM.."boballid"..creditex,banid)
Redis:sadd(TheFRADM.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
cccall = Redis:get(TheFRADM.."tdbelballance"..data.sender_user_id) or 0
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
if tonumber(ballance) < tonumber(cccall) then
return edit(ChatId,Msg_id, "⇜ فلوسك ماتكفي","md",true)
end
Redis:setex(TheFRADM.."iioood" .. data.sender_user_id,920, true)
local list = {"1", "2", "3"}
local rand = list[math.random(#list)]
if rand == "1" then -- 1 con
cccallcc = tonumber(ballance) + tonumber(cccall)
Redis:set(TheFRADM.."boob"..data.sender_user_id,cccallcc)
Redis:del(TheFRADM.."tdbelballance"..data.sender_user_id)
...
cccallcc = tonumber(ballance) - tonumber(cccall)
Redis:set(TheFRADM.."boob"..data.sender_user_id,cccallcc)
cccall = Redis:get(TheFRADM.."tdbelballance"..data.sender_user_id)
Redis:del(TheFRADM.."tdbelballance"..data.sender_user_id)
local convert_mony = string.format("%.0f",cccall)
local convert_monyy = string.format("%.0f",cccallcc)
msalm = "⌯ خسرت بالسحب ☹️\n\n⇜ المبلغ : "..convert_mony.."\nرصيدك الان : `"..convert_monyy.."`\n✧"
...
Redis:set(TheFRADM.."boob"..data.sender_user_id,cccallcc)
namefram = Redis:get(TheFRADM.."namefram"..data.sender_user_id)
Redis:sadd(TheFRADM.."farmarname", namefram)
Redis:set(TheFRADM.."sizefram"..data.sender_user_id,50000)
Redis:sadd(TheFRADM.."ownerfram",data.sender_user_id)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
...
namefram = Redis:get(TheFRADM.."namefram"..data.sender_user_id)
Redis:sadd(TheFRADM.."farmarname", namefram)
Redis:set(TheFRADM.."sizefram"..data.sender_user_id,100000)
Redis:sadd(TheFRADM.."ownerfram",data.sender_user_id)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 8×8\n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(TheFRADM.."namefram"..data.sender_user_id)
Redis:sadd(TheFRADM.."farmarname", namefram)
Redis:set(TheFRADM.."sizefram"..data.sender_user_id,200000)
Redis:sadd(TheFRADM.."ownerfram",data.sender_user_id)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 12×12\n⇜ السعر : 1000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(TheFRADM.."namefram"..data.sender_user_id)
Redis:sadd(TheFRADM.."farmarname", namefram)
Redis:set(TheFRADM.."sizefram"..data.sender_user_id,300000)
Redis:sadd(TheFRADM.."ownerfram",data.sender_user_id)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 16×16\n⇜ السعر : 5000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(TheFRADM.."namefram"..data.sender_user_id)
Redis:sadd(TheFRADM.."farmarname", namefram)
Redis:set(TheFRADM.."sizefram"..data.sender_user_id,400000)
Redis:sadd(TheFRADM.."ownerfram",data.sender_user_id)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 32×32\n⇜ السعر : 10000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
if Redis:get(TheFRADM.."mrkzplayer".."1"..data.sender_user_id) then
...
mrkzplayer = "مهاجم"
cityplayer = "🇺🇦 اوكرانيا"
Redis:set(TheFRADM.."nameplayer".."1"..data.sender_user_id,nameplayer)
Redis:set(TheFRADM.."energyplayer".."1"..data.sender_user_id,energyplayer)
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,39000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(TheFRADM.."mrkzplayer".."4"..data.sender_user_id) then
...
mrkzplayer = "مدافع"
cityplayer = "البرازيل 🇧🇷"
Redis:set(TheFRADM.."nameplayer".."4"..data.sender_user_id,nameplayer)
Redis:set(TheFRADM.."energyplayer".."4"..data.sender_user_id,energyplayer)
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,50000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(TheFRADM.."mrkzplayer".."3"..data.sender_user_id) then
...
Redis:set(TheFRADM.."nameplayer".."3"..data.sender_user_id,nameplayer)
Redis:set(TheFRADM.."energyplayer".."3"..data.sender_user_id,energyplayer)
Redis:set(TheFRADM.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."3"..data.sender_user_id,70000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,40000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."3"..data.sender_user_id,20000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : خوان ماتا\n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إسبانيا 🇪🇸 \n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,15000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,100000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,20000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,30000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(TheFRADM.."mrkzplayer".."5"..data.sender_user_id) then
...
mrkzplayer = "حارس"
cityplayer = "ألمانيا 🇩🇪 "
Redis:set(TheFRADM.."nameplayer".."5"..data.sender_user_id,nameplayer)
Redis:set(TheFRADM.."energyplayer".."5"..data.sender_user_id,energyplayer)
Redis:set(TheFRADM.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."5"..data.sender_user_id,110000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : تير شتيجن\n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : ألمانيا 🇩🇪 \n⇜ السعر : 110000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(TheFRADM.."mrkzplayer".."2"..data.sender_user_id) then
...
mrkzplayer = "جناح"
cityplayer = "فرنسا 🇫🇷 "
Redis:set(TheFRADM.."nameplayer".."2"..data.sender_user_id,nameplayer)
Redis:set(TheFRADM.."energyplayer".."2"..data.sender_user_id,energyplayer)
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,45000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,78000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : رودريغو\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,65000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ميليتاو\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 65000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,73000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : الابا\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : النمسا 🇦🇹 \n⇜ السعر : 73000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,180000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فينيسيوس \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 94\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 180000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,55000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دي ماريا \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 85\n⇜ الجنسية : الأرجنتين 🇦🇷 \n⇜ السعر : 55000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,38000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دانييلي \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 38000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,55000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."5"..data.sender_user_id,99000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دوناروما \n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 89\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 99000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,55000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,59000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."4"..data.sender_user_id,170000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ايدن ازارد \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 93\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 170000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,60000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فرمينو \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 86\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 60000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,19000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : جاك كلارك \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إنجلترا 🏴󠁧󠁢󠁥󠁮󠁧󠁿 \n⇜ السعر : 19000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,53000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,41000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : توريس \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 41000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."3"..data.sender_user_id,41000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."3"..data.sender_user_id,74000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."3"..data.sender_user_id,78000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : بول بوجبا \n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : فرنسا 🇫🇷 \n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."3"..data.sender_user_id,90000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."5"..data.sender_user_id,80000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."5"..data.sender_user_id,70000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."5"..data.sender_user_id,52000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."5"..data.sender_user_id,20000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."5"..data.sender_user_id,40000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."1"..data.sender_user_id,20000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,100000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : محمد صلاح\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : مصر 🇪🇬 \n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,90000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : نيمار\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 90\n⇜ الجنسية : السنغال 🇸🇳 \n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(TheFRADM.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(TheFRADM.."priceplayer".."2"..data.sender_user_id,80000)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."boob"..data.sender_user_id,cccallcc)
lkbnade = Redis:get(TheFRADM.."lkbnade"..data.sender_user_id)
Redis:sadd(TheFRADM.."lkbnadesadd", lkbnade)
namenade = "ريال مدريد"
Redis:set(TheFRADM.."namenade"..data.sender_user_id,namenade)
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,50)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,45)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : برشلونة\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 150000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,40)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : تشيلسي\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,35)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,30)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ليفربول\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 120000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,25)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,20)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,15)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : يوفنتوس\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 40000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(TheFRADM.."nokatnade"..data.sender_user_id,0)
Redis:sadd(TheFRADM.."ownernade",data.sender_user_id)
Redis:set(TheFRADM.."energynade"..data.sender_user_id,10)
ballance = Redis:get(TheFRADM.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ارسنال\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(TheFRADM.."hazrlock"..ChatId) == UserId then
if Redis:sismember(TheFRADM.."listhzerid"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ لقد انضممت الى اللعبة مسبقاً ", true)
end
if tonumber(Redis:get(TheFRADM.."hazrmalek"..ChatId)) == IdUser then
return bot.answerCallbackQuery(data.id, "⇜ انتا مالك اللعبة حاليا", true)
end
Redis:sadd(TheFRADM.."listhzerid"..ChatId, IdUser)
...
if Redis:get(TheFRADM.."soundidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(TheFRADM.."soundidche"..ChatId..IdUser)
else
Redis:del(TheFRADM.."soundidche"..ChatId..IdUser)
...
if Redis:get(TheFRADM.."youtidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(TheFRADM.."youtidche"..ChatId..IdUser)
else
Redis:del(TheFRADM.."youtidche"..ChatId..IdUser)
return edit(ChatId,Msg_id,'\n⇜ لا استطيع تحميل اكثر من 25 ميغا',"md",true)
end
...
local kk_id = Redis:get(TheFRADM.."kk_Akab"..ChatId)
if Redis:sismember(TheFRADM..'members_Ahkamm'..ChatId,IdUser) then
Redis:sadd(TheFRADM.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local kk_id = Redis:get(TheFRADM.."kk_Akab"..ChatId)
if Redis:sismember(TheFRADM..'members_Ahkamm'..ChatId,IdUser) then
Redis:srem(TheFRADM.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text = 'Louis', url = 't.me/Y88F8'},},}}
...
local ff_id = Redis:get(TheFRADM.."ff_Ahkam"..ChatId)
local kk_id = Redis:get(TheFRADM.."kk_Ahkam"..ChatId)
...
local ff_id = Redis:get(TheFRADM.."ff_Ahkkam"..ChatId)
local kk_id = Redis:get(TheFRADM.."kk_Ahkkam"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(TheFRADM.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
local kk_id = Redis:get(TheFRADM.."kk_koorsi"..ChatId)
if Redis:sismember(TheFRADM..'List_Koorsi'..ChatId,IdUser) then
Redis:sadd(TheFRADM.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local ff_id = Redis:get(TheFRADM.."ff_saraha"..ChatId)
local kk_id = Redis:get(TheFRADM.."kk_saraha"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(TheFRADM.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if not Redis:sismember(TheFRADM..'List_Aktooh'..ChatId,IdUser) then 
Redis:sadd(TheFRADM..'List_Aktooh'..ChatId,IdUser)
Redis:setex(TheFRADM.."Witting_StartGameAk"..ChatId,1400,true)
local list = Redis:smembers(TheFRADM..'List_Aktooh'..ChatId) 
if #list == 2 then
for k,v in pairs(list) do
if k == 1 then
...
if k == #list then
local Ak_Tm = Redis:get(TheFRADM.."Ak_Tmooh"..ChatId)
local ban = bot.getUser(Ak_Tm)
local AkName = '['..ban.first_name..'](tg://user?id='..ban.id..')' or 'لا يوجد اسم'
local message = '*✦┊عـدد المصـوتين ⇜*'..#list..' \n*✦┊اسمـاء المصـوتين ⇩*\n'..name1..'\n'..name2..'\n'..name3..'\n\n*✦┊المستخـدم* '..AkName..'\n*✦┊تم كتمـه .. بنجـاح ✓*'
Redis:sadd(TheFRADM.."SilentGroup:Group"..ChatId,Ak_Tm) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Unaktmooh' and Redis:get(TheFRADM.."Witting_StartGameAk"..ChatId) then
local raeaktooh = Redis:get(TheFRADM.."raeaktooh"..ChatId)
...
Redis:srem(TheFRADM.."SilentGroup:Group"..ChatId,Ak_Tm)
Redis:srem(TheFRADM..'List_Aktooh'..ChatId,UserName) 
Redis:del(TheFRADM..'raeaktooh'..ChatId) 
Redis:del(TheFRADM..'List_Aktooh'..ChatId) 
Redis:del(TheFRADM.."Witting_StartGameAk"..ChatId)
Redis:del(TheFRADM.."Start_Aktmooh"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheFRADM..'List_Ahkkam'..ChatId,IdUser) then 
Redis:sadd(TheFRADM..'List_Ahkkam'..ChatId,IdUser)
Redis:setex(TheFRADM.."Witting_StartGameeh"..ChatId,1400,true)
local list = Redis:smembers(TheFRADM..'List_Ahkkam'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
...
---------------------- Dev ZilZal ----------------------
if Text == '/startahkam' and Redis:get(TheFRADM.."Witting_StartGameeh"..ChatId) then
local rarahkam = Redis:get(TheFRADM.."raeahkkam"..ChatId)
...
Redis:set(TheFRADM.."kk_Ahkkam"..ChatId,UserId_Info.id)
Redis:srem(TheFRADM..'List_Ahkkam'..ChatId,UserName) 
local liiist = Redis:smembers(TheFRADM..'List_Ahkkam'..ChatId) 
...
Redis:set(TheFRADM.."ff_Ahkkam"..ChatId,UserId2_Info.id)
local GetLike = Redis:incrby(TheFRADM.."Num:Add:Ahkam"..ChatId..UserId2_Info.id, 5) 
Redis:hset(TheFRADM..':GroupUserCountAhkam:'..ChatId,UserId2_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(TheFRADM..':GroupAhkamNameUser:'..ChatId,UserrInfo.id,NameLUser)
Redis:del(TheFRADM..'raeahkkam'..ChatId) 
Redis:del(TheFRADM..'List_Ahkkam'..ChatId) 
Redis:del(TheFRADM.."Witting_StartGameeh"..ChatId)
Redis:del(TheFRADM.."Start_Ahkkam"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Koorsy' then
if not Redis:sismember(TheFRADM..'List_Koorsi'..ChatId,IdUser) then 
Redis:sadd(TheFRADM..'List_Koorsi'..ChatId,IdUser)
Redis:setex(TheFRADM.."Witting_StartGameek"..ChatId,1400,true)
local list = Redis:smembers(TheFRADM..'List_Koorsi'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
...
---------------------- Dev ZilZal ----------------------
if Text == '/startkoorsi' and Redis:get(TheFRADM.."Witting_StartGameek"..ChatId) then
local rarahkam = Redis:get(TheFRADM.."raekoorsi"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(TheFRADM..'List_Koorsi'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
...
Redis:set(TheFRADM.."koorsi:"..testkoorsi.."chat_id", ChatId)
Redis:set(TheFRADM.."koorsi:"..testkoorsi.."to", UserId_Info.id)
Redis:set(TheFRADM.."koorsi:"..testkoorsi.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(TheFRADM.."kk_koorsi"..ChatId,UserId_Info.id)
Redis:srem(TheFRADM..'List_Koorsi'..ChatId,UserName) 
Redis:del(TheFRADM..'raekoorsi'..ChatId) 
Redis:del(TheFRADM..'List_Koorsi'..ChatId) 
Redis:del(TheFRADM.."Witting_StartGameek"..ChatId)
Redis:del(TheFRADM.."Start_Koorsi"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheFRADM..'List_Saraha'..ChatId,IdUser) then 
