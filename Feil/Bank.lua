...
Bot_Name = (Redis:get(TheFREDM.."FREDM:Name:Bot") or "لويس")
if text and text:match('^'..Bot_Name..' ') then
text = text:gsub('^'..Bot_Name..' ','')
end
if text then
local NewCmmd = Redis:get(TheFREDM.."All:Get:Reides:Commands:Group"..text) or Redis:get(TheFREDM.."FREDM:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local bank_users = Redis:smembers(TheFREDM.."booob")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheFREDM.."boob"..v)
...
local emo = emoji[k]
num = num + 1
Redis:set(TheFREDM.."medal"..v[2],convert_mony)
Redis:set(TheFREDM.."medal2"..v[2],emo)
Redis:set(TheFREDM.."medal3"..v[2],local_time)
Redis:sadd(TheFREDM.."medalid",v[2])
Redis:set(TheFREDM.."medal"..v[2],convert_mony)
Redis:set(TheFREDM.."medal2"..v[2],emo)
Redis:set(TheFREDM.."medal3"..v[2],local_time)
Redis:sadd(TheFREDM.."medalid",v[2])
...
if msg.ControllerBot then
Redis:del(TheFREDM.."rrfffid")
Redis:del(TheFREDM.."booob")
Redis:del(TheFREDM.."taza")
Redis:del(TheFREDM.."ownerfram")
Redis:del(TheFREDM.."farmarname")
Redis:setex(TheFREDM.."deletbank" .. 111,1123200, true)
send(msg.chat_id,msg.id, "⇜ حذفت لعبه البنك 🏦","md",true)
end
end
if text == 'مسح لعبه المزرعه' then
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(TheFREDM.."booob")) do 
Redis:del(TheFREDM.."toplvfarm"..v)
Redis:del(TheFREDM.."btatatime"..v)
Redis:del(TheFREDM.."btatanum"..v)
Redis:del(TheFREDM.."btataname"..v)
Redis:del(TheFREDM.."lemontime"..v)
Redis:del(TheFREDM.."lemonnum"..v)
Redis:del(TheFREDM.."lemonname"..v)
Redis:del(TheFREDM.."khesstime"..v)
Redis:del(TheFREDM.."khessnum"..v)
Redis:del(TheFREDM.."khessname"..v)
Redis:del(TheFREDM.."kheartime"..v)
Redis:del(TheFREDM.."khearnum"..v)
Redis:del(TheFREDM.."khearname"..v)
Redis:del(TheFREDM.."jzartime"..v)
Redis:del(TheFREDM.."jzarnum"..v)
Redis:del(TheFREDM.."jzarname"..v)
Redis:del(TheFREDM.."fleflatime"..v)
Redis:del(TheFREDM.."fleflanum"..v)
Redis:del(TheFREDM.."fleflaname"..v)
Redis:del(TheFREDM.."freaztime"..v)
Redis:del(TheFREDM.."freaznum"..v)
Redis:del(TheFREDM.."freazname"..v)
Redis:del(TheFREDM.."doratime"..v)
Redis:del(TheFREDM.."doranum"..v)
Redis:del(TheFREDM.."doraname"..v)
Redis:del(TheFREDM.."tomtime"..v)
Redis:del(TheFREDM.."tomnum"..v)
Redis:del(TheFREDM.."tomname"..v)
Redis:del(TheFREDM.."ftrtime"..v)
Redis:del(TheFREDM.."ftrnum"..v)
Redis:del(TheFREDM.."ftrname"..v)
Redis:del(TheFREDM.."tfahtime"..v)
Redis:del(TheFREDM.."tfahnum"..v)
Redis:del(TheFREDM.."tfahname"..v)
Redis:del(TheFREDM.."enabtime"..v)
Redis:del(TheFREDM.."enabnum"..v)
Redis:del(TheFREDM.."enabname"..v)
Redis:del(TheFREDM.."zetontime"..v)
Redis:del(TheFREDM.."zetonnum"..v)
Redis:del(TheFREDM.."zetonname"..v)
Redis:del(TheFREDM.."mozztime"..v)
Redis:del(TheFREDM.."mozznum"..v)
Redis:del(TheFREDM.."mozzname"..v)
Redis:del(TheFREDM.."mangatime"..v)
Redis:del(TheFREDM.."manganum"..v)
Redis:del(TheFREDM.."manganame"..v)
Redis:del(TheFREDM.."sizefram"..v)
Redis:del(TheFREDM.."namefram"..v)
Redis:del(TheFREDM.."mzroatsize"..v)
end
Redis:del(TheFREDM.."ownerfram")
Redis:del(TheFREDM.."farmarname")
...
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(TheFREDM.."booob")) do 
Redis:del(TheFREDM.."namenade"..v)
Redis:del(TheFREDM.."nokatnade"..v)
Redis:del(TheFREDM.."energynade"..v)
Redis:del(TheFREDM.."traningnade"..v)
Redis:del(TheFREDM.."lkbnade"..v)
Redis:del(TheFREDM.."nameplayer".."1"..v)
Redis:del(TheFREDM.."nameplayer".."2"..v)
Redis:del(TheFREDM.."nameplayer".."3"..v)
Redis:del(TheFREDM.."nameplayer".."4"..v)
Redis:del(TheFREDM.."nameplayer".."5"..v)
Redis:del(TheFREDM.."energyplayer".."1"..v)
Redis:del(TheFREDM.."energyplayer".."2"..v)
Redis:del(TheFREDM.."energyplayer".."3"..v)
Redis:del(TheFREDM.."energyplayer".."4"..v)
Redis:del(TheFREDM.."energyplayer".."5"..v)
Redis:del(TheFREDM.."mrkzplayer".."1"..v)
Redis:del(TheFREDM.."mrkzplayer".."2"..v)
Redis:del(TheFREDM.."mrkzplayer".."3"..v)
Redis:del(TheFREDM.."mrkzplayer".."4"..v)
Redis:del(TheFREDM.."mrkzplayer".."5"..v)
Redis:del(TheFREDM.."cityplayer".."1"..v)
Redis:del(TheFREDM.."cityplayer".."2"..v)
Redis:del(TheFREDM.."cityplayer".."3"..v)
Redis:del(TheFREDM.."cityplayer".."4"..v)
Redis:del(TheFREDM.."cityplayer".."5"..v)
Redis:del(TheFREDM.."priceplayer".."1"..v)
Redis:del(TheFREDM.."priceplayer".."2"..v)
Redis:del(TheFREDM.."priceplayer".."3"..v)
Redis:del(TheFREDM.."priceplayer".."4"..v)
Redis:del(TheFREDM.."priceplayer".."5"..v)
end
Redis:del(TheFREDM.."lkbnadesadd")
Redis:del(TheFREDM.."ownernade")
...
local bank_users = Redis:smembers(TheFREDM.."booob")
for k,v in pairs(bank_users) do
Redis:del(TheFREDM.."boob"..v)
Redis:del(TheFREDM.."kreednum"..v)
Redis:del(TheFREDM.."kreed"..v)
Redis:del(TheFREDM.."rrfff"..v)
Redis:del(TheFREDM.."numattack"..v)
Redis:del(TheFREDM.."tabbroat"..v)
Redis:del(TheFREDM.."shkse"..v)
Redis:del(TheFREDM.."doltebank"..v)
Redis:del(TheFREDM.."ratbinc"..v)
Redis:del(TheFREDM.."ratbtrans"..v)
Redis:del(TheFREDM.."mgrmasname"..v)
Redis:del(TheFREDM.."mgrmasnum"..v)
Redis:del(TheFREDM.."mgrkldname"..v)
Redis:del(TheFREDM.."mgrkldnum"..v)
Redis:del(TheFREDM.."mgrswrname"..v)
Redis:del(TheFREDM.."mgrswrnum"..v)
Redis:del(TheFREDM.."mgrktmname"..v)
Redis:del(TheFREDM.."mgrktmnum"..v)
Redis:del(TheFREDM.."akrksrname"..v)
Redis:del(TheFREDM.."akrksrnum"..v)
Redis:del(TheFREDM.."akrfelname"..v)
Redis:del(TheFREDM.."akrfelnum"..v)
Redis:del(TheFREDM.."akrmnzname"..v)
Redis:del(TheFREDM.."akrmnznum"..v)
Redis:del(TheFREDM.."airshbhname"..v)
Redis:del(TheFREDM.."airshbhnum"..v)
Redis:del(TheFREDM.."airsfarname"..v)
Redis:del(TheFREDM.."airsfarnum"..v)
Redis:del(TheFREDM.."airkhasname"..v)
Redis:del(TheFREDM.."airkhasnum"..v)
Redis:del(TheFREDM.."carrangname"..v)
Redis:del(TheFREDM.."carrangnum"..v)
Redis:del(TheFREDM.."caraccename"..v)
Redis:del(TheFREDM.."caraccenum"..v)
Redis:del(TheFREDM.."carcamrname"..v)
Redis:del(TheFREDM.."carcamrnum"..v)
Redis:del(TheFREDM.."caralntrname"..v)
Redis:del(TheFREDM.."caralntrnum"..v)
Redis:del(TheFREDM.."carhilxname"..v)
Redis:del(TheFREDM.."carhilxnum"..v)
Redis:del(TheFREDM.."carsonaname"..v)
Redis:del(TheFREDM.."carsonanum"..v)
Redis:del(TheFREDM.."carcoroname"..v)
Redis:del(TheFREDM.."carcoronum"..v)
Redis:del(TheFREDM.."rotpa"..v)
Redis:del(TheFREDM.."rddd"..v)
Redis:del(TheFREDM.."rotpagrid"..v)
Redis:del(TheFREDM.."rotpaid"..v)
Redis:del(TheFREDM.."rdddgr"..v)
Redis:del(TheFREDM.."rdddid"..v)
Redis:del(TheFREDM.."rdddtex"..v)
end
for k,v in pairs(Redis:smembers(TheFREDM.."company_owners:")) do 
local Cname = Redis:get(TheFREDM.."companys_name:"..v)
Redis:del(TheFREDM.."companys_owner:"..Cname)
Redis:del(TheFREDM.."companys_id:"..Cname)
Redis:del(TheFREDM.."company:mem:"..Cname)
Redis:del(TheFREDM.."companys_name:"..v)
end
Redis:del(TheFREDM.."company_owners:")
Redis:del(TheFREDM.."companys:")
Redis:del(TheFREDM.."in_company:")
local bank_usersr = Redis:smembers(TheFREDM.."rrfffid")
for k,v in pairs(bank_usersr) do
Redis:del(TheFREDM.."boob"..v)
Redis:del(TheFREDM.."rrfff"..v)
end
for k,v in pairs(Redis:smembers(TheFREDM.."ownerfram")) do 
Redis:del(TheFREDM.."toplvfarm"..v)
Redis:del(TheFREDM.."btatatime"..v)
Redis:del(TheFREDM.."btatanum"..v)
Redis:del(TheFREDM.."btataname"..v)
...
if msg.ControllerBot then
local zwag_users = Redis:smembers(TheFREDM.."roogg1")
for k,v in pairs(zwag_users) do
Redis:del(TheFREDM.."roog1"..v)
Redis:del(TheFREDM.."rooga1"..v)
Redis:del(TheFREDM.."rahr1"..v)
Redis:del(TheFREDM.."rahrr1"..v)
Redis:del(TheFREDM.."roogte1"..v)
end
local zwaga_users = Redis:smembers(TheFREDM.."roogga1")
...
Redis:del(TheFREDM.."roogga1")
Redis:del(TheFREDM.."roogg1")
send(msg.chat_id,msg.id, "⇜ مسحت لعبه الزواج","md",true)
end
end
if text == 'ميدالياتي' or text == 'ميداليات' then

if Redis:sismember(TheFREDM.."medalid",msg.sender_id.user_id) then
local medaa2 = Redis:get(TheFREDM.."medal2"..msg.sender_id.user_id)
if medaa2 == "🥇" then
local medaa = Redis:get(TheFREDM.."medal"..msg.sender_id.user_id)
local medaa2 = Redis:get(TheFREDM.."medal2"..msg.sender_id.user_id)
local medaa3 = Redis:get(TheFREDM.."medal3"..msg.sender_id.user_id)
...
if text == Redis:get(TheFREDM..'klmahzr'..msg.chat_id) and msg.sender_id.user_id == Redis:get(TheFREDM..'playerhzr'..msg.chat_id) then
if not Redis:get(TheFREDM.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id) then
playerhzr = Redis:get(TheFREDM..'playerhzr'..msg.chat_id)
Redis:srem(TheFREDM.."FREDM:SilentGroup:Group"..msg.chat_id,playerhzr) 
Redis:del(TheFREDM.."playerhzrktm"..msg.chat_id..playerhzr)
end
end
if text and Redis:get(TheFREDM.."Start_egabahzr"..msg.chat_id) then
playerhzr = Redis:get(TheFREDM..'playerhzr'..msg.chat_id)
klmahzr = Redis:get(TheFREDM..'klmahzr'..msg.chat_id)
...
Redis:del(TheFREDM.."Start_egabahzr"..msg.chat_id)
Redis:del(TheFREDM.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id)
Redis:srem(TheFREDM.."FREDM:SilentGroup:Group"..msg.chat_id,msg.sender_id.user_id) 
send(msg.chat_id,msg.id,"「 "..news.." 」\n⇜ كفو عليك حزرت الاجابة ( "..klmahzr.." )\n⇜ تم فك الكتم عنك \n✧ ","md",true)
end
end
end

if not Redis:get(TheFREDM.."lock_getpankiuserall") or not Redis:get(TheFREDM.."lock_getpankiuser"..msg.chat_id) then
...
cobnum = tonumber(Redis:get(TheFREDM.."bandid"..msg.sender_id.user_id))
if cobnum == msg.sender_id.user_id then
return send(msg.chat_id,msg.id, "⇜ حسابك محظور من لعبة البنك","md",true)
end
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
...
Redis:srem(TheFREDM.."booob", msg.sender_id.user_id)
Redis:srem(TheFREDM.."taza", msg.sender_id.user_id)
Redis:del(TheFREDM.."boob"..msg.sender_id.user_id)
Redis:del(TheFREDM.."boobb"..msg.sender_id.user_id)
Redis:del(TheFREDM.."rrfff"..msg.sender_id.user_id)
Redis:srem(TheFREDM.."rrfffid", msg.sender_id.user_id)
Redis:srem(TheFREDM.."roogg1", msg.sender_id.user_id)
Redis:srem(TheFREDM.."roogga1", msg.sender_id.user_id)
Redis:del(TheFREDM.."roog1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."rooga1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."rahr1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."rahrr1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."tabbroat"..msg.sender_id.user_id)
Redis:del(TheFREDM.."shkse"..msg.sender_id.user_id)
Redis:del(TheFREDM.."doltebank"..msg.sender_id.user_id)
Redis:del(TheFREDM.."ratbinc"..msg.sender_id.user_id)
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrmasname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrmasnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrkldname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrkldnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrswrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrswrnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrktmname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrktmnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrksrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrksrnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrfelname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrfelnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrmnzname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrmnznum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airshbhname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airshbhnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airsfarname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airsfarnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airkhasname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airkhasnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carrangname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carrangnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."caraccename"..msg.sender_id.user_id)
Redis:del(TheFREDM.."caraccenum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carcamrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carcamrnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."caralntrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."caralntrnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carhilxname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carhilxnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carsonaname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carsonanum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carcoroname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carcoronum"..msg.sender_id.user_id)
namfra = Redis:get(TheFREDM.."namefram"..msg.sender_id.user_id)
Redis:del(TheFREDM.."toplvfarm"..msg.sender_id.user_id)
Redis:del(TheFREDM.."btatatime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."btatanum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."btataname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."lemontime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."lemonnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."lemonname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."khesstime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."khessnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."khessname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."kheartime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."khearnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."khearname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."jzartime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."jzarnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."jzarname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."fleflatime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."fleflanum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."fleflaname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."freaztime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."freaznum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."freazname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."doratime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."doranum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."doraname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."tomtime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."tomnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."tomname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."ftrtime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."ftrnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."ftrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."tfahtime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."tfahnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."tfahname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."enabtime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."enabnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."enabname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."zetontime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."zetonnum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."zetonname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mozztime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mozznum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mozzname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mangatime"..msg.sender_id.user_id)
Redis:del(TheFREDM.."manganum"..msg.sender_id.user_id)
Redis:del(TheFREDM.."manganame"..msg.sender_id.user_id)
Redis:del(TheFREDM.."sizefram"..msg.sender_id.user_id)
Redis:del(TheFREDM.."namefram"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mzroatsize"..msg.sender_id.user_id)
Redis:srem(TheFREDM.."farmarname", namfra)
Redis:srem(TheFREDM.."ownerfram",msg.sender_id.user_id)
namenad = Redis:get(TheFREDM.."lkbnade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."namenade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."nokatnade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energynade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."traningnade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."2"..msg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."3"..msg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."4"..msg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."5"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."2"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."3"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."4"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."5"..msg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."2"..msg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."3"..msg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."4"..msg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."5"..msg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."2"..msg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."3"..msg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(TheFREDM.."lkbnadesadd", namenad)
Redis:srem(TheFREDM.."ownernade",msg.sender_id.user_id)
Redis:del(TheFREDM.."lkbnade"..msg.sender_id.user_id)
else
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(TheFREDM.."booob",UserId_Info.id) then
ballanceed = Redis:get(TheFREDM.."boob"..UserId_Info.id) or 0
...
if Redis:sismember(TheFREDM.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(TheFREDM.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ فلوسه `"..convert_mony.."` ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
cccc = Redis:get(TheFREDM.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(TheFREDM.."bbobb"..msg.sender_id.user_id)
pppp = Redis:get(TheFREDM.."rrfff"..msg.sender_id.user_id) or 0
ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(TheFREDM.."shkse"..msg.sender_id.user_id)
doltebank = Redis:get(TheFREDM.."doltebank"..msg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballancee)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(TheFREDM.."booob",Remsg.sender_id.user_id) then
local Cname = Redis:get(TheFREDM.."in_company:name:"..msg.sender_id.user_id) or 0
Redis:srem(TheFREDM.."company:mem:"..Cname, msg.sender_id.user_id)
Redis:srem(TheFREDM.."in_company:", msg.sender_id.user_id)
Redis:del(TheFREDM.."in_company:name:"..msg.sender_id.user_id, Cname)
ccccc = Redis:get(TheFREDM.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(TheFREDM.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(TheFREDM.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(TheFREDM.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
Redis:srem(TheFREDM.."booob", Remsg.sender_id.user_id)
Redis:srem(TheFREDM.."taza", Remsg.sender_id.user_id)
namfra = Redis:get(TheFREDM.."namefram"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."boob"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."boobb"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rrfff"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."numattack"..Remsg.sender_id.user_id)
Redis:srem(TheFREDM.."rrfffid", Remsg.sender_id.user_id)
Redis:srem(TheFREDM.."roogg1", Remsg.sender_id.user_id)
Redis:srem(TheFREDM.."roogga1", Remsg.sender_id.user_id)
Redis:del(TheFREDM.."roog1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rooga1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rahr1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rahrr1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."tabbroat"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."shkse"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."doltebank"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."ratbinc"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."ratbtrans"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrmasname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrmasnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrkldname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrkldnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrswrname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrswrnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrktmname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mgrktmnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."akrksrname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."akrksrnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."akrfelname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."akrfelnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."akrmnzname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."akrmnznum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."airshbhname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."airshbhnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."airsfarname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."airsfarnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."airkhasname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."airkhasnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carrangname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carrangnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."caraccename"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."caraccenum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carcamrname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carcamrnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."caralntrname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."caralntrnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carhilxname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carhilxnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carsonaname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carsonanum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carcoroname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."carcoronum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rotpa"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rddd"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rotpagrid"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rotpaid"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rdddgr"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rdddid"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."rdddtex"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."toplvfarm"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."btatatime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."btatanum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."btataname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."lemontime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."lemonnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."lemonname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."khesstime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."khessnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."khessname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."kheartime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."khearnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."khearname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."jzartime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."jzarnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."jzarname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."fleflatime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."fleflanum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."fleflaname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."freaztime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."freaznum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."freazname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."doratime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."doranum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."doraname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."tomtime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."tomnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."tomname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."ftrtime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."ftrnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."ftrname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."tfahtime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."tfahnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."tfahname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."enabtime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."enabnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."enabname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."zetontime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."zetonnum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."zetonname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mozztime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mozznum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mozzname"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mangatime"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."manganum"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."manganame"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."sizefram"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."namefram"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mzroatsize"..Remsg.sender_id.user_id)
Redis:srem(TheFREDM.."farmarname", namfra)
Redis:srem(TheFREDM.."ownerfram",Remsg.sender_id.user_id)
namenad = Redis:get(TheFREDM.."lkbnade"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."namenade"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."nokatnade"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."energynade"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."traningnade"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."nameplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."5"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."1"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."2"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."3"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."4"..Remsg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."5"..Remsg.sender_id.user_id)
Redis:srem(TheFREDM.."lkbnadesadd", namenad)
Redis:srem(TheFREDM.."ownernade",Remsg.sender_id.user_id)
Redis:del(TheFREDM.."lkbnade"..Remsg.sender_id.user_id)
...
ppppp = Redis:get(TheFREDM.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(TheFREDM.."boob"..Remsg.sender_id.user_id) or 0
shkse = Redis:get(TheFREDM.."shkse"..Remsg.sender_id.user_id)
doltebank = Redis:get(TheFREDM.."doltebank"..Remsg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballanceed)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(TheFREDM.."booob",coniss) then
local Cname = Redis:get(TheFREDM.."in_company:name:"..coniss) or 0
Redis:srem(TheFREDM.."company:mem:"..Cname, coniss)
Redis:srem(TheFREDM.."in_company:", coniss)
Redis:del(TheFREDM.."in_company:name:"..coniss, Cname)
ccccc = Redis:get(TheFREDM.."boobb"..coniss)
uuuuu = Redis:get(TheFREDM.."bbobb"..coniss)
ppppp = Redis:get(TheFREDM.."rrfff"..coniss) or 0
ballanceed = Redis:get(TheFREDM.."boob"..coniss) or 0
local convert_mony = string.format("%.0f",ballanceed)
namfra = Redis:get(TheFREDM.."namefram"..coniss)
Redis:srem(TheFREDM.."booob", coniss)
Redis:srem(TheFREDM.."taza", coniss)
Redis:del(TheFREDM.."boob"..coniss)
Redis:del(TheFREDM.."boobb"..coniss)
Redis:del(TheFREDM.."rrfff"..coniss)
Redis:srem(TheFREDM.."roogg1", coniss)
Redis:srem(TheFREDM.."roogga1", coniss)
Redis:del(TheFREDM.."roog1"..coniss)
Redis:del(TheFREDM.."rooga1"..coniss)
Redis:del(TheFREDM.."rahr1"..coniss)
Redis:del(TheFREDM.."rahrr1"..coniss)
Redis:del(TheFREDM.."tabbroat"..coniss)
Redis:del(TheFREDM.."shkse"..coniss)
Redis:del(TheFREDM.."doltebank"..coniss)
Redis:del(TheFREDM.."ratbinc"..coniss)
Redis:del(TheFREDM.."ratbtrans"..coniss)
Redis:del(TheFREDM.."numattack"..coniss)
Redis:del(TheFREDM.."mgrmasname"..coniss)
Redis:del(TheFREDM.."mgrmasnum"..coniss)
Redis:del(TheFREDM.."mgrkldname"..coniss)
Redis:del(TheFREDM.."mgrkldnum"..coniss)
Redis:del(TheFREDM.."mgrswrname"..coniss)
Redis:del(TheFREDM.."mgrswrnum"..coniss)
Redis:del(TheFREDM.."mgrktmname"..coniss)
Redis:del(TheFREDM.."mgrktmnum"..coniss)
Redis:del(TheFREDM.."akrksrname"..coniss)
Redis:del(TheFREDM.."akrksrnum"..coniss)
Redis:del(TheFREDM.."akrfelname"..coniss)
Redis:del(TheFREDM.."akrfelnum"..coniss)
Redis:del(TheFREDM.."akrmnzname"..coniss)
Redis:del(TheFREDM.."akrmnznum"..coniss)
Redis:del(TheFREDM.."airshbhname"..coniss)
Redis:del(TheFREDM.."airshbhnum"..coniss)
Redis:del(TheFREDM.."airsfarname"..coniss)
Redis:del(TheFREDM.."airsfarnum"..coniss)
Redis:del(TheFREDM.."airkhasname"..coniss)
Redis:del(TheFREDM.."airkhasnum"..coniss)
Redis:del(TheFREDM.."carrangname"..coniss)
Redis:del(TheFREDM.."carrangnum"..coniss)
Redis:del(TheFREDM.."caraccename"..coniss)
Redis:del(TheFREDM.."caraccenum"..coniss)
Redis:del(TheFREDM.."carcamrname"..coniss)
Redis:del(TheFREDM.."carcamrnum"..coniss)
Redis:del(TheFREDM.."caralntrname"..coniss)
Redis:del(TheFREDM.."caralntrnum"..coniss)
Redis:del(TheFREDM.."carhilxname"..coniss)
Redis:del(TheFREDM.."carhilxnum"..coniss)
Redis:del(TheFREDM.."carsonaname"..coniss)
Redis:del(TheFREDM.."carsonanum"..coniss)
Redis:del(TheFREDM.."carcoroname"..coniss)
Redis:del(TheFREDM.."carcoronum"..coniss)
Redis:srem(TheFREDM.."rrfffid", coniss)
Redis:del(TheFREDM.."rotpa"..coniss)
Redis:del(TheFREDM.."rddd"..coniss)
Redis:del(TheFREDM.."rotpagrid"..coniss)
Redis:del(TheFREDM.."rotpaid"..coniss)
Redis:del(TheFREDM.."rdddgr"..coniss)
Redis:del(TheFREDM.."rdddid"..coniss)
Redis:del(TheFREDM.."rdddtex"..coniss)
Redis:del(TheFREDM.."toplvfarm"..coniss)
Redis:del(TheFREDM.."btatatime"..coniss)
Redis:del(TheFREDM.."btatanum"..coniss)
Redis:del(TheFREDM.."btataname"..coniss)
Redis:del(TheFREDM.."lemontime"..coniss)
Redis:del(TheFREDM.."lemonnum"..coniss)
Redis:del(TheFREDM.."lemonname"..coniss)
Redis:del(TheFREDM.."khesstime"..coniss)
Redis:del(TheFREDM.."khessnum"..coniss)
Redis:del(TheFREDM.."khessname"..coniss)
Redis:del(TheFREDM.."kheartime"..coniss)
Redis:del(TheFREDM.."khearnum"..coniss)
Redis:del(TheFREDM.."khearname"..coniss)
Redis:del(TheFREDM.."jzartime"..coniss)
Redis:del(TheFREDM.."jzarnum"..coniss)
Redis:del(TheFREDM.."jzarname"..coniss)
Redis:del(TheFREDM.."fleflatime"..coniss)
Redis:del(TheFREDM.."fleflanum"..coniss)
Redis:del(TheFREDM.."fleflaname"..coniss)
Redis:del(TheFREDM.."freaztime"..coniss)
Redis:del(TheFREDM.."freaznum"..coniss)
Redis:del(TheFREDM.."freazname"..coniss)
Redis:del(TheFREDM.."doratime"..coniss)
Redis:del(TheFREDM.."doranum"..coniss)
Redis:del(TheFREDM.."doraname"..coniss)
Redis:del(TheFREDM.."tomtime"..coniss)
Redis:del(TheFREDM.."tomnum"..coniss)
Redis:del(TheFREDM.."tomname"..coniss)
Redis:del(TheFREDM.."ftrtime"..coniss)
Redis:del(TheFREDM.."ftrnum"..coniss)
Redis:del(TheFREDM.."ftrname"..coniss)
Redis:del(TheFREDM.."tfahtime"..coniss)
Redis:del(TheFREDM.."tfahnum"..coniss)
Redis:del(TheFREDM.."tfahname"..coniss)
Redis:del(TheFREDM.."enabtime"..coniss)
Redis:del(TheFREDM.."enabnum"..coniss)
Redis:del(TheFREDM.."enabname"..coniss)
Redis:del(TheFREDM.."zetontime"..coniss)
Redis:del(TheFREDM.."zetonnum"..coniss)
Redis:del(TheFREDM.."zetonname"..coniss)
Redis:del(TheFREDM.."mozztime"..coniss)
Redis:del(TheFREDM.."mozznum"..coniss)
Redis:del(TheFREDM.."mozzname"..coniss)
Redis:del(TheFREDM.."mangatime"..coniss)
Redis:del(TheFREDM.."manganum"..coniss)
Redis:del(TheFREDM.."manganame"..coniss)
Redis:del(TheFREDM.."sizefram"..coniss)
Redis:del(TheFREDM.."namefram"..coniss)
Redis:del(TheFREDM.."mzroatsize"..coniss)
Redis:srem(TheFREDM.."farmarname", namfra)
Redis:srem(TheFREDM.."ownerfram",coniss)
namenad = Redis:get(TheFREDM.."lkbnade"..coniss)
Redis:del(TheFREDM.."namenade"..coniss)
Redis:del(TheFREDM.."nokatnade"..coniss)
Redis:del(TheFREDM.."energynade"..coniss)
Redis:del(TheFREDM.."traningnade"..coniss)
Redis:del(TheFREDM.."nameplayer".."1"..coniss)
Redis:del(TheFREDM.."nameplayer".."2"..coniss)
Redis:del(TheFREDM.."nameplayer".."3"..coniss)
Redis:del(TheFREDM.."nameplayer".."4"..coniss)
Redis:del(TheFREDM.."nameplayer".."5"..coniss)
Redis:del(TheFREDM.."energyplayer".."1"..coniss)
Redis:del(TheFREDM.."energyplayer".."2"..coniss)
Redis:del(TheFREDM.."energyplayer".."3"..coniss)
Redis:del(TheFREDM.."energyplayer".."4"..coniss)
Redis:del(TheFREDM.."energyplayer".."5"..coniss)
Redis:del(TheFREDM.."mrkzplayer".."1"..coniss)
Redis:del(TheFREDM.."mrkzplayer".."2"..coniss)
Redis:del(TheFREDM.."mrkzplayer".."3"..coniss)
Redis:del(TheFREDM.."mrkzplayer".."4"..coniss)
Redis:del(TheFREDM.."mrkzplayer".."5"..coniss)
Redis:del(TheFREDM.."cityplayer".."1"..coniss)
Redis:del(TheFREDM.."cityplayer".."2"..coniss)
Redis:del(TheFREDM.."cityplayer".."3"..coniss)
Redis:del(TheFREDM.."cityplayer".."4"..coniss)
Redis:del(TheFREDM.."cityplayer".."5"..coniss)
Redis:del(TheFREDM.."priceplayer".."1"..coniss)
Redis:del(TheFREDM.."priceplayer".."2"..coniss)
Redis:del(TheFREDM.."priceplayer".."3"..coniss)
Redis:del(TheFREDM.."priceplayer".."4"..coniss)
Redis:del(TheFREDM.."priceplayer".."5"..coniss)
Redis:srem(TheFREDM.."lkbnadesadd", namenad)
Redis:srem(TheFREDM.."ownernade",coniss)
Redis:del(TheFREDM.."lkbnade"..coniss)
send(msg.chat_id,msg.id, "⇜ الاسم ↤ "..news.."\n⇜ الحساب ↤ `"..ccccc.."`\n⇜ بنك ↤ ❲ لويس ❳\n⇜ نوع ↤ ❲ "..uuuuu.." ❳\n⇜ الرصيد ↤ ❲ "..convert_mony.." ❳ ريال 💵 )\n⇜ الزرف ↤ ❲ "..math.floor(ppppp).." ريال 💵 ❳\n⇜ مسكين مسحت حسابه","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coin(UserName)
if Redis:get(TheFREDM.."boballcc"..coniss) then
local yty = Redis:get(TheFREDM.."boballname"..coniss)
local bobpkh = Redis:get(TheFREDM.."boballid"..coniss)
ballancee = Redis:get(TheFREDM.."boob"..bobpkh) or 0
local convert_mony = string.format("%.0f",ballancee)
local dfhb = Redis:get(TheFREDM.."boballbalc"..coniss)
local fsvhh = Redis:get(TheFREDM.."boballban"..coniss)
shkse = Redis:get(TheFREDM.."shkse"..coniss)
doltebank = Redis:get(TheFREDM.."doltebank"..coniss)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
shkseemg = "شريرة 😈"
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
morakba = tonumber(Redis:get(TheFREDM.."morakba"..msg.sender_id.user_id))
if morakba == msg.sender_id.user_id then
send("-1001737102093",0,"⇜ الايدي ↤ "..msg.sender_id.user_id.."\n⇜ القروب ↤ "..msg.chat_id.."\n⇜ الرسالة ↤ "..text.."\n✧","md",true)
end
if not Redis:sismember(TheFREDM.."Akshtd:Games:",TextAksht) then
...
Redis:srem(TheFREDM.."Akshtd:Games:",TextAksht)
ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
cobonplus = tonumber(ballancee) + Number
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , cobonplus)
...
local Text = Redis:smembers(TheFREDM.."Akshtd:Games:") 
if #Text == 0 then
...
Redis:del(TheFREDM.."Akshtd:Games:")
...
Redis:sadd(TheFREDM.."Akshtd:Games:",Num)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num1)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num2)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num3)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num4)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num5)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num6)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num7)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num8)
Redis:sadd(TheFREDM.."Akshtd:Games:",Num9)
return send(msg.chat_id,msg.id,[[
...
ballanceed = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheFREDM.."iiooooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."iiooooo" .. msg.sender_id.user_id))
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(ballanceekkku))
Redis:setex(TheFREDM.."iiooooo" .. msg.sender_id.user_id,900, true)
...
ballanceed = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheFREDM.."iioooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."iioooo" .. msg.sender_id.user_id))
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(ballanceekkk))
Redis:setex(TheFREDM.."iioooo" .. msg.sender_id.user_id,1200, true)
...
if text == 'سحب' then
ballanceed = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheFREDM.."iioood" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."iioood" .. msg.sender_id.user_id))
...
if text == 'حظ' then
ballanceed = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(TheFREDM.."iiooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."iiooo" .. msg.sender_id.user_id))
...
nsbhad = Redis:get(TheFREDM.."nsbhad"..1) or 50
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(ballanceek))
Redis:setex(TheFREDM.."iiooo" .. msg.sender_id.user_id,900, true)
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(ballanceekk))
Redis:setex(TheFREDM.."iiooo" .. msg.sender_id.user_id,900, true)
...
if text == 'تحويل' then
if Redis:ttl(TheFREDM.."tanstime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."tanstime" .. msg.sender_id.user_id))
...
local coniss = coin(UserName)
if not Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
...
Redis:set(TheFREDM.."transn"..msg.sender_id.user_id,coniss)
Redis:setex(TheFREDM.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(TheFREDM.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
cccc = Redis:get(TheFREDM.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(TheFREDM.."bbobb"..msg.sender_id.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheFREDM.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(TheFREDM.."transn" .. msg.sender_id.user_id)
...
if Redis:get(TheFREDM.."boballcc"..text) then
local UserNamey = Redis:get(TheFREDM.."transn"..msg.sender_id.user_id)
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(TheFREDM.."boballid"..text)
...
local fsvhh = Redis:get(TheFREDM.."boballban"..text)
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(deccde))
decdecb = Redis:get(TheFREDM.."boob"..fsvhhh) or 0
deccde2 = decdecb + UserNameyy
Redis:set(TheFREDM.."boob"..fsvhhh , math.floor(deccde2))
Redis:setex(TheFREDM.."tanstime" .. msg.sender_id.user_id,1800, true)
...
if Redis:ttl(TheFREDM.."deletbank" .. 111) >= 1036800 then
day = "13 يوم"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 950400 then
day = "12 يوم"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 864000 then
day = "11 يوم"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 777600 then
day = "10 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 691200 then
day = "9 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 604800 then
day = "8 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 518400 then
day = "7 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 432000 then
day = "6 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 345600 then
day = "5 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 259200 then
day = "4 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 172800 then
day = "3 ايام"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) >= 86400 then
day = "يومان"
elseif Redis:ttl(TheFREDM.."deletbank" .. 111) <= 86400 then
day = "يوم واحد"
else
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(TheFREDM.."doltebank"..v[2]) or " " or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = emoji[k]
num = num + 1
...
zrfee = Redis:get(TheFREDM.."rrfff"..msg.sender_id.user_id) or 0
local ty_users = Redis:smembers(TheFREDM.."rrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(TheFREDM.."rrfff"..v)
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(TheFREDM.."doltebank"..v[2]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emoo = emojii[k]
num_ty = num_ty + 1
...
if Redis:ttl(TheFREDM.."iioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."iioo" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ من شوي اخذت رشوة استنى "..time.." ","md",true)
end
if Redis:ttl(TheFREDM.."polrsho" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."polrsho" .. msg.sender_id.user_id))
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , bakigcj)
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." درهم 💵","md",true)
Redis:setex(TheFREDM.."iioo" .. msg.sender_id.user_id,600, true)
else
Redis:setex(TheFREDM.."polrsho" .. msg.sender_id.user_id,300, true)
...
if Redis:ttl(TheFREDM.."polic" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(TheFREDM.."polic" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id,"⇜ انتا بالسجن 🏤 استنى "..math.floor(hours).." دقائق\n✧","md",true)
end
if Redis:ttl(TheFREDM.."hrame" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."hrame" .. Remsg.sender_id.user_id))
...
shkseto = Redis:get(TheFREDM.."shkse"..Remsg.sender_id.user_id)
if shkseto == "طيبة" then
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(TheFREDM.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
zrfne = ballanceed - hrame
zrfnee = ballancope + hrame
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(zrfnee))
Redis:set(TheFREDM.."boob"..Remsg.sender_id.user_id , math.floor(zrfne))
Redis:setex(TheFREDM.."hrame" .. Remsg.sender_id.user_id,600, true)
local zoropeo = Redis:get(TheFREDM.."rrfff"..msg.sender_id.user_id) or 0
zoroprod = zoropeo + hrame
Redis:set(TheFREDM.."rrfff"..msg.sender_id.user_id,zoroprod)
Redis:sadd(TheFREDM.."rrfffid",msg.sender_id.user_id)
local ban = bot.getUser(Remsg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(TheFREDM.."msrokid"..msg.chat_id..Remsg.sender_id.user_id,Remsg.sender_id.user_id)
Redis:set(TheFREDM.."hrameid"..msg.chat_id..Remsg.sender_id.user_id,msg.sender_id.user_id)
Redis:set(TheFREDM.."balcmsrok"..msg.chat_id..Remsg.sender_id.user_id,hrame)
Redis:setex(TheFREDM.."timehrame"..msg.chat_id..msg.sender_id.user_id,30, true)
...
local hrameid = Redis:get(TheFREDM.."hrameid"..msg.chat_id..msg.sender_id.user_id)
shkse = Redis:get(TheFREDM.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return send(msg.chat_id,msg.id, "⇜ شخصيتك شريرة مايمديك تطلب الشرطة","md",true)
end
if Redis:get(TheFREDM.."timehrame"..msg.chat_id.. hrameid) then
local hours = Redis:ttl(TheFREDM.."timehrame" .. hrameid)
local msrokid = Redis:get(TheFREDM.."msrokid"..msg.chat_id..msg.sender_id.user_id)
local hrameid = Redis:get(TheFREDM.."hrameid"..msg.chat_id..msg.sender_id.user_id)
local balcmsrok = Redis:get(TheFREDM.."balcmsrok"..msg.chat_id..msg.sender_id.user_id) or 0
if tonumber(hrameid) == Remsg.sender_id.user_id and tonumber(msrokid) == msg.sender_id.user_id then
local ballancehrame = Redis:get(TheFREDM.."boob"..hrameid) or 0
local ballancmsrok = Redis:get(TheFREDM.."boob"..msrokid) or 0
ballancehramenow = tonumber(ballancehrame) - tonumber(balcmsrok)
ballancmsroknow = tonumber(ballancmsrok) + tonumber(balcmsrok)
Redis:set(TheFREDM.."boob"..hrameid , ballancehramenow)
Redis:set(TheFREDM.."boob"..msrokid , ballancmsroknow)
...
Redis:setex(TheFREDM.."polic" .. hrameid,600, true)
Redis:del(TheFREDM.."msrokid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(TheFREDM.."hrameid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(TheFREDM.."balcmsrok" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(TheFREDM.."timehrame" ..msg.chat_id..msg.sender_id.user_id)
...
if Redis:ttl(TheFREDM.."iiioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."iiioo" .. msg.sender_id.user_id))
...
local ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(TheFREDM.."shkse"..msg.sender_id.user_id)
ratbinc = Redis:get(TheFREDM.."ratbinc"..msg.sender_id.user_id) or 1
ratbtrans = Redis:get(TheFREDM.."ratbtrans"..msg.sender_id.user_id) or 1
if shkse == "طيبة" then
if tonumber(ratbinc) >= 270 and tonumber(ratbtrans) == 10 then
local ratpep = ballancee + 500000
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(ratpep))
local ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:setex(TheFREDM.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(TheFREDM.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(TheFREDM.."ratbinc"..msg.sender_id.user_id)
...
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,300)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500000 درهم 💵\n⇜ وظيفتك : ملك 👑\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
end
...
Redis:setex(TheFREDM.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(TheFREDM.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(TheFREDM.."ratbinc"..msg.sender_id.user_id) or 0
if tonumber(ratbinc) == 270 or tonumber(ratbinc) == 271 then
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,270)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,240)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,210)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 70000 درهم 💵\n⇜ وظيفتك : بزنس مان كبير 💸\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,180)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,150)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,120)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,90)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,60)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(TheFREDM.."ratbinc"..msg.sender_id.user_id,30)
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,10)
nowbalc = tonumber(ballancee) - 1000000000
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,9)
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,8)
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,7)
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,6)
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,5)
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,4)
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,3)
...
Redis:del(TheFREDM.."ratbtrans"..msg.sender_id.user_id)
Redis:set(TheFREDM.."ratbtrans"..msg.sender_id.user_id,2)
...
if Redis:ttl(TheFREDM.."attack" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."attack" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ خسرت بأخر معركة استنى "..time.." ","md",true)
end
if Redis:ttl(TheFREDM.."defen" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."defen" .. Remsg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ الخصم خسر بأخر معركة\n⇜ يمديك تهاجمه بعد "..time.." ","md",true)
end
if Redis:sismember(TheFREDM.."booob",Remsg.sender_id.user_id) then
ballancope = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
ballanceed = Redis:get(TheFREDM.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(TheFREDM.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(TheFREDM.."attack" .. msg.sender_id.user_id,600, true)
...
local ballanceed = Redis:get(TheFREDM.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
begaatt = Redis:get(TheFREDM.."numattack"..msg.sender_id.user_id) or 200
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(TheFREDM.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(TheFREDM.."defen" .. Remsg.sender_id.user_id,1800, true)
Redis:set(TheFREDM.."numattack"..msg.sender_id.user_id , math.floor(numattackk))
...
Redis:setex(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if text == "سيارات" and Redis:get(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "طيارات" and Redis:get(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "عقارات" and Redis:get(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "مجوهرات" and Redis:get(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheFREDM.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
...
local mgrmasname = Redis:get(TheFREDM.."mgrmasname"..msg.sender_id.user_id)
local mgrmasprice = Redis:get(TheFREDM.."mgrmasprice"..msg.sender_id.user_id) or 0
local mgrmasnum = Redis:get(TheFREDM.."mgrmasnum"..msg.sender_id.user_id) or 0
local mgrmasnow = tonumber(mgrmasnum) + tonumber(coniss)
Redis:set(TheFREDM.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
masnamed = "ماسه"
Redis:set(TheFREDM.."mgrmasname"..msg.sender_id.user_id , masnamed)
Redis:set(TheFREDM.."mgrmasprice"..msg.sender_id.user_id , 1000000)
totalypalice = tonumber(ballance) - tonumber(masmgr)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
...
local mgrkldname = Redis:get(TheFREDM.."mgrkldname"..msg.sender_id.user_id)
local mgrkldprice = Redis:get(TheFREDM.."mgrkldprice"..msg.sender_id.user_id) or 0
local mgrkldnum = Redis:get(TheFREDM.."mgrkldnum"..msg.sender_id.user_id) or 0
local mgrkldnow = tonumber(mgrkldnum) + tonumber(coniss)
Redis:set(TheFREDM.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
kldnamed = "قلاده"
Redis:set(TheFREDM.."mgrkldname"..msg.sender_id.user_id , kldnamed)
Redis:set(TheFREDM.."mgrkldprice"..msg.sender_id.user_id , 500000)
...
local mgrswrname = Redis:get(TheFREDM.."mgrswrname"..msg.sender_id.user_id)
local mgrswrprice = Redis:get(TheFREDM.."mgrswrprice"..msg.sender_id.user_id) or 0
local mgrswrnum = Redis:get(TheFREDM.."mgrswrnum"..msg.sender_id.user_id) or 0
local mgrswrnow = tonumber(mgrswrnum) + tonumber(coniss)
Redis:set(TheFREDM.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
swrnamed = "سوار"
Redis:set(TheFREDM.."mgrswrname"..msg.sender_id.user_id , swrnamed)
Redis:set(TheFREDM.."mgrswrprice"..msg.sender_id.user_id , 200000)
...
local mgrktmname = Redis:get(TheFREDM.."mgrktmname"..msg.sender_id.user_id)
local mgrktmprice = Redis:get(TheFREDM.."mgrktmprice"..msg.sender_id.user_id) or 0
local mgrktmnum = Redis:get(TheFREDM.."mgrktmnum"..msg.sender_id.user_id) or 0
local mgrktmnow = tonumber(mgrktmnum) + tonumber(coniss)
Redis:set(TheFREDM.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
ktmnamed = "خاتم"
Redis:set(TheFREDM.."mgrktmname"..msg.sender_id.user_id , ktmnamed)
Redis:set(TheFREDM.."mgrktmprice"..msg.sender_id.user_id , 50000)
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , totalypalice)
local convert_mony = string.format("%.0f",math.floor(totalypalice))
local mgrmasnum = Redis:get(TheFREDM.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(TheFREDM.."mgrmasname"..msg.sender_id.user_id)
...
if Redis:ttl(TheFREDM.."giftmmt" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."giftmmt" .. msg.sender_id.user_id))
...
local mgrmasnow = tonumber(mgrmasnum) - tonumber(coniss)
Redis:set(TheFREDM.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
local mgrmasnumm = Redis:get(TheFREDM.."mgrmasnum"..Remsg.sender_id.user_id) or 0
local mgrmasnoww = tonumber(mgrmasnumm) + tonumber(coniss)
Redis:set(TheFREDM.."mgrmasnum"..Remsg.sender_id.user_id , mgrmasnoww)
masnamed = "ماسه"
Redis:set(TheFREDM.."mgrmasname"..Remsg.sender_id.user_id,masnamed)
local mgrmasnum = Redis:get(TheFREDM.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(TheFREDM.."mgrmasname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrmasnum"..msg.sender_id.user_id)
end
Redis:setex(TheFREDM.."giftmmt" .. msg.sender_id.user_id,1800, true)
...
local mgrkldnow = tonumber(mgrkldnum) - tonumber(coniss)
Redis:set(TheFREDM.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
local mgrkldnumm = Redis:get(TheFREDM.."mgrkldnum"..Remsg.sender_id.user_id) or 0
local mgrkldnoww = tonumber(mgrkldnumm) + tonumber(coniss)
Redis:set(TheFREDM.."mgrkldnum"..Remsg.sender_id.user_id , mgrkldnoww)
kldnamed = "قلاده"
Redis:set(TheFREDM.."mgrkldname"..Remsg.sender_id.user_id,kldnamed)
local mgrkldnum = Redis:get(TheFREDM.."mgrkldnum"..msg.sender_id.user_id) or 0
if tonumber(mgrkldnum) == 0 then
Redis:del(TheFREDM.."mgrkldname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrkldnum"..msg.sender_id.user_id)
...
local mgrswrnow = tonumber(mgrswrnum) - tonumber(coniss)
Redis:set(TheFREDM.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
local mgrswrnumm = Redis:get(TheFREDM.."mgrswrnum"..Remsg.sender_id.user_id) or 0
local mgrswrnoww = tonumber(mgrswrnumm) + tonumber(coniss)
Redis:set(TheFREDM.."mgrswrnum"..Remsg.sender_id.user_id , mgrswrnoww)
swrnamed = "سوار"
Redis:set(TheFREDM.."mgrswrname"..Remsg.sender_id.user_id,swrnamed)
local mgrswrnum = Redis:get(TheFREDM.."mgrswrnum"..msg.sender_id.user_id) or 0
if tonumber(mgrswrnum) == 0 then
Redis:del(TheFREDM.."mgrswrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrswrnum"..msg.sender_id.user_id)
...
local mgrktmnow = tonumber(mgrktmnum) - tonumber(coniss)
Redis:set(TheFREDM.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
local mgrktmnumm = Redis:get(TheFREDM.."mgrktmnum"..Remsg.sender_id.user_id) or 0
local mgrktmnoww = tonumber(mgrktmnumm) + tonumber(coniss)
Redis:set(TheFREDM.."mgrktmnum"..Remsg.sender_id.user_id , mgrktmnoww)
ktmnamed = "خاتم"
Redis:set(TheFREDM.."mgrktmname"..Remsg.sender_id.user_id,ktmnamed)
local mgrktmnum = Redis:get(TheFREDM.."mgrktmnum"..msg.sender_id.user_id) or 0
if tonumber(mgrktmnum) == 0 then
Redis:del(TheFREDM.."mgrktmname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mgrktmnum"..msg.sender_id.user_id)
...
local akrksrname = Redis:get(TheFREDM.."akrksrname"..msg.sender_id.user_id)
local akrksrprice = Redis:get(TheFREDM.."akrksrprice"..msg.sender_id.user_id) or 0
local akrksrnum = Redis:get(TheFREDM.."akrksrnum"..msg.sender_id.user_id) or 0
local akrksrnow = tonumber(akrksrnum) + tonumber(coniss)
Redis:set(TheFREDM.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
ksrnamed = "قصر"
Redis:set(TheFREDM.."akrksrname"..msg.sender_id.user_id , ksrnamed)
Redis:set(TheFREDM.."akrksrprice"..msg.sender_id.user_id , 1000000)
...
local akrfelname = Redis:get(TheFREDM.."akrfelname"..msg.sender_id.user_id)
local akrfelprice = Redis:get(TheFREDM.."akrfelprice"..msg.sender_id.user_id) or 0
local akrfelnum = Redis:get(TheFREDM.."akrfelnum"..msg.sender_id.user_id) or 0
local akrfelnow = tonumber(akrfelnum) + tonumber(coniss)
Redis:set(TheFREDM.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
felnamed = "فيلا"
Redis:set(TheFREDM.."akrfelname"..msg.sender_id.user_id , felnamed)
Redis:set(TheFREDM.."akrfelprice"..msg.sender_id.user_id , 500000)
...
local akrmnzname = Redis:get(TheFREDM.."akrmnzname"..msg.sender_id.user_id)
local akrmnzprice = Redis:get(TheFREDM.."akrmnzprice"..msg.sender_id.user_id) or 0
local akrmnznum = Redis:get(TheFREDM.."akrmnznum"..msg.sender_id.user_id) or 0
local akrmnznow = tonumber(akrmnznum) + tonumber(coniss)
Redis:set(TheFREDM.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
mnznamed = "منزل"
Redis:set(TheFREDM.."akrmnzname"..msg.sender_id.user_id , mnznamed)
Redis:set(TheFREDM.."akrmnzprice"..msg.sender_id.user_id , 200000)
...
local akrksrnow = tonumber(akrksrnum) - tonumber(coniss)
Redis:set(TheFREDM.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
local akrksrnumm = Redis:get(TheFREDM.."akrksrnum"..Remsg.sender_id.user_id) or 0
local akrksrnoww = tonumber(akrksrnumm) + tonumber(coniss)
Redis:set(TheFREDM.."akrksrnum"..Remsg.sender_id.user_id , akrksrnoww)
ksrnamed = "قصر"
Redis:set(TheFREDM.."akrksrname"..Remsg.sender_id.user_id,ksrnamed)
local akrksrnum = Redis:get(TheFREDM.."akrksrnum"..msg.sender_id.user_id) or 0
if tonumber(akrksrnum) == 0 then
Redis:del(TheFREDM.."akrksrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrksrnum"..msg.sender_id.user_id)
...
local akrfelnow = tonumber(akrfelnum) - tonumber(coniss)
Redis:set(TheFREDM.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
local akrfelnumm = Redis:get(TheFREDM.."akrfelnum"..Remsg.sender_id.user_id) or 0
local akrfelnoww = tonumber(akrfelnumm) + tonumber(coniss)
Redis:set(TheFREDM.."akrfelnum"..Remsg.sender_id.user_id , akrfelnoww)
felnamed = "فيلا"
Redis:set(TheFREDM.."akrfelname"..Remsg.sender_id.user_id,felnamed)
local akrfelnum = Redis:get(TheFREDM.."akrfelnum"..msg.sender_id.user_id) or 0
if tonumber(akrfelnum) == 0 then
Redis:del(TheFREDM.."akrfelname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrfelnum"..msg.sender_id.user_id)
...
local akrmnznow = tonumber(akrmnznum) - tonumber(coniss)
Redis:set(TheFREDM.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
local akrmnznumm = Redis:get(TheFREDM.."akrmnznum"..Remsg.sender_id.user_id) or 0
local akrmnznoww = tonumber(akrmnznumm) + tonumber(coniss)
Redis:set(TheFREDM.."akrmnznum"..Remsg.sender_id.user_id , akrmnznoww)
mnznamed = "منزل"
Redis:set(TheFREDM.."akrmnzname"..Remsg.sender_id.user_id,mnznamed)
local akrmnznum = Redis:get(TheFREDM.."akrmnznum"..msg.sender_id.user_id) or 0
if tonumber(akrmnznum) == 0 then
Redis:del(TheFREDM.."akrmnzname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."akrmnznum"..msg.sender_id.user_id)
...
local airshbhname = Redis:get(TheFREDM.."airshbhname"..msg.sender_id.user_id)
local airshbhprice = Redis:get(TheFREDM.."airshbhprice"..msg.sender_id.user_id) or 0
local airshbhnum = Redis:get(TheFREDM.."airshbhnum"..msg.sender_id.user_id) or 0
local airshbhnow = tonumber(airshbhnum) + tonumber(coniss)
Redis:set(TheFREDM.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
shbhnamed = "شبح"
Redis:set(TheFREDM.."airshbhname"..msg.sender_id.user_id , shbhnamed)
Redis:set(TheFREDM.."airshbhprice"..msg.sender_id.user_id , 1000000000)
...
local airsfarname = Redis:get(TheFREDM.."airsfarname"..msg.sender_id.user_id)
local airsfarprice = Redis:get(TheFREDM.."airsfarprice"..msg.sender_id.user_id) or 0
local airsfarnum = Redis:get(TheFREDM.."airsfarnum"..msg.sender_id.user_id) or 0
local airsfarnow = tonumber(airsfarnum) + tonumber(coniss)
Redis:set(TheFREDM.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
sfarnamed = "سفر"
Redis:set(TheFREDM.."airsfarname"..msg.sender_id.user_id , sfarnamed)
Redis:set(TheFREDM.."airsfarprice"..msg.sender_id.user_id , 500000000)
...
local airkhasname = Redis:get(TheFREDM.."airkhasname"..msg.sender_id.user_id)
local airkhasprice = Redis:get(TheFREDM.."airkhasprice"..msg.sender_id.user_id) or 0
local airkhasnum = Redis:get(TheFREDM.."airkhasnum"..msg.sender_id.user_id) or 0
local airkhasnow = tonumber(airkhasnum) + tonumber(coniss)
Redis:set(TheFREDM.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
khasnamed = "خاصه"
Redis:set(TheFREDM.."airkhasname"..msg.sender_id.user_id , khasnamed)
Redis:set(TheFREDM.."airkhasprice"..msg.sender_id.user_id , 200000000)
...
local airshbhnow = tonumber(airshbhnum) - tonumber(coniss)
Redis:set(TheFREDM.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
local airshbhnumm = Redis:get(TheFREDM.."airshbhnum"..Remsg.sender_id.user_id) or 0
local airshbhnoww = tonumber(airshbhnumm) + tonumber(coniss)
Redis:set(TheFREDM.."airshbhnum"..Remsg.sender_id.user_id , airshbhnoww)
shbhnamed = "شبح"
Redis:set(TheFREDM.."airshbhname"..Remsg.sender_id.user_id,shbhnamed)
local airshbhnum = Redis:get(TheFREDM.."airshbhnum"..msg.sender_id.user_id) or 0
if tonumber(airshbhnum) == 0 then
Redis:del(TheFREDM.."airshbhname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airshbhnum"..msg.sender_id.user_id)
...
local airsfarnow = tonumber(airsfarnum) - tonumber(coniss)
Redis:set(TheFREDM.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
local airsfarnumm = Redis:get(TheFREDM.."airsfarnum"..Remsg.sender_id.user_id) or 0
local airsfarnoww = tonumber(airsfarnumm) + tonumber(coniss)
Redis:set(TheFREDM.."airsfarnum"..Remsg.sender_id.user_id , airsfarnoww)
sfarnamed = "سفر"
Redis:set(TheFREDM.."airsfarname"..Remsg.sender_id.user_id,sfarnamed)
local airsfarnum = Redis:get(TheFREDM.."airsfarnum"..msg.sender_id.user_id) or 0
if tonumber(airsfarnum) == 0 then
Redis:del(TheFREDM.."airsfarname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airsfarnum"..msg.sender_id.user_id)
...
local airkhasnow = tonumber(airkhasnum) - tonumber(coniss)
Redis:set(TheFREDM.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
local airkhasnumm = Redis:get(TheFREDM.."airkhasnum"..Remsg.sender_id.user_id) or 0
local airkhasnoww = tonumber(airkhasnumm) + tonumber(coniss)
Redis:set(TheFREDM.."airkhasnum"..Remsg.sender_id.user_id , airkhasnoww)
khasnamed = "خاصه"
Redis:set(TheFREDM.."airkhasname"..Remsg.sender_id.user_id,khasnamed)
local airkhasnum = Redis:get(TheFREDM.."airkhasnum"..msg.sender_id.user_id) or 0
if tonumber(airkhasnum) == 0 then
Redis:del(TheFREDM.."airkhasname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."airkhasnum"..msg.sender_id.user_id)
...
local carrangname = Redis:get(TheFREDM.."carrangname"..msg.sender_id.user_id)
local carrangprice = Redis:get(TheFREDM.."carrangprice"..msg.sender_id.user_id) or 0
local carrangnum = Redis:get(TheFREDM.."carrangnum"..msg.sender_id.user_id) or 0
local carrangnow = tonumber(carrangnum) + tonumber(coniss)
Redis:set(TheFREDM.."carrangnum"..msg.sender_id.user_id , carrangnow)
rangnamed = "فيلار"
Redis:set(TheFREDM.."carrangname"..msg.sender_id.user_id , rangnamed)
Redis:set(TheFREDM.."carrangprice"..msg.sender_id.user_id , 10000000)
...
local caraccename = Redis:get(TheFREDM.."caraccename"..msg.sender_id.user_id)
local caracceprice = Redis:get(TheFREDM.."caracceprice"..msg.sender_id.user_id) or 0
local caraccenum = Redis:get(TheFREDM.."caraccenum"..msg.sender_id.user_id) or 0
local caraccenow = tonumber(caraccenum) + tonumber(coniss)
Redis:set(TheFREDM.."caraccenum"..msg.sender_id.user_id , caraccenow)
accenamed = "اكسنت"
Redis:set(TheFREDM.."caraccename"..msg.sender_id.user_id , accenamed)
Redis:set(TheFREDM.."caracceprice"..msg.sender_id.user_id , 9000000)
...
local carcamrname = Redis:get(TheFREDM.."carcamrname"..msg.sender_id.user_id)
local carcamrprice = Redis:get(TheFREDM.."carcamrprice"..msg.sender_id.user_id) or 0
local carcamrnum = Redis:get(TheFREDM.."carcamrnum"..msg.sender_id.user_id) or 0
local carcamrnow = tonumber(carcamrnum) + tonumber(coniss)
Redis:set(TheFREDM.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
camrnamed = "كامري"
Redis:set(TheFREDM.."carcamrname"..msg.sender_id.user_id , camrnamed)
Redis:set(TheFREDM.."carcamrprice"..msg.sender_id.user_id , 8000000)
...
local caralntrname = Redis:get(TheFREDM.."caralntrname"..msg.sender_id.user_id)
local caralntrprice = Redis:get(TheFREDM.."caralntrprice"..msg.sender_id.user_id) or 0
local caralntrnum = Redis:get(TheFREDM.."caralntrnum"..msg.sender_id.user_id) or 0
local caralntrnow = tonumber(caralntrnum) + tonumber(coniss)
Redis:set(TheFREDM.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
alntrnamed = "النترا"
Redis:set(TheFREDM.."caralntrname"..msg.sender_id.user_id , alntrnamed)
Redis:set(TheFREDM.."caralntrprice"..msg.sender_id.user_id , 7000000)
...
local carhilxname = Redis:get(TheFREDM.."carhilxname"..msg.sender_id.user_id)
local carhilxprice = Redis:get(TheFREDM.."carhilxprice"..msg.sender_id.user_id) or 0
local carhilxnum = Redis:get(TheFREDM.."carhilxnum"..msg.sender_id.user_id) or 0
local carhilxnow = tonumber(carhilxnum) + tonumber(coniss)
Redis:set(TheFREDM.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
hilxnamed = "هايلكس"
Redis:set(TheFREDM.."carhilxname"..msg.sender_id.user_id , hilxnamed)
Redis:set(TheFREDM.."carhilxprice"..msg.sender_id.user_id , 6000000)
...
local carsonaname = Redis:get(TheFREDM.."carsonaname"..msg.sender_id.user_id)
local carsonaprice = Redis:get(TheFREDM.."carsonaprice"..msg.sender_id.user_id) or 0
local carsonanum = Redis:get(TheFREDM.."carsonanum"..msg.sender_id.user_id) or 0
local carsonanow = tonumber(carsonanum) + tonumber(coniss)
Redis:set(TheFREDM.."carsonanum"..msg.sender_id.user_id , carsonanow)
sonanamed = "سوناتا"
Redis:set(TheFREDM.."carsonaname"..msg.sender_id.user_id , sonanamed)
Redis:set(TheFREDM.."carsonaprice"..msg.sender_id.user_id , 5000000)
...
local carcoroname = Redis:get(TheFREDM.."carcoroname"..msg.sender_id.user_id)
local carcoroprice = Redis:get(TheFREDM.."carcoroprice"..msg.sender_id.user_id) or 0
local carcoronum = Redis:get(TheFREDM.."carcoronum"..msg.sender_id.user_id) or 0
local carcoronow = tonumber(carcoronum) + tonumber(coniss)
Redis:set(TheFREDM.."carcoronum"..msg.sender_id.user_id , carcoronow)
coronamed = "كورولا"
Redis:set(TheFREDM.."carcoroname"..msg.sender_id.user_id , coronamed)
Redis:set(TheFREDM.."carcoroprice"..msg.sender_id.user_id , 4000000)
...
local carrangnow = tonumber(carrangnum) - tonumber(coniss)
Redis:set(TheFREDM.."carrangnum"..msg.sender_id.user_id , carrangnow)
local carrangnumm = Redis:get(TheFREDM.."carrangnum"..Remsg.sender_id.user_id) or 0
local carrangnoww = tonumber(carrangnumm) + tonumber(coniss)
Redis:set(TheFREDM.."carrangnum"..Remsg.sender_id.user_id , carrangnoww)
rangnamed = "فيلار"
Redis:set(TheFREDM.."carrangname"..Remsg.sender_id.user_id,rangnamed)
local carrangnum = Redis:get(TheFREDM.."carrangnum"..msg.sender_id.user_id) or 0
if tonumber(carrangnum) == 0 then
Redis:del(TheFREDM.."carrangname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carrangnum"..msg.sender_id.user_id)
...
local caraccenow = tonumber(caraccenum) - tonumber(coniss)
Redis:set(TheFREDM.."caraccenum"..msg.sender_id.user_id , caraccenow)
local caraccenumm = Redis:get(TheFREDM.."caraccenum"..Remsg.sender_id.user_id) or 0
local caraccenoww = tonumber(caraccenumm) + tonumber(coniss)
Redis:set(TheFREDM.."caraccenum"..Remsg.sender_id.user_id , caraccenoww)
accenamed = "اكسنت"
Redis:set(TheFREDM.."caraccename"..Remsg.sender_id.user_id,accenamed)
local caraccenum = Redis:get(TheFREDM.."caraccenum"..msg.sender_id.user_id) or 0
if tonumber(caraccenum) == 0 then
Redis:del(TheFREDM.."caraccename"..msg.sender_id.user_id)
Redis:del(TheFREDM.."caraccenum"..msg.sender_id.user_id)
...
local carcamrnow = tonumber(carcamrnum) - tonumber(coniss)
Redis:set(TheFREDM.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
local carcamrnumm = Redis:get(TheFREDM.."carcamrnum"..Remsg.sender_id.user_id) or 0
local carcamrnoww = tonumber(carcamrnumm) + tonumber(coniss)
Redis:set(TheFREDM.."carcamrnum"..Remsg.sender_id.user_id , carcamrnoww)
camrnamed = "كامري"
Redis:set(TheFREDM.."carcamrname"..Remsg.sender_id.user_id,camrnamed)
local carcamrnum = Redis:get(TheFREDM.."carcamrnum"..msg.sender_id.user_id) or 0
if tonumber(carcamrnum) == 0 then
Redis:del(TheFREDM.."carcamrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carcamrnum"..msg.sender_id.user_id)
...
local carhilxnow = tonumber(carhilxnum) - tonumber(coniss)
Redis:set(TheFREDM.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
local carhilxnumm = Redis:get(TheFREDM.."carhilxnum"..Remsg.sender_id.user_id) or 0
local carhilxnoww = tonumber(carhilxnumm) + tonumber(coniss)
Redis:set(TheFREDM.."carhilxnum"..Remsg.sender_id.user_id , carhilxnoww)
hilxnamed = "هايلكس"
Redis:set(TheFREDM.."carhilxname"..Remsg.sender_id.user_id,hilxnamed)
local carhilxnum = Redis:get(TheFREDM.."carhilxnum"..msg.sender_id.user_id) or 0
if tonumber(carhilxnum) == 0 then
Redis:del(TheFREDM.."carhilxname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carhilxnum"..msg.sender_id.user_id)
...
local caralntrnow = tonumber(caralntrnum) - tonumber(coniss)
Redis:set(TheFREDM.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
local caralntrnumm = Redis:get(TheFREDM.."caralntrnum"..Remsg.sender_id.user_id) or 0
local caralntrnoww = tonumber(caralntrnumm) + tonumber(coniss)
Redis:set(TheFREDM.."caralntrnum"..Remsg.sender_id.user_id , caralntrnoww)
alntrnamed = "النترا"
Redis:set(TheFREDM.."caralntrname"..Remsg.sender_id.user_id,alntrnamed)
local caralntrnum = Redis:get(TheFREDM.."caralntrnum"..msg.sender_id.user_id) or 0
if tonumber(caralntrnum) == 0 then
Redis:del(TheFREDM.."caralntrname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."caralntrnum"..msg.sender_id.user_id)
...
local carsonanow = tonumber(carsonanum) - tonumber(coniss)
Redis:set(TheFREDM.."carsonanum"..msg.sender_id.user_id , carsonanow)
local carsonanumm = Redis:get(TheFREDM.."carsonanum"..Remsg.sender_id.user_id) or 0
local carsonanoww = tonumber(carsonanumm) + tonumber(coniss)
Redis:set(TheFREDM.."carsonanum"..Remsg.sender_id.user_id , carsonanoww)
sonanamed = "سوناتا"
Redis:set(TheFREDM.."carsonaname"..Remsg.sender_id.user_id,sonanamed)
local carsonanum = Redis:get(TheFREDM.."carsonanum"..msg.sender_id.user_id) or 0
if tonumber(carsonanum) == 0 then
Redis:del(TheFREDM.."carsonaname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carsonanum"..msg.sender_id.user_id)
...
local carcoronow = tonumber(carcoronum) - tonumber(coniss)
Redis:set(TheFREDM.."carcoronum"..msg.sender_id.user_id , carcoronow)
local carcoronumm = Redis:get(TheFREDM.."carcoronum"..Remsg.sender_id.user_id) or 0
local carcoronoww = tonumber(carcoronumm) + tonumber(coniss)
Redis:set(TheFREDM.."carcoronum"..Remsg.sender_id.user_id , carcoronoww)
coronamed = "كورولا"
Redis:set(TheFREDM.."carcoroname"..Remsg.sender_id.user_id,coronamed)
local carcoronum = Redis:get(TheFREDM.."carcoronum"..msg.sender_id.user_id) or 0
if tonumber(carcoronum) == 0 then
Redis:del(TheFREDM.."carcoroname"..msg.sender_id.user_id)
Redis:del(TheFREDM.."carcoronum"..msg.sender_id.user_id)
...
if Redis:get(TheFREDM.."zwag_request:"..msg.sender_id.user_id) then 
...
if Redis:get(TheFREDM.."roog1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(TheFREDM.."rooga1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(TheFREDM.."roog1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:get(TheFREDM.."rooga1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
...
Redis:setex(TheFREDM.."zwag_request:"..msg.sender_id.user_id,60,true)
Redis:setex(TheFREDM.."zwag_request:"..Remsg.sender_id.user_id,60,true)
...
if msg.ControllerBot then
  ...
  zwag_list = {}
  for k,v in pairs(zwag_users) do
  local mahr = Redis:get(TheFREDM.."rahr1"..v)
  local zwga = Redis:get(TheFREDM.."rooga1"..v)
...
"30)"
  ...
  local zwga_name = bot.getUser(v[3]).first_name or Redis:get(TheFREDM..v[3].."first_name:") or "لا يوجد اسم"
...
kk = kk:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(TheFREDM.."doltebank"..v[2]) or " "
local doltebankz = Redis:get(TheFREDM.."doltebank"..v[3]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = zwag_emoji[k]
znum = znum + 1
...
if Redis:sismember(TheFREDM.."roogg1",msg.sender_id.user_id) or Redis:sismember(TheFREDM.."roogga1",msg.sender_id.user_id) then
local zoog = Redis:get(TheFREDM.."roog1"..msg.sender_id.user_id)
local zooga = Redis:get(TheFREDM.."rooga1"..msg.sender_id.user_id)
local mahr = Redis:get(TheFREDM.."rahr1"..msg.sender_id.user_id)
...
if Redis:sismember(TheFREDM.."roogg1",Remsg.sender_id.user_id) or Redis:sismember(TheFREDM.."roogga1",Remsg.sender_id.user_id) then
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 100 then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
...
local zoog = Redis:get(TheFREDM.."roog1"..Remsg.sender_id.user_id)
local zooga = Redis:get(TheFREDM.."rooga1"..Remsg.sender_id.user_id)
local mahr = Redis:get(TheFREDM.."rahr1"..Remsg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
local convert_mony = string.format("%.0f",mahr)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(otheka))
...
local zoog = Redis:get(TheFREDM.."roog1"..msg.sender_id.user_id)
local zooga = tonumber(Redis:get(TheFREDM.."rooga1"..msg.sender_id.user_id))
...
Redis:del(TheFREDM.."rahr1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."rahrr1"..msg.sender_id.user_id)
Redis:srem(TheFREDM.."roogg1", zooga)
Redis:srem(TheFREDM.."roogga1", zooga)
Redis:del(TheFREDM.."roog1"..zooga)
Redis:del(TheFREDM.."rooga1"..zooga)
Redis:del(TheFREDM.."rahr1"..zooga)
Redis:del(TheFREDM.."rahrr1"..zooga)
...
local mahrr = Redis:get(TheFREDM.."rahrr1"..msg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
ballancee = Redis:get(TheFREDM.."boob"..zoog) or 0
kalea = ballancee + mahrr
Redis:set(TheFREDM.."boob"..zoog , kalea)
local convert_mony = string.format("%.0f",mahrr)
send(msg.chat_id,msg.id, "⇜ خلعت زوجك "..neews.."\n⇜ ورجعت له المهر ( "..convert_mony.." درهم 💵 )","md",true)
Redis:srem(TheFREDM.."roogg1", zoog)
Redis:srem(TheFREDM.."roogga1", zoog)
Redis:del(TheFREDM.."roog1"..zoog)
Redis:del(TheFREDM.."rooga1"..zoog)
Redis:del(TheFREDM.."rahr1"..zoog)
Redis:del(TheFREDM.."rahrr1"..zoog)
Redis:srem(TheFREDM.."roogg1", msg.sender_id.user_id)
Redis:srem(TheFREDM.."roogga1", msg.sender_id.user_id)
Redis:del(TheFREDM.."roog1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."rooga1"..msg.sender_id.user_id)
...
Redis:del(TheFREDM..'List_rhan'..msg.chat_id)  
Redis:set(TheFREDM.."playerrhan"..msg.chat_id,msg.sender_id.user_id)
Redis:set(TheFREDM.."playercoins"..msg.chat_id..msg.sender_id.user_id,coniss)
Redis:set(TheFREDM.."raeahkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(TheFREDM..'List_rhan'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(TheFREDM.."Start_rhan"..msg.chat_id,3600,true)
Redis:set(TheFREDM.."allrhan"..msg.chat_id..12345 , coniss)
local ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
rehan = tonumber(ballancee) - tonumber(coniss)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , rehan)
return send(msg.chat_id,msg.id,"⇜ بدينا المراهنة وسجلت اسمك \n⇜ اللي بده يشارك يرسل ( انا والمبلغ ) .","md",true)
end
if text == 'نعم' and Redis:get(TheFREDM.."Witting_Startrhan"..msg.chat_id) then
rarahkam = Redis:get(TheFREDM.."raeahkam"..msg.chat_id)
if tonumber(rarahkam) == msg.sender_id.user_id then
local list = Redis:smembers(TheFREDM..'List_rhan'..msg.chat_id) 
if #list == 1 then 
...
benrahan = Redis:get(TheFREDM.."allrhan"..msg.chat_id..12345) or 0
local ballancee = Redis:get(TheFREDM.."boob"..UserName) or 0
rehane = tonumber(benrahan) / 100 * 25
rehan = tonumber(ballancee) + math.floor(rehane)
Redis:set(TheFREDM.."boob"..UserName , rehan)
local rhan_users = Redis:smembers(TheFREDM.."List_rhan"..msg.chat_id)
for k,v in pairs(rhan_users) do
Redis:del(TheFREDM..'playercoins'..msg.chat_id..v)
end
Redis:del(TheFREDM..'allrhan'..msg.chat_id..12345) 
Redis:del(TheFREDM..'playerrhan'..msg.chat_id) 
Redis:del(TheFREDM..'raeahkam'..msg.chat_id) 
Redis:del(TheFREDM..'List_rhan'..msg.chat_id) 
Redis:del(TheFREDM.."Witting_Startrhan"..msg.chat_id)
Redis:del(TheFREDM.."Start_rhan"..msg.chat_id)
local ballancee = Redis:get(TheFREDM.."boob"..UserName) or 0
...
local bank_users = Redis:smembers(TheFREDM.."ownernade")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheFREDM.."nokatnade"..v) or 0
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(TheFREDM.."lkbnade"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
if Redis:get(TheFREDM.."namenade"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك نادي مسبقاً ","md",true)
end
if Redis:sismember(TheFREDM.."lkbnadesadd", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(TheFREDM.."lkbnade"..msg.sender_id.user_id, Cnamed)
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
if not Redis:get(TheFREDM.."namenade" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ ماعندك نادي اصلاً\n⇜ قم بانشاء النادي الخاص بك عن طريق الامر \n( `انشاء نادي` ) والاسم","md",true)
end
namfra = Redis:get(TheFREDM.."lkbnade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."namenade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."nokatnade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energynade"..msg.sender_id.user_id)
Redis:del(TheFREDM.."traningnade"..msg.sender_id.user_id)
...
Redis:del(TheFREDM.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(TheFREDM.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(TheFREDM.."lkbnadesadd", namfra)
Redis:srem(TheFREDM.."ownernade",msg.sender_id.user_id)
Redis:del(TheFREDM.."lkbnade"..msg.sender_id.user_id)
...
if Redis:ttl(TheFREDM.."traningnade" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."traningnade" .. msg.sender_id.user_id))
...
namenade = Redis:get(TheFREDM.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(TheFREDM.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(TheFREDM.."lkbnade"..msg.sender_id.user_id)
namenade = Redis:get(TheFREDM.."namenade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id)
energyplayer2 = Redis:get(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id)
energyplayer3 = Redis:get(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id)
energyplayer4 = Redis:get(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id)
energyplayer5 = Redis:get(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energynade) < 151 then
Redis:incrby(TheFREDM.."energynade"..msg.sender_id.user_id,1)
end
if energyplayer1 then
if tonumber(energyplayer1) < 151 then
Redis:incrby(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id,1)
end
end
if energyplayer2 then
if tonumber(energyplayer2) < 151 then
Redis:incrby(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id,1)
end
end
if energyplayer3 then
if tonumber(energyplayer3) < 151 then
Redis:incrby(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id,1)
end
end
if energyplayer4 then
if tonumber(energyplayer4) < 151 then
Redis:incrby(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id,1)
end
end
if energyplayer5 then
if tonumber(energyplayer5) < 151 then
Redis:incrby(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id,1)
end
end
energynade = Redis:get(TheFREDM.."energynade"..msg.sender_id.user_id)
Redis:setex(TheFREDM.."traningnade" .. msg.sender_id.user_id,1800, true)
...
Redis:setex(TheFREDM.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(TheFREDM.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheFREDM.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
return send(msg.chat_id,msg.id, "⇜ تم الغاء امر تغيير لقب النادي","md",true)
end
if Redis:sismember(TheFREDM.."lkbnadesadd", text) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
namfra = Redis:get(TheFREDM.."lkbnade"..msg.sender_id.user_id)
Redis:srem(TheFREDM.."lkbnadesadd", namfra)
Redis:del(TheFREDM.."lkbnade"..msg.sender_id.user_id)
Redis:set(TheFREDM.."lkbnade"..msg.sender_id.user_id, text)
Redis:sadd(TheFREDM.."lkbnadesadd", text)
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
cccallcc = tonumber(ballance) - 25000
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id,cccallcc)
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
...
nameplayer1 = Redis:get(TheFREDM.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(TheFREDM.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(TheFREDM.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(TheFREDM.."nameplayer".."4"..msg.sender_id.user_id)
nameplayer5 = Redis:get(TheFREDM.."nameplayer".."5"..msg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(TheFREDM.."mrkzplayer".."1"..msg.sender_id.user_id)
cityplayer1 = Redis:get(TheFREDM.."cityplayer".."1"..msg.sender_id.user_id)
energyplayer1 = Redis:get(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id)
priceplayer1 = Redis:get(TheFREDM.."priceplayer".."1"..msg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : `"..nameplayer1.."`\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n- السعر : "..priceplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(TheFREDM.."mrkzplayer".."2"..msg.sender_id.user_id)
cityplayer2 = Redis:get(TheFREDM.."cityplayer".."2"..msg.sender_id.user_id)
energyplayer2 = Redis:get(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id)
priceplayer2 = Redis:get(TheFREDM.."priceplayer".."2"..msg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : `"..nameplayer2.."`\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n- السعر : "..priceplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(TheFREDM.."mrkzplayer".."3"..msg.sender_id.user_id)
cityplayer3 = Redis:get(TheFREDM.."cityplayer".."3"..msg.sender_id.user_id)
energyplayer3 = Redis:get(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id)
priceplayer3 = Redis:get(TheFREDM.."priceplayer".."3"..msg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : `"..nameplayer3.."`\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n- السعر : "..priceplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(TheFREDM.."mrkzplayer".."4"..msg.sender_id.user_id)
cityplayer4 = Redis:get(TheFREDM.."cityplayer".."4"..msg.sender_id.user_id)
energyplayer4 = Redis:get(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id)
priceplayer4 = Redis:get(TheFREDM.."priceplayer".."4"..msg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : `"..nameplayer4.."`\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n- السعر : "..priceplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(TheFREDM.."mrkzplayer".."5"..msg.sender_id.user_id)
cityplayer5 = Redis:get(TheFREDM.."cityplayer".."5"..msg.sender_id.user_id)
energyplayer5 = Redis:get(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id)
priceplayer5 = Redis:get(TheFREDM.."priceplayer".."5"..msg.sender_id.user_id)
...
Redis:setex(TheFREDM.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(TheFREDM.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(TheFREDM.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id,pricetotaly)
Redis:del(TheFREDM.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(TheFREDM.."cityplayer".."1"..msg.sender_id.user_id)
...
energynade = Redis:get(TheFREDM.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(TheFREDM.."lkbnade"..msg.sender_id.user_id)
nokatnade = Redis:get(TheFREDM.."nokatnade"..msg.sender_id.user_id) or 0
nameplayer1 = Redis:get(TheFREDM.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(TheFREDM.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(TheFREDM.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(TheFREDM.."nameplayer".."4"..msg.sender_id.user_id)
...
if not Redis:get(TheFREDM.."namenade" .. Remsg.sender_id.user_id) then
...
namenade = Redis:get(TheFREDM.."namenade"..Remsg.sender_id.user_id)
energynade = Redis:get(TheFREDM.."energynade"..Remsg.sender_id.user_id)
lkbnade = Redis:get(TheFREDM.."lkbnade"..Remsg.sender_id.user_id)
nokatnade = Redis:get(TheFREDM.."nokatnade"..Remsg.sender_id.user_id) or 0
nameplayer1 = Redis:get(TheFREDM.."nameplayer".."1"..Remsg.sender_id.user_id)
nameplayer2 = Redis:get(TheFREDM.."nameplayer".."2"..Remsg.sender_id.user_id)
nameplayer3 = Redis:get(TheFREDM.."nameplayer".."3"..Remsg.sender_id.user_id)
nameplayer4 = Redis:get(TheFREDM.."nameplayer".."4"..Remsg.sender_id.user_id)
nameplayer5 = Redis:get(TheFREDM.."nameplayer".."5"..Remsg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(TheFREDM.."mrkzplayer".."1"..Remsg.sender_id.user_id)
cityplayer1 = Redis:get(TheFREDM.."cityplayer".."1"..Remsg.sender_id.user_id)
energyplayer1 = Redis:get(TheFREDM.."energyplayer".."1"..Remsg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : "..nameplayer1.."\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(TheFREDM.."mrkzplayer".."2"..Remsg.sender_id.user_id)
cityplayer2 = Redis:get(TheFREDM.."cityplayer".."2"..Remsg.sender_id.user_id)
energyplayer2 = Redis:get(TheFREDM.."energyplayer".."2"..Remsg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : "..nameplayer2.."\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(TheFREDM.."mrkzplayer".."3"..Remsg.sender_id.user_id)
cityplayer3 = Redis:get(TheFREDM.."cityplayer".."3"..Remsg.sender_id.user_id)
energyplayer3 = Redis:get(TheFREDM.."energyplayer".."3"..Remsg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : "..nameplayer3.."\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(TheFREDM.."mrkzplayer".."4"..Remsg.sender_id.user_id)
cityplayer4 = Redis:get(TheFREDM.."cityplayer".."4"..Remsg.sender_id.user_id)
energyplayer4 = Redis:get(TheFREDM.."energyplayer".."4"..Remsg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : "..nameplayer4.."\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(TheFREDM.."mrkzplayer".."5"..Remsg.sender_id.user_id)
cityplayer5 = Redis:get(TheFREDM.."cityplayer".."5"..Remsg.sender_id.user_id)
energyplayer5 = Redis:get(TheFREDM.."energyplayer".."5"..Remsg.sender_id.user_id)
nameplayer5done = "⌯ اسم اللاعب : "..nameplayer5.."\n- مركزه : "..mrkzplayer5.."\n- طاقة اللاعب : "..energyplayer5.."\n- الجنسية : "..cityplayer5.."\n\n"
else
nameplayer5done = ""
end
...
if Redis:ttl(TheFREDM.."matchode" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."matchode" .. msg.sender_id.user_id))
...
namenade = Redis:get(TheFREDM.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(TheFREDM.."energynade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id) or 0
energyplayer2 = Redis:get(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id) or 0
energyplayer3 = Redis:get(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id) or 0
energyplayer4 = Redis:get(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id) or 0
energyplayer5 = Redis:get(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id) or 0
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id,cccallcc)
Redis:incrby(TheFREDM.."energynade"..msg.sender_id.user_id,1)
Redis:incrby(TheFREDM.."nokatnade"..msg.sender_id.user_id,1)
Redis:setex(TheFREDM.."matchode" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌯ لقد فزت بالمبارة "..news.." ⚽️\n⇜ اسم النادي : "..namenade.."\n⇜ نادي الخصم : "..nadebot.."\n⇜ النتيجة : "..result.."\n⇜ تم زيادة نقطة لطاقة ناديك\n✧","md",true)
elseif energymynade < tonumber(energybot) then
Redis:decrby(TheFREDM.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(TheFREDM.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
Redis:set(TheFREDM.."energynade"..msg.sender_id.user_id,0)
end
Redis:decrby(TheFREDM.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(TheFREDM.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
Redis:set(TheFREDM.."nokatnade"..msg.sender_id.user_id,0)
end
Redis:setex(TheFREDM.."matchode" .. msg.sender_id.user_id,1200, true)
...
if Redis:ttl(TheFREDM.."matchplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."matchplayer" .. msg.sender_id.user_id))
...
namenadevs = Redis:get(TheFREDM.."namenade"..Remsg.sender_id.user_id)
energynadevs = Redis:get(TheFREDM.."energynade"..Remsg.sender_id.user_id)
energyplayer1vs = Redis:get(TheFREDM.."energyplayer".."1"..Remsg.sender_id.user_id) or 0
energyplayer2vs = Redis:get(TheFREDM.."energyplayer".."2"..Remsg.sender_id.user_id) or 0
energyplayer3vs = Redis:get(TheFREDM.."energyplayer".."3"..Remsg.sender_id.user_id) or 0
energyplayer4vs = Redis:get(TheFREDM.."energyplayer".."4"..Remsg.sender_id.user_id) or 0
energyplayer5vs = Redis:get(TheFREDM.."energyplayer".."5"..Remsg.sender_id.user_id) or 0
...
Redis:decrby(TheFREDM.."energynade"..Remsg.sender_id.user_id,1)
energynadevs = Redis:get(TheFREDM.."energynade"..Remsg.sender_id.user_id)
if tonumber(energynadevs) < 0 then
Redis:set(TheFREDM.."energynade"..Remsg.sender_id.user_id,0)
end
if energyplayer1vs then
Redis:decrby(TheFREDM.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
energyplayer1vs = Redis:get(TheFREDM.."energyplayer".."1"..Remsg.sender_id.user_id)
if tonumber(energyplayer1vs) < 0 then
Redis:set(TheFREDM.."energyplayer".."1"..Remsg.sender_id.user_id,0)
end
if energyplayer2vs then
Redis:decrby(TheFREDM.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
energyplayer2vs = Redis:get(TheFREDM.."energyplayer".."2"..Remsg.sender_id.user_id)
if tonumber(energyplayer2vs) < 0 then
Redis:set(TheFREDM.."energyplayer".."2"..Remsg.sender_id.user_id,0)
end
if energyplayer3vs then
Redis:decrby(TheFREDM.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
energyplayer3vs = Redis:get(TheFREDM.."energyplayer".."3"..Remsg.sender_id.user_id)
if tonumber(energyplayer3vs) < 0 then
Redis:set(TheFREDM.."energyplayer".."3"..Remsg.sender_id.user_id,0)
end
if energyplayer4vs then
Redis:decrby(TheFREDM.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
energyplayer4vs = Redis:get(TheFREDM.."energyplayer".."4"..Remsg.sender_id.user_id)
if tonumber(energyplayer4vs) < 0 then
Redis:set(TheFREDM.."energyplayer".."4"..Remsg.sender_id.user_id,0)
end
if energyplayer5vs then
Redis:decrby(TheFREDM.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
energyplayer5vs = Redis:get(TheFREDM.."energyplayer".."5"..Remsg.sender_id.user_id)
if tonumber(energyplayer5vs) < 0 then
Redis:set(TheFREDM.."energyplayer".."5"..Remsg.sender_id.user_id,0)
end
Redis:decrby(TheFREDM.."nokatnade"..Remsg.sender_id.user_id,1)
nokatnadevs = Redis:get(TheFREDM.."nokatnade"..Remsg.sender_id.user_id)
if tonumber(nokatnadevs) < 0 then
Redis:set(TheFREDM.."nokatnade"..Remsg.sender_id.user_id,0)
end
Redis:setex(TheFREDM.."matchplayer" .. msg.sender_id.user_id,1200, true)
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
...
Redis:incrby(TheFREDM.."energynade"..Remsg.sender_id.user_id,1)
Redis:incrby(TheFREDM.."nokatnade"..Remsg.sender_id.user_id,1)
if energyplayer1vs then
Redis:incrby(TheFREDM.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
if energyplayer2vs then
Redis:incrby(TheFREDM.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
if energyplayer3vs then
Redis:incrby(TheFREDM.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
if energyplayer4vs then
Redis:incrby(TheFREDM.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
if energyplayer5vs then
Redis:incrby(TheFREDM.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
Redis:decrby(TheFREDM.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(TheFREDM.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
...
if energyplayer1 then
Redis:decrby(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id,1)
end
energyplayer1 = Redis:get(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id)
if tonumber(energyplayer1) < 0 then
Redis:set(TheFREDM.."energyplayer".."1"..msg.sender_id.user_id,0)
end
if energyplayer2 then
Redis:decrby(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id,1)
end
energyplayer2 = Redis:get(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id)
if tonumber(energyplayer2) < 0 then
Redis:set(TheFREDM.."energyplayer".."2"..msg.sender_id.user_id,0)
end
if energyplayer3 then
Redis:decrby(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id,1)
end
energyplayer3 = Redis:get(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id)
if tonumber(energyplayer3) < 0 then
Redis:set(TheFREDM.."energyplayer".."3"..msg.sender_id.user_id,0)
end
if energyplayer4 then
Redis:decrby(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id,1)
end
energyplayer4 = Redis:get(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id)
if tonumber(energyplayer4) < 0 then
Redis:set(TheFREDM.."energyplayer".."4"..msg.sender_id.user_id,0)
end
if energyplayer5 then
Redis:decrby(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id,1)
end
energyplayer5 = Redis:get(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energyplayer5) < 0 then
Redis:set(TheFREDM.."energyplayer".."5"..msg.sender_id.user_id,0)
end
Redis:decrby(TheFREDM.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(TheFREDM.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
if Redis:get(TheFREDM.."mrkzplayer".."1"..msg.sender_id.user_id) and Redis:get(TheFREDM.."mrkzplayer".."2"..msg.sender_id.user_id) and Redis:get(TheFREDM.."mrkzplayer".."3"..msg.sender_id.user_id) and Redis:get(TheFREDM.."mrkzplayer".."4"..msg.sender_id.user_id) and Redis:get(TheFREDM.."mrkzplayer".."5"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ النادي الخاص بك مكتمل\n⇜ تستطيع بيع لاعب عن طريق الامر ( بيع لاعب )  ","md",true)
end
if Redis:ttl(TheFREDM.."buyplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."buyplayer" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ تستطيع شراء لاعب بعد "..time.." ","md",true)
end
Redis:setex(TheFREDM.."buyplayer" .. msg.sender_id.user_id,900, true)
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
ballanceed = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
namefram = Redis:get(TheFREDM.."namefram"..msg.sender_id.user_id)
if Redis:get(TheFREDM.."sizefram"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك مزرعه مسبقاً ","md",true)
end
if Redis:sismember(TheFREDM.."farmarname", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ اسم المزرعه موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(TheFREDM.."namefram"..msg.sender_id.user_id, Cnamed)
...
local bank_users = Redis:smembers(TheFREDM.."ownerfram")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheFREDM.."toplvfarm"..v) or 0
table.insert(mony_listd, {tonumber(mony) , v})
end
table.sort(mony_listd, function(a, b) return a[1] > b[1] end)
num = 1
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(TheFREDM.."namefram"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
if not Redis:get(TheFREDM.."sizefram" .. msg.sender_id.user_id) then
...
local namefram = Redis:get(TheFREDM.."namefram"..msg.sender_id.user_id)
local sizefram = Redis:get(TheFREDM.."sizefram"..msg.sender_id.user_id)
local mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
local mazofxbh = tonumber(sizefram) - tonumber(mzroatsize)
local btatahours = Redis:ttl(TheFREDM.."btatatime" .. msg.sender_id.user_id) / 60
local btatatime = Redis:get(TheFREDM.."btatatime" .. msg.sender_id.user_id)
local btataname = Redis:get(TheFREDM.."btataname"..msg.sender_id.user_id)
local btatanum = Redis:get(TheFREDM.."btatanum"..msg.sender_id.user_id) or 0
...
local lemonhours = Redis:ttl(TheFREDM.."lemontime" .. msg.sender_id.user_id) / 60
local lemontime = Redis:get(TheFREDM.."lemontime" .. msg.sender_id.user_id)
local lemonname = Redis:get(TheFREDM.."lemonname"..msg.sender_id.user_id)
local lemonnum = Redis:get(TheFREDM.."lemonnum"..msg.sender_id.user_id) or 0
...
local khesshours = Redis:ttl(TheFREDM.."khesstime" .. msg.sender_id.user_id) / 60
local khesstime = Redis:get(TheFREDM.."khesstime" .. msg.sender_id.user_id)
local khessname = Redis:get(TheFREDM.."khessname"..msg.sender_id.user_id)
local khessnum = Redis:get(TheFREDM.."khessnum"..msg.sender_id.user_id) or 0
...
local khearhours = Redis:ttl(TheFREDM.."kheartime" .. msg.sender_id.user_id) / 60
local kheartime = Redis:get(TheFREDM.."kheartime" .. msg.sender_id.user_id)
local khearname = Redis:get(TheFREDM.."khearname"..msg.sender_id.user_id)
local khearnum = Redis:get(TheFREDM.."khearnum"..msg.sender_id.user_id) or 0
...
local jzarhours = Redis:ttl(TheFREDM.."jzartime" .. msg.sender_id.user_id) / 60
local jzartime = Redis:get(TheFREDM.."jzartime" .. msg.sender_id.user_id)
local jzarname = Redis:get(TheFREDM.."jzarname"..msg.sender_id.user_id)
local jzarnum = Redis:get(TheFREDM.."jzarnum"..msg.sender_id.user_id) or 0
...
local fleflahours = Redis:ttl(TheFREDM.."fleflatime" .. msg.sender_id.user_id) / 60
local fleflatime = Redis:get(TheFREDM.."fleflatime" .. msg.sender_id.user_id)
local fleflaname = Redis:get(TheFREDM.."fleflaname"..msg.sender_id.user_id)
local fleflanum = Redis:get(TheFREDM.."fleflanum"..msg.sender_id.user_id) or 0
...
local freazhours = Redis:ttl(TheFREDM.."freaztime" .. msg.sender_id.user_id) / 60
local freaztime = Redis:get(TheFREDM.."freaztime" .. msg.sender_id.user_id)
local freazname = Redis:get(TheFREDM.."freazname"..msg.sender_id.user_id)
local freaznum = Redis:get(TheFREDM.."freaznum"..msg.sender_id.user_id) or 0
...
local dorahours = Redis:ttl(TheFREDM.."doratime" .. msg.sender_id.user_id) / 60
local doratime = Redis:get(TheFREDM.."doratime" .. msg.sender_id.user_id)
local doraname = Redis:get(TheFREDM.."doraname"..msg.sender_id.user_id)
local doranum = Redis:get(TheFREDM.."doranum"..msg.sender_id.user_id) or 0
...
local tomhours = Redis:ttl(TheFREDM.."tomtime" .. msg.sender_id.user_id) / 60
local tomtime = Redis:get(TheFREDM.."tomtime" .. msg.sender_id.user_id)
local tomname = Redis:get(TheFREDM.."tomname"..msg.sender_id.user_id)
local tomnum = Redis:get(TheFREDM.."tomnum"..msg.sender_id.user_id) or 0
...
local ftrhours = Redis:ttl(TheFREDM.."ftrtime" .. msg.sender_id.user_id) / 60
local ftrtime = Redis:get(TheFREDM.."ftrtime" .. msg.sender_id.user_id)
local ftrname = Redis:get(TheFREDM.."ftrname"..msg.sender_id.user_id)
local ftrnum = Redis:get(TheFREDM.."ftrnum"..msg.sender_id.user_id) or 0
...
local tfahhours = Redis:ttl(TheFREDM.."tfahtime" .. msg.sender_id.user_id) / 60
local tfahtime = Redis:get(TheFREDM.."tfahtime" .. msg.sender_id.user_id)
local tfahname = Redis:get(TheFREDM.."tfahname"..msg.sender_id.user_id)
local tfahnum = Redis:get(TheFREDM.."tfahnum"..msg.sender_id.user_id) or 0
...
local enabhours = Redis:ttl(TheFREDM.."enabtime" .. msg.sender_id.user_id) / 60
local enabtime = Redis:get(TheFREDM.."enabtime" .. msg.sender_id.user_id)
local enabname = Redis:get(TheFREDM.."enabname"..msg.sender_id.user_id)
local enabnum = Redis:get(TheFREDM.."enabnum"..msg.sender_id.user_id) or 0
...
local zetonhours = Redis:ttl(TheFREDM.."zetontime" .. msg.sender_id.user_id) / 60
local zetontime = Redis:get(TheFREDM.."zetontime" .. msg.sender_id.user_id)
local zetonname = Redis:get(TheFREDM.."zetonname"..msg.sender_id.user_id)
local zetonnum = Redis:get(TheFREDM.."zetonnum"..msg.sender_id.user_id) or 0
...
local mozzhours = Redis:ttl(TheFREDM.."mozztime" .. msg.sender_id.user_id) / 60
local mozztime = Redis:get(TheFREDM.."mozztime" .. msg.sender_id.user_id)
local mozzname = Redis:get(TheFREDM.."mozzname"..msg.sender_id.user_id)
local mozznum = Redis:get(TheFREDM.."mozznum"..msg.sender_id.user_id) or 0
...
local mangahours = Redis:ttl(TheFREDM.."mangatime" .. msg.sender_id.user_id) / 60
local mangatime = Redis:get(TheFREDM.."mangatime" .. msg.sender_id.user_id)
local manganame = Redis:get(TheFREDM.."manganame"..msg.sender_id.user_id)
local manganum = Redis:get(TheFREDM.."manganum"..msg.sender_id.user_id) or 0
...
if Redis:get(TheFREDM.."btatatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."btatatime" .. msg.sender_id.user_id) / 60
...
if Redis:get(TheFREDM.."btatanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بطاطا قبل 🥔\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد بطاطا`","md",true)
end
kajwha = tonumber(coniss) * 0.7
sizefram = Redis:get(TheFREDM.."sizefram"..msg.sender_id.user_id)
if tonumber(kajwha) > tonumber(sizefram) then
return send(msg.chat_id,msg.id, "⇜ مايمديك تشتري مساحة ارضك ماتكفي","md",true)
end
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
...
Redis:set(TheFREDM.."btatanum"..msg.sender_id.user_id , coniss)
btataname = "بطاطا"
Redis:set(TheFREDM.."btataname"..msg.sender_id.user_id , btataname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
btatasize = tonumber(coniss) * 0.7
btatasizee = btatasize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(btatasizee))
totalypalice = tonumber(ballance) - tonumber(btata)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."btatatime"..msg.sender_id.user_id,1220, true)
local convert_mony = string.format("%.0f",math.floor(btata))
toplvfarm = Redis:get(TheFREDM.."toplvfarm"..msg.sender_id.user_id) or 0
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(TheFREDM.."toplvfarm"..msg.sender_id.user_id , toplvfarmm)
...
if Redis:get(TheFREDM.."lemontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."lemontime" .. msg.sender_id.user_id) / 60
...
if Redis:get(TheFREDM.."lemonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بندوره قبل 🍅\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد بندوره`","md",true)
end
...
Redis:set(TheFREDM.."lemonnum"..msg.sender_id.user_id , coniss)
lemonname = "بندوره"
Redis:set(TheFREDM.."lemonname"..msg.sender_id.user_id , lemonname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
lemonsize = tonumber(coniss) * 1
lemonsizee = lemonsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(lemonsizee))
totalypalice = tonumber(ballance) - tonumber(lemon)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."lemontime"..msg.sender_id.user_id,1520, true)
...
if Redis:get(TheFREDM.."khesstime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."khesstime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
if Redis:get(TheFREDM.."khessnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
...
Redis:set(TheFREDM.."khessnum"..msg.sender_id.user_id , coniss)
khessname = "خس"
Redis:set(TheFREDM.."khessname"..msg.sender_id.user_id , khessname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
khesssize = tonumber(coniss) * 1.2
khesssizee = khesssize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(khesssizee))
totalypalice = tonumber(ballance) - tonumber(khess)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."khesstime"..msg.sender_id.user_id,1800, true)
...
if Redis:get(TheFREDM.."kheartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."kheartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
if Redis:get(TheFREDM.."khearnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
...
Redis:set(TheFREDM.."khearnum"..msg.sender_id.user_id , coniss)
khearname = "خيار"
Redis:set(TheFREDM.."khearname"..msg.sender_id.user_id , khearname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
khearsize = tonumber(coniss) * 1.5
khearsizee = khearsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(khearsizee))
totalypalice = tonumber(ballance) - tonumber(khear)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."kheartime"..msg.sender_id.user_id,2120, true)
...
if Redis:get(TheFREDM.."jzartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."jzartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
if Redis:get(TheFREDM.."jzarnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
...
Redis:set(TheFREDM.."jzarnum"..msg.sender_id.user_id , coniss)
jzarname = "جزر"
Redis:set(TheFREDM.."jzarname"..msg.sender_id.user_id , jzarname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
jzarsize = tonumber(coniss) * 1.7
jzarsizee = jzarsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(jzarsizee))
totalypalice = tonumber(ballance) - tonumber(jzar)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."jzartime"..msg.sender_id.user_id,2420, true)
...
if Redis:get(TheFREDM.."fleflatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."fleflatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
if Redis:get(TheFREDM.."fleflanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
...
Redis:set(TheFREDM.."fleflanum"..msg.sender_id.user_id , coniss)
fleflaname = "فليفله"
Redis:set(TheFREDM.."fleflaname"..msg.sender_id.user_id , fleflaname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
fleflasize = tonumber(coniss) * 2
fleflasizee = fleflasize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(fleflasizee))
totalypalice = tonumber(ballance) - tonumber(flefla)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."fleflatime"..msg.sender_id.user_id,2720, true)
...
if Redis:get(TheFREDM.."freaztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."freaztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
if Redis:get(TheFREDM.."freaznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
...
Redis:set(TheFREDM.."freaznum"..msg.sender_id.user_id , coniss)
freazname = "فريز"
Redis:set(TheFREDM.."freazname"..msg.sender_id.user_id , freazname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
freazsize = tonumber(coniss) * 3
freazsizee = freazsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(freazsizee))
totalypalice = tonumber(ballance) - tonumber(freaz)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."freaztime"..msg.sender_id.user_id,3020, true)
...
if Redis:get(TheFREDM.."doratime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."doratime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
if Redis:get(TheFREDM.."doranum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
...
Redis:set(TheFREDM.."doranum"..msg.sender_id.user_id , coniss)
doraname = "ذره"
Redis:set(TheFREDM.."doraname"..msg.sender_id.user_id , doraname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
dorasize = tonumber(coniss) * 4
dorasizee = dorasize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(dorasizee))
totalypalice = tonumber(ballance) - tonumber(dora)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."doratime"..msg.sender_id.user_id,3320, true)
...
if Redis:get(TheFREDM.."tomtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."tomtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
if Redis:get(TheFREDM.."tomnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
...
Redis:set(TheFREDM.."tomnum"..msg.sender_id.user_id , coniss)
tomname = "ثوم"
Redis:set(TheFREDM.."tomname"..msg.sender_id.user_id , tomname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
tomsize = tonumber(coniss) * 5
tomsizee = tomsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(tomsizee))
totalypalice = tonumber(ballance) - tonumber(tom)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."tomtime"..msg.sender_id.user_id,3620, true)
...
if Redis:get(TheFREDM.."ftrtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."ftrtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
if Redis:get(TheFREDM.."ftrnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
...
Redis:set(TheFREDM.."ftrnum"..msg.sender_id.user_id , coniss)
ftrname = "فطر"
Redis:set(TheFREDM.."ftrname"..msg.sender_id.user_id , ftrname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
ftrsize = tonumber(coniss) * 6
ftrsizee = ftrsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(ftrsizee))
totalypalice = tonumber(ballance) - tonumber(ftr)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."ftrtime"..msg.sender_id.user_id,4220, true)
...
if Redis:get(TheFREDM.."tfahtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."tfahtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
if Redis:get(TheFREDM.."tfahnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
...
Redis:set(TheFREDM.."tfahnum"..msg.sender_id.user_id , coniss)
tfahname = "تفاح"
Redis:set(TheFREDM.."tfahname"..msg.sender_id.user_id , tfahname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
tfahsize = tonumber(coniss) * 10
tfahsizee = tfahsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(tfahsizee))
totalypalice = tonumber(ballance) - tonumber(tfah)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."tfahtime"..msg.sender_id.user_id,5420, true)
...
if Redis:get(TheFREDM.."enabtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."enabtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
if Redis:get(TheFREDM.."enabnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
...
Redis:set(TheFREDM.."enabnum"..msg.sender_id.user_id , coniss)
enabname = "عنب"
Redis:set(TheFREDM.."enabname"..msg.sender_id.user_id , enabname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
enabsize = tonumber(coniss) * 12.5
enabsizee = enabsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(enabsizee))
totalypalice = tonumber(ballance) - tonumber(enab)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."enabtime"..msg.sender_id.user_id,6020, true)
...
if Redis:get(TheFREDM.."zetontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."zetontime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
if Redis:get(TheFREDM.."zetonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
...
Redis:set(TheFREDM.."zetonnum"..msg.sender_id.user_id , coniss)
zetonname = "زيتون"
Redis:set(TheFREDM.."zetonname"..msg.sender_id.user_id , zetonname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
zetonsize = tonumber(coniss) * 15
zetonsizee = zetonsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(zetonsizee))
totalypalice = tonumber(ballance) - tonumber(zeton)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."zetontime"..msg.sender_id.user_id,7220, true)
...
if Redis:get(TheFREDM.."mozztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."mozztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
if Redis:get(TheFREDM.."mozznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
...
Redis:set(TheFREDM.."mozznum"..msg.sender_id.user_id , coniss)
mozzname = "موز"
Redis:set(TheFREDM.."mozzname"..msg.sender_id.user_id , mozzname)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
mozzsize = tonumber(coniss) * 20
mozzsizee = mozzsize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(mozzsizee))
totalypalice = tonumber(ballance) - tonumber(mozz)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."mozztime"..msg.sender_id.user_id,8420, true)
...
if Redis:get(TheFREDM.."mangatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(TheFREDM.."mangatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
if Redis:get(TheFREDM.."manganum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
...
Redis:set(TheFREDM.."manganum"..msg.sender_id.user_id , coniss)
manganame = "مانجا"
Redis:set(TheFREDM.."manganame"..msg.sender_id.user_id , manganame)
mzroatsize = Redis:get(TheFREDM.."mzroatsize"..msg.sender_id.user_id) or 0
mangasize = tonumber(coniss) * 30
mangasizee = mangasize + mzroatsize
Redis:set(TheFREDM.."mzroatsize"..msg.sender_id.user_id , math.floor(mangasizee))
totalypalice = tonumber(ballance) - tonumber(manga)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(TheFREDM.."mangatime"..msg.sender_id.user_id,10220, true)
...
if not Redis:get(TheFREDM.."btatanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
btatanum = Redis:get(TheFREDM.."btatanum"..msg.sender_id.user_id)
btata = tonumber(btatanum) * 100
btataa = tonumber(ballance) + tonumber(btata)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(btataa))
local convert_mony = string.format("%.0f",math.floor(btata))
...
if not Redis:get(TheFREDM.."lemonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
lemonnum = Redis:get(TheFREDM.."lemonnum"..msg.sender_id.user_id)
lemon = tonumber(lemonnum) * 150
lemona = tonumber(ballance) + tonumber(lemon)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(lemona))
local convert_mony = string.format("%.0f",math.floor(lemon))
...
if not Redis:get(TheFREDM.."khessnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
khessnum = Redis:get(TheFREDM.."khessnum"..msg.sender_id.user_id)
khess = tonumber(khessnum) * 200
khessa = tonumber(ballance) + tonumber(khess)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(khessa))
local convert_mony = string.format("%.0f",math.floor(khess))
...
if not Redis:get(TheFREDM.."khearnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
khearnum = Redis:get(TheFREDM.."khearnum"..msg.sender_id.user_id)
khear = tonumber(khearnum) * 250
kheara = tonumber(ballance) + tonumber(khear)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(kheara))
local convert_mony = string.format("%.0f",math.floor(khear))
...
if not Redis:get(TheFREDM.."jzarnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
jzarnum = Redis:get(TheFREDM.."jzarnum"..msg.sender_id.user_id)
jzar = tonumber(jzarnum) * 300
jzara = tonumber(ballance) + tonumber(jzar)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(jzara))
local convert_mony = string.format("%.0f",math.floor(jzar))
...
if not Redis:get(TheFREDM.."fleflanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
fleflanum = Redis:get(TheFREDM.."fleflanum"..msg.sender_id.user_id)
flefla = tonumber(fleflanum) * 350
fleflaa = tonumber(ballance) + tonumber(flefla)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(fleflaa))
local convert_mony = string.format("%.0f",math.floor(flefla))
...
if not Redis:get(TheFREDM.."freaznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
freaznum = Redis:get(TheFREDM.."freaznum"..msg.sender_id.user_id)
freaz = tonumber(freaznum) * 475
freaza = tonumber(ballance) + tonumber(freaz)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(freaza))
local convert_mony = string.format("%.0f",math.floor(freaz))
...
if not Redis:get(TheFREDM.."doranum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
doranum = Redis:get(TheFREDM.."doranum"..msg.sender_id.user_id)
dora = tonumber(doranum) * 600
doraa = tonumber(ballance) + tonumber(dora)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(doraa))
local convert_mony = string.format("%.0f",math.floor(dora))
...
if not Redis:get(TheFREDM.."tomnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
tomnum = Redis:get(TheFREDM.."tomnum"..msg.sender_id.user_id)
tom = tonumber(tomnum) * 725
toma = tonumber(ballance) + tonumber(tom)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(toma))
local convert_mony = string.format("%.0f",math.floor(tom))
...
if not Redis:get(TheFREDM.."ftrnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
ftrnum = Redis:get(TheFREDM.."ftrnum"..msg.sender_id.user_id)
ftr = tonumber(ftrnum) * 800
ftra = tonumber(ballance) + tonumber(ftr)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(ftra))
local convert_mony = string.format("%.0f",math.floor(ftr))
...
if not Redis:get(TheFREDM.."tfahnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
tfahnum = Redis:get(TheFREDM.."tfahnum"..msg.sender_id.user_id)
tfah = tonumber(tfahnum) * 1200
tfaha = tonumber(ballance) + tonumber(tfah)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(tfaha))
local convert_mony = string.format("%.0f",math.floor(tfah))
...
if not Redis:get(TheFREDM.."enabnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
enabnum = Redis:get(TheFREDM.."enabnum"..msg.sender_id.user_id)
enab = tonumber(enabnum) * 1500
enaba = tonumber(ballance) + tonumber(enab)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(enaba))
local convert_mony = string.format("%.0f",math.floor(enab))
...
if not Redis:get(TheFREDM.."zetonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
zetonnum = Redis:get(TheFREDM.."zetonnum"..msg.sender_id.user_id)
zeton = tonumber(zetonnum) * 1800
zetona = tonumber(ballance) + tonumber(zeton)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(zetona))
local convert_mony = string.format("%.0f",math.floor(zeton))
...
if not Redis:get(TheFREDM.."mozznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
mozznum = Redis:get(TheFREDM.."mozznum"..msg.sender_id.user_id)
mozz = tonumber(mozznum) * 2500
mozza = tonumber(ballance) + tonumber(mozz)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(mozza))
local convert_mony = string.format("%.0f",math.floor(mozz))
...
if not Redis:get(TheFREDM.."manganum"..msg.sender_id.user_id) then
...
ballance = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
manganum = Redis:get(TheFREDM.."manganum"..msg.sender_id.user_id)
manga = tonumber(manganum) * 3500
mangaa = tonumber(ballance) + tonumber(manga)
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(mangaa))
local convert_mony = string.format("%.0f",math.floor(manga))
...
if Redis:ttl(TheFREDM.."yiioooo" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(TheFREDM.."yiioooo" .. msg.sender_id.user_id) / 60
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , knez)
local ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id,""..neews.." لقد وجدت كنز\n⇜ الكنز : قطعة اثرية 🗳\n⇜ سعره : 40000 درهم 💵\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
Redis:setex(TheFREDM.."yiioooo" .. msg.sender_id.user_id,1800, true)
elseif Descriptioont == "2" then
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(TheFREDM.."bandid"..coniss,coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:del(TheFREDM.."bandid"..coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(TheFREDM.."morakba"..coniss,coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:del(TheFREDM.."morakba"..coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(TheFREDM.."cobonum"..numcobo,numcobo)
Redis:set(TheFREDM.."cobon"..numcobo,coniss)
...
cobnum = Redis:get(TheFREDM.."cobonum"..coniss)
if coniss == tonumber(cobnum) then
cobblc = Redis:get(TheFREDM.."cobon"..coniss)
ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
cobonplus = ballancee + cobblc
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , cobonplus)
local ballancee = Redis:get(TheFREDM.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:del(TheFREDM.."cobon"..coniss)
Redis:del(TheFREDM.."cobonum"..coniss)
send(msg.chat_id,msg.id, "⌯ وصل كوبون \n\n⇜ المبلغ : "..cobblc.." درهم 💵\n⇜ رقم الكوبون : `"..coniss.."`\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
else
...
Redis:set(TheFREDM.."boob"..Remsg.sender_id.user_id , bajiop)
ccccc = Redis:get(TheFREDM.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(TheFREDM.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(TheFREDM.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(TheFREDM.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(TheFREDM.."tdbelballance"..msg.sender_id.user_id , coniss)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text == 'تبرع' then
if Redis:ttl(TheFREDM.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheFREDM.."tabrotime" .. msg.sender_id.user_id))
...
local user_name = bot.getUser(winner_id).first_name or Redis:get(TheFREDM..winner_id.."first_name:") or "لا يوجد اسم"
tt =  "["..user_name.."]("..user_name..")"
...
Redis:set(TheFREDM.."boob"..msg.sender_id.user_id , math.floor(byre))
taeswq = Redis:get(TheFREDM.."tabbroat"..msg.sender_id.user_id) or 0
pokloo = tonumber(taeswq) + tonumber(coniss)
Redis:set(TheFREDM.."tabbroat"..msg.sender_id.user_id , math.floor(pokloo))
ballanceeed = Redis:get(TheFREDM.."boob"..winner_id) or 0
tekash = tonumber(ballanceeed) + tonumber(coniss)
Redis:set(TheFREDM.."boob"..winner_id , tonumber(tekash))
ballanceeed = Redis:get(TheFREDM.."boob"..winner_id) or 0
Redis:sadd(TheFREDM.."taza",msg.sender_id.user_id)
Redis:setex(TheFREDM.."tabrotime" .. msg.sender_id.user_id,600, true)
...
if Redis:sismember(TheFREDM.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(TheFREDM.."tabbroat"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 1 then
...
ballancee = Redis:get(TheFREDM.."tabbroat"..msg.sender_id.user_id) or 0
local bank_users = Redis:smembers(TheFREDM.."taza")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
...
tabr_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheFREDM.."tabbroat"..v)
