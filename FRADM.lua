...
FRADM = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..FRADM)
bot = Fx.FRADMbots.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=FRADM,token=Token}
chsource = Redis:get(FRADM..'chsource') or "UY_X6"
chdevolper = Redis:get(FRADM..'chdevolper') or "JY_X6"
function var(value)  
...
if v:match(".lua$") and not Redis:sismember(FRADM..'files',v) then
plugin = dofile("plugin/"..v)
if plugin and plugin.FRADM and msg then
results = plugin.FRADM(msg)
end
end
end
end
...
if src_files and src_files.FRADM and msg then
results = src_files.FRADM(msg)
end
end
end
end
...
shh = tostring(text)
if Redis:get(FRADM..'rmzsource') then
shh = shh:gsub(" ◍ ",Redis:get(FRADM..'rmzsource'))
end
local listm = Redis:smembers(FRADM.."Words:r")
for k,v in pairs(listm) do
i ,j  = string.find(shh, v)
if j and i then
local x = string.sub(shh, i,j)
local neww = Redis:get(FRADM.."Word:Replace"..x)  
shh = shh:gsub(x,neww)
else
shh = shh
end
...
sh = tostring(text)
if Redis:get(FRADM..'rmzsource') then
sh = sh:gsub(" ◍ ",Redis:get(FRADM..'rmzsource'))
end
local listm = Redis:smembers(FRADM.."Words:r")
for k,v in pairs(listm) do
...
if Redis:sismember(FRADM.."ControlAll:Groups",UserId) then
ControllerAll = true
end
end
...
mderall = false
local statuse = Redis:sismember(FRADM.."Specialall:Group",senderr)
if statuse then
mderall = true
end
return mderall
...
Status = 0
local Controll2 = Redis:sismember(FRADM.."ControlAll:Groups",UserId)
Devss = Redis:sismember(FRADM.."Devss:Groups",UserId) 
...
local Controll2 = Redis:sismember(FRADM.."ControlAll:Groups",UserId)
Dev = Redis:sismember(FRADM.."Dev:Groups",UserId) 
Devss = Redis:sismember(FRADM.."Devss:Groups",UserId) 
Ownerss = Redis:sismember(FRADM.."Ownerss:Group"..ChatId,UserId) 
SuperCreator = Redis:sismember(FRADM.."SuperCreator:Group"..ChatId,UserId) 
Creator = Redis:sismember(FRADM.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(FRADM.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(FRADM.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(FRADM.."Special:Group"..ChatId,UserId)
...
elseif Dev then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."Developer:Bot:Reply"..ChatId) or 'المطور القميل'
elseif Ownerss then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."PresidentQ:Group:Reply"..ChatId) or  'صاحب الخرابه يواد'
elseif SuperCreator then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي عم الناس'
elseif Creator then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."Constructor:Group:Reply"..ChatId) or 'المنشئ روح قلبي'
elseif Manger then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."Manager:Group:Reply"..ChatId) or 'المدير العثل'
elseif Admin then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."Admin:Group:Reply"..ChatId) or 'الادمن القميل'
elseif StatusMember == "chatMemberStatusCreator" then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or 'مشرف المجموعه'
elseif Special then
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."Vip:Group:Reply"..ChatId) or 'المميز حبيبي الكل'
else
Status = Redis:get(FRADM..'SetRt'..ChatId..':'..UserId) or Redis:get(FRADM.."Mempar:Group:Reply"..ChatId) or 'العضو المسكين'
end  
return Status
end 
...
if Redis:sismember(FRADM.."SuperCreator:Group"..chat,useri)  then
TheBasicsz = "✅"
else
TheBasicsz = "❌"
end
if Redis:sismember(FRADM.."Creator:Group"..chat,useri) then
Originatorsz = "✅"
else
Originatorsz = "❌"
end
if Redis:sismember(FRADM.."Manger:Group"..chat,useri) then
Managersz = "✅"
else
Managersz = "❌"
end
if Redis:sismember(FRADM.."Admin:Group"..chat,useri) then
Addictivez = "✅"
else
Addictivez = "❌"
end
if Redis:sismember(FRADM.."Special:Group"..chat,useri) then
Distinguishedz = "✅"
else
Distinguishedz = "❌"
end
...
if Redis:sismember(FRADM.."chatMemberStatusRestricted"..chat,useri) then
Restricted = "✅"
else
Restricted = "❌"
end
if Redis:sismember(FRADM.."BanGroup"..chat,useri) then
BanGroup = "✅"
else
BanGroup = "❌"
end
if Redis:sismember(FRADM.."SilentGroup:Group"..chat,useri) then
SilentGroup = "✅"
else
SilentGroup = "❌"
end
...
if Redis:get(FRADM.."Lock:phshar"..ChatId) then    
alphsar = "✅"
else 
alphsar = "❌"    
end
if Redis:get(FRADM.."Lock:alkfr"..ChatId) then    
alkfr = "✅"
else 
alkfr = "❌"    
end
if Redis:get(FRADM.."Lock:tphlesh"..ChatId) then    
tphlesh = "✅"
else 
tphlesh = "❌"    
end
if Redis:get(FRADM.."Lock:farsia"..ChatId) then    
farsia = "✅"
else 
farsia = "❌"    
end

if Redis:get(FRADM.."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❌"    
end
if Redis:get(FRADM.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❌"
end
if Redis:get(FRADM.."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❌ "    
end
if Redis:get(FRADM.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❌ "    
end    
if Redis:get(FRADM.."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❌ "    
end    
if Redis:get(FRADM.."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❌ "    
end
if Redis:get(FRADM.."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❌ "    
end
if Redis:hget(FRADM.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(FRADM.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(FRADM.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(FRADM.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❌ "     
end
if Redis:get(FRADM.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(FRADM.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(FRADM.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(FRADM.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(FRADM.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(FRADM.."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(FRADM.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(FRADM.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(FRADM.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(FRADM.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(FRADM.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(FRADM.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(FRADM.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(FRADM.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(FRADM.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(FRADM.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(FRADM.."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(FRADM.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(FRADM.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(FRADM.."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(FRADM.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(FRADM.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(FRADM.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(FRADM.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(FRADM.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(FRADM.."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(FRADM.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(FRADM.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(FRADM.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(FRADM.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(FRADM.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(FRADM.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(FRADM.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(FRADM.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(FRADM.."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(FRADM.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(FRADM.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(FRADM.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(FRADM.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(FRADM.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(FRADM.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(FRADM.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(FRADM.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(FRADM.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(FRADM.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(FRADM.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(FRADM.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
KtmAll = Redis:sismember(FRADM.."KtmAll:Groups",UserId) ,
BanAll = Redis:sismember(FRADM.."BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(FRADM.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(FRADM.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = bot.getChatMember(msg.chat_id,FRADM).status 
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(FRADM..'Chat:Channel:Join'..msg.chat_id)
if Channel then
...
JoinChannel = true
if not Redis:sismember(FRADM.."BotFree:Group:",msg.chat_id) then
local Channel = Redis:get(FRADM..'Channel:Join')
if Channel then
local url , res = https.request('https://api.telegram.org/bot'..Token..'/getchatmember?chat_id=@'..Channel..'&user_id='..senderr)
local ChannelJoin = JSON.decode(url)
if ChannelJoin.result.status == "left" then
...
--[[
if msg.content.voice_note and Redis:get(FRADM..msg_chat_id.."sound:cmd") then 
...
xname =  (Redis:get(FRADM.."Name:Bot") or "صعيدي") 
...
if tonumber(msg.sender_id.user_id) == tonumber(FRADM) then
return false
end 
if text == 'كانسل' and tonumber(senderr) == tonumber(5183920797) then
Redis:del(FRADM..msg.chat_id..'update:')
send(msg.chat_id,msg.id,"ضنن")
end
if Redis:get(FRADM..msg.chat_id..'update:') then
local msgg_idd = tonumber(Redis:get(FRADM..msg.chat_id..'update:'))
...
Redis:set(FRADM..msg.chat_id..'update:',tonumber(msg_idd))
end
...
if Redis:sismember(FRADM.."SilentGroup:Group"..msg.chat_id,"xx"..tonumber(msg.sender_id.chat_id)) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end 
if Redis:get(FRADM.."Lock:SenderChat"..msg_chat_id) then
...
elseif Redis:sismember(FRADM.."Devss:Groups",senderr) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطـور الثانوي '
elseif Redis:sismember(FRADM.."Dev:Groups",senderr) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."Developer:Bot:Reply"..msg.chat_id) or 'المطور القميل'
elseif Redis:sismember(FRADM.."Ownerss:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."PresidentQ:Group:Reply"..msg.chat_id) or  'صاحب الخرابه يواد'
elseif Redis:sismember(FRADM.."SuperCreator:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي عم الناس'
elseif Redis:sismember(FRADM.."Creator:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ روح قلبي'
elseif Redis:sismember(FRADM.."Manger:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."Manager:Group:Reply"..msg.chat_id) or 'المدير القميل'
elseif Redis:sismember(FRADM.."Admin:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."Admin:Group:Reply"..msg.chat_id) or 'الادمن القميل'
elseif Redis:sismember(FRADM.."Special:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."Vip:Group:Reply"..msg.chat_id) or 'المميز حبيبي الكل'
elseif tonumber(senderr) == tonumber(FRADM) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(FRADM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FRADM.."Mempar:Group:Reply"..msg.chat_id) or 'العضو المسكين'
end  
...
for v in io.popen('ls plugin'):lines() do
if Redis:sismember(FRADM..'files',v) then
state = "『 معطل 』"
else 
state = "『 مفعل 』"
end
...
if text then
local neww = Redis:get(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if neww then
text = neww or text
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(FRADM..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(FRADM..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'* ◍ عليك الاشتراك في قناة البوت لأستخدام الاوامر\n√*',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(FRADM..'Channel:Join:Name'), url = 't.me/'..Redis:get(FRADM..'Channel:Join')}, },}}
return send(msg.chat_id,msg.id,'* ◍ عليك الاشتراك في قناة البوت لأستخدام الاوامر\n√*',"md",false, false, false, false, reply_markup)
end
...
if tonumber(FRADM) ~= tonumber(FilesJson.BotId) then
...
Y = Y + 1
Redis:sadd(FRADM..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(FRADM.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(FRADM.."SuperCreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(FRADM.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(FRADM.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(FRADM.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(FRADM.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(FRADM) then 
return send(msg_chat_id,msg_id,' ◍ عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه\n√')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(FRADM.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(FRADM.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(FRADM.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(FRADM.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(FRADM.."SuperCreator:Group"..idg,idASAS)
end;end
end
...
if Redis:get(FRADM.."broadcast") then
...
Redis:setex(FRADM.."general:broadcast" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
---------------------- Dev JABWA ----------------------
if Redis:get(FRADM.."set:chs"..senderr) then
if text then
if text == "الغاء" or text == "الغاء الامر" then
Redis:del(FRADM.."set:chs"..senderr)
return send(msg_chat_id,msg_id,'*◍ تم الغاء الامر بنجاح ✅*',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(FRADM.."chsource",ch)
Redis:del(FRADM.."set:chs"..senderr)
...
Redis:set(FRADM.."set:chs"..senderr,true)
return send(msg_chat_id,msg_id,'*◍ ارسل معرف القناه الان\n√*',"md",true)  
end
if Redis:get(FRADM.."set:rmz"..senderr) then
if text then
if text == "الغاء" or text == "الغاء الامر" then
Redis:del(FRADM.."set:rmz"..senderr)
return send(msg_chat_id,msg_id,'*تم الغاء الامر بنجاح ✅*',"md",true)  
end
Redis:set(FRADM..'rmzsource',text)
Redis:del(FRADM.."set:rmz"..senderr)
...
Redis:set(FRADM.."set:rmz"..senderr,true)
...
Redis:set(FRADM.."rmzsource"," ◍ ")
return send(msg_chat_id,msg_id,'*• تم ارجاع رمز السورس الي { ◍ }\n√*',"md",true)  
end
if Redis:get(FRADM.."set:devs"..senderr) then
if text then
if text == "الغاء" or text == "الغاء الامر" then
Redis:del(FRADM.."set:devs"..senderr)
return send(msg_chat_id,msg_id,'*تم الغاء الامر بنجاح ✅*',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(FRADM.."chdevolper",ch)
Redis:del(FRADM.."set:devs"..senderr)
...
Redis:set(FRADM.."set:devs"..senderr,true)
...
Redis:setex(FRADM.."Change:Source:Bot"..senderr,300,true) 
...
Redis:del(FRADM.."Source:Bot") 
return send(msg_chat_id,msg_id,"* ◍ تم مسح رد الكليشة بنجاح\n√*","md",true)   
end
if text == (Redis:get(FRADM.."Bot:Name") or "صعيدي") then
local photo = bot.getUserProfilePhotos(FRADM)
if photo.total_count > 0 then
local NamesBot = (Redis:get(FRADM.."Bot:Name") or "صعيدي")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == (Redis:get(FRADM.."Name:Bot") or "صعيدي") then
local photo = bot.getUserProfilePhotos(FRADM)
if photo.total_count > 0 then
local NamesBot = (Redis:get(FRADM.."Name:Bot") or "صعيدي")
local Mostafa = {
'• مالك حبيبى 🥺',
'• مخصماك وبعد عني مش طيقاك 😹',
'• مبكلمكش 🥺',
...
local list = Redis:smembers(FRADM..'ChekBotAdd')  
...
local Dev = Redis:smembers(FRADM.."Dev:Groups")
local DevS = Redis:smembers(FRADM.."Devss:Groups")
local set_Json = '{"BotId": '..FRADM..',\n"Dev":['
...
for k,v in pairs(Dev) do 
if not Redis:sismember(FRADM.."Dev:Groups",v) then
Redis:sadd(FRADM.."Dev:Groups",v)
end
end
for k,v in pairs(DevS) do 
if not Redis:sismember(FRADM.."Devss:Groups",v) then
Redis:sadd(FRADM.."Devss:Groups",v)
end
end
...
Redis:set(FRADM.."Reply:Source"..msg_chat_id,true) 
...
Redis:del(FRADM.."Reply:Source"..msg_chat_id) 
...
Redis:set(FRADM.."reply:on"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FRADM.."reply:of"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local app = Redis:smembers(FRADM.."app:reply:Source")
for k,v in pairs(app) do
Redis:del(FRADM.."Add:reply:Source:Gif"..v)   
Redis:del(FRADM.."Add:reply:Source:vico"..v)   
Redis:del(FRADM.."Add:reply:Source:stekr"..v)     
Redis:del(FRADM.."Add:reply:Source:Text"..v)   
Redis:del(FRADM.."Add:reply:Source:Photo"..v)
Redis:del(FRADM.."Add:reply:Source:Video"..v)
Redis:del(FRADM.."Add:reply:Source:File"..v)
Redis:del(FRADM.."Add:reply:Source:Audio"..v)
Redis:del(FRADM.."Add:reply:Source:video_note"..v)
Redis:del(FRADM.."app:reply:Source")
end
...
text = "\n ◍ قائمة ردود السورس ⇞⇟\n══════× َ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳 ×══════\n"
for k,v in pairs(app) do
if Redis:get(FRADM.."Add:reply:Source:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(FRADM.."Add:reply:Source:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(FRADM.."Add:reply:Source:stekr"..v) then
db = "ملصق 🧿"
elseif Redis:get(FRADM.."Add:reply:Source:Text"..v) then
db = "رساله ✉"
elseif Redis:get(FRADM.."Add:reply:Source:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(FRADM.."Add:reply:Source:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(FRADM.."Add:reply:Source:File"..v) then
db = "ملف ◍ "
elseif Redis:get(FRADM.."Add:reply:Source:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(FRADM.."Add:reply:Source:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
local id = Redis:get(FRADM.."id:JABWA:Groups")
...
---------------------- Dev JABWA ----------------------
if (Redis:get(FRADM.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ❌' then   
Redis:del(FRADM.."AddSudosNew"..msg_chat_id)
...
Redis:setex(FRADM..'welcom_ph:witting'..senderr,300,true) 
...
Redis:set(FRADM..'Num:Add:Bot',text:match("تعيين عدد الاعضاء (%d+)$") ) 
...
local JABWA = "*• عدد المشتركين -> "..(Redis:scard(FRADM..'Num:User:Pv') or 0).." 🥺❤️\n√*"
send(msg_chat_id,msg_id, JABWA,"md",true)   
end
...
local JABWA = "*• عدد الجروبات -> "..(Redis:scard(FRADM..'ChekBotAdd') or 0).." 🥺❤️\n√*"
send(msg_chat_id,msg_id, JABWA,"md",true)   
end
...
local JABWA = "*• عدد الجروبات -> "..(Redis:scard(FRADM..'ChekBotAdd') or 0).." 🥺❤️\n• عدد المشتركين -> "..(Redis:scard(FRADM..'Num:User:Pv') or 0).." 🥺❤️\n√*"
send(msg_chat_id,msg_id, JABWA,"md",true)   
end
---------------------- Dev JABWA ----------------------
if text == "تفعيل" then
...
if Redis:sismember(FRADM..'Black:listBan:',msg_chat_id) then
return send(msg_chat_id,msg_id,"* ◍ عذرآ الجروب محظوره من التفعيل *","md",true)  
end
if Redis:sismember(FRADM.."ChekBotAdd",msg_chat_id) then
return send(msg_chat_id,msg_id,'* • الجروب مفعل من قبل\n√*',"md",true)  
end
Redis:sadd(FRADM.."ChekBotAdd",msg_chat_id)
...
if Info_Members.members[k].status.FRADMbots == "chatMemberStatusCreator" then
...
if Info_Members.members[k].status.FRADMbots == "chatMemberStatusCreator" then
Redis:sadd(FRADM.."Ownerss:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(FRADM.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:srem(FRADM.."ChekBotAdd",msg_chat_id)
Redis:del(FRADM.."Admin:Group"..msg_chat_id) 
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local Text = "*• تم تعطيل جروب "..Get_Chat.title.."\n• وتنزيل الادمن من الرتبه\n√*"
if not Redis:sismember(FRADM.."ChekBotAdd",msg_chat_id) then
...
---------------------- Dev JABWA ----------------------
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(FRADM.."ChekBotAdd",msg_chat_id) then
Redis:incr(FRADM..'Num:Message:User'..msg.chat_id..':'..senderr) 

if text then
local GetMsg = Redis:incr(FRADM..'Num:Message:User'..msg.chat_id..':'..senderr) 
Redis:hset(FRADM..':GroupUserCountMsg:'..msg.chat_id,senderr,GetMsg)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(FRADM..':GroupNameUser:'..msg.chat_id,senderr,NameLUser)
end
---------------------- Dev JABWA ----------------------
if text == "ترند" then
...
GroupAllRtba = Redis:hgetall(FRADM..':GroupUserCountMsg:'..msg.chat_id)
GetAllNames  = Redis:hgetall(FRADM..':GroupNameUser:'..msg.chat_id)
GroupAllRtbaL = {}
...
GroupAllRtba = Redis:hgetall(FRADM..':GroupUserCountMsg:groups')
GetAllNames  = Redis:hgetall(FRADM..':GroupNameUser:groups')
GroupAllRtbaL = {}
for k,v in pairs(GroupAllRtba) do table.insert(GroupAllRtbaL,{v,k}) end
Count,Kount,i = 8 , 0 , 1
for _ in pairs(GroupAllRtbaL) do Kount = Kount + 1 end
...
local GetMsg = Redis:incr(FRADM..'FRADM:MsgNumbergroups'..msg.chat_id) or 1
Redis:hset(FRADM..':GroupUserCountMsg:groups',msg.chat_id,GetMsg)
end
...
Redis:sadd(FRADM.."Black:listBan:",Chatid)
...
Redis:srem(FRADM.."Black:listBan:",Chatid)
...
if Redis:sismember(FRADM.."KtmAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ◍ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FRADM.."KtmAll:Groups",UserId_Info.id) 
...
local Groups = (Redis:scard(FRADM..'ChekBotAdd') or 0)
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if ban and ban.type and ban.type.FRADMbots == "userTypeBot" then
...
if Redis:sismember(FRADM.."KtmAll:Groups",Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"◍ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FRADM.."KtmAll:Groups",Message_Reply.sender_id.user_id) 
...
local Info_Members = Redis:smembers(FRADM.."KtmAll:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ◍ لا يوجد مكتومين عام حاليا , ","md",true)  
end
Redis:del(FRADM.."KtmAll:Groups") 
...
Redis:set(FRADM.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(FRADM.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"◍ ارسل السؤال الان\n√")
end
...
local list = Redis:smembers(FRADM.."gamebot:new1")
t = " ◍ الاسئله المضافه \n"
for k,v in pairs(list) do
t = t..""..k.." ◍ -> ( "..v.." )\n"
end
...
Redis:set(FRADM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and Redis:get(FRADM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
Redis:del(FRADM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:sadd(FRADM.."joke:", text)
...
Redis:set(FRADM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id, "rmjoke")
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and Redis:get(FRADM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id) == "rmjoke" then
Redis:del(FRADM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:srem(FRADM.."joke:", text)
...
Redis:del(FRADM.."gamebot:new1")
return send(msg_chat_id,msg_id,"*◍ تم مسح الاسئله\n√*","md")
end
if text == 'اسالني' then
if not Redis:get(FRADM.."Status:Games"..msg.chat_id) then
return false
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(FRADM..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(FRADM..'Chat:Channel:Join'..msg.chat_id)}, },}}
...
if not Redis:get(FRADM..'lock_geams'..msg.chat_id) then
local list = Redis:smembers(FRADM.."gamebot:new1")
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(FRADM.."gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(FRADM.."gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(FRADM.."gamebot:newqus:as3"..quschen)
local ansar0 = Redis:get(FRADM.."gamebot:newqus:as0"..quschen)
local ansar4 = Redis:get(FRADM.."gamebot:newqus:as4"..quschen)
...
Redis:set(FRADM.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(FRADM.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id," ◍ ارسل اللغز الان\n√")
end
...
local list = Redis:smembers(FRADM.."lkz:gamebot:new1")
t = " ◍ الالغاز "
for k,v in pairs(list) do
t = t..""..k.." ◍ -> ("..v.." )\n"
end
...
Redis:del(FRADM.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(FRADM.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(FRADM.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(FRADM.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(FRADM.."lkz:gamebot:newqus:as4"..quschen)
if ansar1 == ansar4 then
testt = 'ansar1'
elseif ansar2 == ansar4 then
testt = 'ansar2'
...
---------------------- Dev JABWA ----------------------
if Redis:get(FRADM..'Set:array'..senderr..':'..msg_chat_id) == 'true1' then
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
local test = Redis:get(FRADM..'Text:array'..senderr..':'..msg_chat_id..'')
Redis:sadd(FRADM.."Add:Rd:array:Text"..test,text)  
_key = {
...
if text then
if Redis:get(FRADM.."Set:array:Ssd"..senderr..":"..msg_chat_id) == 'dttd' then
Redis:del(FRADM.."Set:array:Ssd"..senderr..":"..msg_chat_id)
gery = Redis:get(FRADM.."Set:array:addpu"..senderr..":"..msg_chat_id)
if not Redis:sismember(FRADM.."Add:Rd:array:Text"..gery,text) then
send(msg_chat_id, msg_id,'* ◍ لا يوجد رد متعدد\n√*',"md",true)
return false
end
Redis:srem(FRADM.."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,'* ◍ تم حذفه بنجاح\n√*',"md",true)
end
end
if text then
if Redis:get(FRADM.."Set:array:Ssd"..senderr..":"..msg_chat_id) == 'delrd' then
Redis:del(FRADM.."Set:array:Ssd"..senderr..":"..msg_chat_id)
if not Redis:sismember(FRADM..'List:array',text) then
send(msg_chat_id, msg_id,'* ◍ لا يوجد رد متعدد\n√*',"md",true)
return false
end
Redis:set(FRADM.."Set:array:addpu"..senderr..":"..msg_chat_id,text)
Redis:set(FRADM.."Set:array:Ssd"..senderr..":"..msg_chat_id,"dttd")
...
Redis:set(FRADM.."Set:array:Ssd"..senderr..":"..msg_chat_id,"delrd")
return false 
end
if text then
if Redis:get(FRADM.."Set:array"..senderr..":"..msg_chat_id) == 'true' then
Redis:sadd(FRADM..'List:array', text)
Redis:set(FRADM..'Text:array'..senderr..':'..msg_chat_id, text)
send(msg_chat_id, msg_id,'*◍ ارسل الرد الذي تريد اضافته\n√*',"md",true)
Redis:del(FRADM.."Set:array"..senderr..":"..msg_chat_id)
Redis:set(FRADM..'Set:array'..senderr..':'..msg_chat_id,'true1')
Redis:del(FRADM.."Add:Rd:array:Text"..text)   
return false
end
end

if text then
if Redis:get(FRADM.."Set:array:rd"..senderr..":"..msg_chat_id) == 'delrd' then
Redis:del(FRADM.."Set:array:rd"..senderr..":"..msg_chat_id)
Redis:del(FRADM.."Add:Rd:array:Text"..text)
Redis:srem(FRADM..'List:array', text)
...
send_inlin_key(msg_chat_id,"*◍ ارسل الكلمه التي تريد حذفها\n√*",inlin,msg_id)
Redis:set(FRADM.."Set:array:rd"..senderr..":"..msg_chat_id,"delrd")
return false 
end
if text then
if  Redis:sismember(FRADM..'List:array',text) then
local list = Redis:smembers(FRADM.."Add:Rd:array:Text"..text)
...
local list = Redis:smembers(FRADM..'List:array')
...
local list = Redis:smembers(FRADM..'List:array')
for k,v in pairs(list) do
Redis:del(FRADM.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(FRADM..'List:array'..msg_chat_id)
end
...
Redis:set(FRADM.."Set:array"..senderr..":"..msg_chat_id,true)
return false
end
...
TotalMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
TotalMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..rep_idd) or 0
TotalMsgT = Total_message(TotalMsg) 
return send(msg_chat_id,msg_id," ◍ التفاعل -> "..TotalMsgT, "md")
end
...
if Message_Reply.FRADMbots == "error" then
...
if not Redis:get(FRADM.."Status:Id"..msg_chat_id) then
return false
end
local UserInfo = bot.getUser(senderr)
...
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.FRADMbots
if (StatusMember == "chatMemberStatusCreator") then
...
if (StatusMember.status.FRADMbots == "chatMemberStatusCreator") then
local Lakb = ' '..Lakb..' '
else
Lakb = 'لا يوجد لك لقب'
end
local UserId = senderr
local Num = Redis:get(FRADM.."Num:Add:Games"..msg.chat_id..senderr) or 0
local Text = Redis:get(FRADM.."Num:Add:Memp"..msg.chat_id..senderr) or 0
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(FRADM..'Num:Message:Edit'..msg_chat_id..senderr) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(FRADM.."Num:Add:Games"..msg.chat_id..senderr) or 0
local NumAdd = Redis:get(FRADM.."Num:Add:Memp"..msg.chat_id..":"..senderr) or 0
local Texting = {
"〈 جمالك ده طبيعي يولا 🙈💗 〉",
...
Get_Is_Id = Redis:get(FRADM.."Set:Id:Groups") or Redis:get(FRADM.."Set:Id:Group"..msg_chat_id)
if Redis:get(FRADM.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
if photo.total_count > 0 then
if not msg.Special and Redis:get(FRADM..'idnotmem'..msg.chat_id)  then
return send(msg_chat_id,msg_id,
'*\n'..Description..'\n💎╖ ايدِيڪ ⇇ '..UserId..
'\n🐣╢ اسمڪ ⇇ '..nameuser..
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if UserInfo and UserInfo.type and UserInfo.type.FRADMbots == "userTypeBot" then
...
local RinkBot = Controller(msg_chat_id,rep_idd)
local TotalMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..rep_idd) or 0
local TotalEdit = Redis:get(FRADM..'Num:Message:Edit'..msg_chat_id..rep_idd) or 0
local TotalMsgT = Total_message(TotalMsg) 
if Redis:get(FRADM.."Status:IdPhoto"..msg_chat_id) then
if photo.total_count > 0 then
if not msg.Special and Redis:get(FRADM..'idnotmem'..msg.chat_id)  then
...
local TotalMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(FRADM..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(FRADM.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(FRADM.."Num:Add:Games"..msg.chat_id..UserId) or 0
if UserInfo.luatele  == "error" and UserInfo.code == 6 then
...
local RinkBot = Controller(msg_chat_id,UserId_Info.id)
local TotalMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(FRADM..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return send(msg_chat_id,msg_id,
'*\n🎭╖ الاسم ->* '..Text..
'*\n🗽╢ الايدي -> '..UserId..
...
local StatusMember = bot.getChatMember(msg_chat_id,FRADM).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return send(msg_chat_id,msg_id,' ◍ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = bot.getChatMember(msg_chat_id,FRADM).status 
if GetMemberStatus.can_change_info then
change_info = '✅' else change_info = '❌'
end
if GetMemberStatus.can_delete_messages then
...
Redis:sadd(FRADM.."allM"..msg.chat_id, msg.id)
if Redis:get(FRADM.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(FRADM.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(FRADM.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(FRADM.."allM"..msg.chat_id)
...
Redis:del(FRADM.."allM"..msg.chat_id)
end
end
end
...
Redis:set(FRADM.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(FRADM.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(FRADM.."allM"..msg.chat_id)  
...
for k, v in pairs(List_Members) do
local UserInfo = bot.getUser(v.member_id.user_id)
if Info_Members.members[k].status.FRADMbots == "chatMemberStatusAdministrator" then
x = x + 1
Admin = ' ⇿〘  ادمن 〙'
else
Admin = " ⇿〘  عضو 〙"
...
local Bot_Name = (Redis:get(FRADM.."Name:Bot") or "صعيدي")
if text then
...
Redis:set(FRADM.."Lock:SenderChat"..msg_chat_id,true) 
...
Redis:del(FRADM.."Lock:SenderChat"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:phshar"..msg_chat_id,true) 
...
Redis:del(FRADM.."Lock:phshar"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:alkfr"..msg_chat_id,true) 
...
Redis:del(FRADM.."Lock:alkfr"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:english"..msg_chat_id,true) 
...
Redis:del(FRADM.."Lock:english"..msg_chat_id) 
send(msg_chat_id,msg_id,Reply_Status(senderr," ◍ تم فتح الانكليزيه").unLock,"md",true)  
return false
end 
---------------------- Dev JABWA ----------------------
if text == "صورتي" then
if Redis:get(FRADM.."myphoto"..msg.chat_id) then
...
if Redis:get(FRADM.."hisphoto"..msg_chat_id) == "off" then
...
Redis:set(FRADM..'SOFI:Channe:Vip'..senderr,UserId)
...
if not Redis:get(FRADM..'SOFI:Channe:Vip'..senderr) then
...
Redis:del(FRADM..'SOFI:Channe:Vip'..senderr)
...
if Redis:get(FRADM..'SetChanneVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ◍ تم الغاء حفظ قناتك *',"md",true)  
Redis:del(FRADM..'SetChanneVip'..senderr)
return false  
end 
Redis:del(FRADM..'SetChanneVip'..senderr)
Redis:set(FRADM..'SOFI:Channe:Vip'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FRADM..'SetChanneVip'..senderr,true)
return false
end
...
local rules = Redis:get(FRADM..'SOFI:Channe:Vip'..senderr)
bot.sendText(msg_chat_id,msg_id, rules,"html",true)
end
end
if Redis:get(FRADM..'SetGroupVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ◍ تم الغاء حفظ جروبك *',"md",true)  
Redis:del(FRADM..'SetGroupVip'..senderr)
return false  
end 
Redis:del(FRADM..'SetGroupVip'..senderr)
Redis:set(FRADM..'SOFI:Group:Vip'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FRADM..'SetGroupVip'..senderr,true)
return false
end
if Redis:get(FRADM..'SetnameVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ◍ تم الغاء حفظ اسمك 💥*',"md",true)  
Redis:del(FRADM..'SetnameVip'..senderr)
return false  
end 
Redis:del(FRADM..'SetnameVip'..senderr)
Redis:set(FRADM..'Game:name'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FRADM..'SetnameVip'..senderr,true)
return false
end
if Redis:get(FRADM..'SetSunniVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ◍ تم الغاء حفظ سنك ⏺️ *',"md",true)  
Redis:del(FRADM..'SetSunniVip'..senderr)
return false  
end 
Redis:del(FRADM..'SetSunniVip'..senderr)
Redis:set(FRADM..'Game:Sunni'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FRADM..'SetSunniVip'..senderr,true)
return false
end
if Redis:get(FRADM..'SetBotVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ◍ تم الغاء حفظ بوتك 🤖 *',"md",true)  
Redis:del(FRADM..'SetBotVip'..senderr)
return false  
end 
Redis:del(FRADM..'SetBotVip'..senderr)
Redis:set(FRADM..'SOFI:Bot:Vip'..senderr,text)
...
Redis:set(FRADM.."Lock:tphlesh"..msg_chat_id,true) 
Redis:del(FRADM.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(FRADM.."Lock:tphlesh"..msg_chat_id)  
Redis:set(FRADM.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(FRADM.."Lock:farsia"..msg_chat_id,true) 
...
Redis:del(FRADM.."Lock:farsia"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:text"..msg_chat_id,true) 
...
Redis:set(FRADM.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(FRADM.."lockpin"..msg_chat_id,(bot.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(FRADM.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(FRADM.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(FRADM..''..lock..msg_chat_id,"del")    
end
...
Redis:set(FRADM.."Lock:AlUasat"..msg_chat_id,"del")  
...
Redis:del(FRADM.."Lock:AlUasat"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Animation"..msg_chat_id,"del")  
Redis:set(FRADM.."Lock:Photo"..msg_chat_id,"del")  
Redis:set(FRADM.."Lock:vico"..msg_chat_id,"del")  
Redis:set(FRADM.."Lock:Audio"..msg_chat_id,"del")  
Redis:set(FRADM.."Lock:Sticker"..msg_chat_id,"del")  
Redis:set(FRADM.."Lock:Video"..msg_chat_id,"del")  
...
Redis:del(FRADM.."Lock:Animation"..msg_chat_id)  
Redis:del(FRADM.."Lock:Photo"..msg_chat_id)  
Redis:del(FRADM.."Lock:vico"..msg_chat_id)  
Redis:del(FRADM.."Lock:Audio"..msg_chat_id)  
Redis:del(FRADM.."Lock:Sticker"..msg_chat_id)  
Redis:del(FRADM.."Lock:Video"..msg_chat_id)  
...
Redis:del(FRADM.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(FRADM.."Lock:text"..msg_chat_id)  
...
Redis:del(FRADM.."Lock:Join"..msg_chat_id)  
...
Redis:del(FRADM.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(FRADM.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(FRADM.."lockpin"..msg_chat_id)  
...
Redis:del(FRADM.."Lock:edit"..msg_chat_id) 
...
Redis:del(FRADM.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(FRADM..''..lock..msg_chat_id)    
end
...
Redis:hset(FRADM.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(FRADM.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(FRADM.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(FRADM.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(FRADM.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(FRADM.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Link"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:geam"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:set(FRADM.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:forward"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Document"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Contact"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Spam"..msg_chat_id)  
...
Redis:set(FRADM.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(FRADM.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(FRADM.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(FRADM.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(FRADM.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(FRADM.."Set:Link"..msg_chat_id..""..senderr,120,true) 
...
Redis:del(FRADM.."Group:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ◍ تم مسح الرابط\n√*","md",true)             
end
if text == "الرابط" then
if not Redis:get(FRADM.."Status:Link"..msg_chat_id) then
return send(msg_chat_id,msg_id,"* ◍ تم تعطيل الرابط من قبل الادارة\n√*","md",true)
end 
local Get_Chat = bot.getChat(msg_chat_id)
local GetLink = Redis:get(FRADM.."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
Redis:set(FRADM.."Group:Link"..msg_chat_id,LinkGroup.invite_link) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
Redis:setex(FRADM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr, 120, true)  
local textett =[[
...
local Welcome = Redis:get(FRADM.."Welcome:Groups")
if Welcome then 
...
Redis:del(FRADM.."Welcome:Groups") 
return send(msg_chat_id,msg_id,"* ◍ تم ازالة الترحيب العام في المجموعات\n√*","md",true)   
end

if Redis:get(FRADM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr) then 
if text == "الغاء" then 
Redis:del(FRADM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
return send(msg_chat_id,msg_id,"* ◍ تم الغاء حفظ الترحيب عام\n√*","md",true)   
end 
Redis:del(FRADM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
Redis:set(FRADM.."Welcome:Groups",text) 
...
Redis:setex(FRADM.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. senderr, 120, true)  
local textett =[[
 ◍ ارسل لي الترحيب عام الان
 ◍ تستطيع اضافة مايلي !
يمكنك استخدام الدوال الاتيه 
...
if not Redis:get(FRADM.."Status:Welcome"..msg_chat_id) then
return send(msg_chat_id,msg_id,"* ◍ تم تعطيل الترحيب من قبل الادمنيه\n√*","md",true)
end 
local Welcome = Redis:get(FRADM.."Welcome:Group"..msg_chat_id)
if Welcome then 
return send(msg_chat_id,msg_id,Welcome,"md",true)   
else 
...
Redis:del(FRADM.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(FRADM.."Set:Rules:" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
Redis:del(FRADM.."Group:Rules"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ◍ تم ازالة قوانين الجروب\n√*","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(FRADM.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(FRADM.."Set:Description:" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
Redis:set(FRADM.."Chat:Photo"..msg_chat_id..":"..senderr,true) 
...
local list = Redis:smembers(FRADM.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(FRADM.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(FRADM.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(FRADM.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(FRADM..'FilterText'..msg_chat_id..':'..senderr,'true')
...
Redis:set(FRADM..'FilterText'..msg_chat_id..':'..senderr,'DelFilter')
return send(msg_chat_id,msg_id,'* ◍ ارسل الان { ملصق ,متحركه ,صوره ,رساله }\n√*',"md",true)  
end
...
Redis:set(FRADM.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender_id.user_id,"true") 
...
Redis:set(FRADM.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender_id.user_id,"true") 
...
local list = Redis:smembers(FRADM.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(FRADM.."All:Get:Reides:Commands:Group"..v)
Redis:del(FRADM.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(FRADM.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(FRADM.."Command:Reids:Group"..msg_chat_id..":"..senderr,"true") 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FRADM.."Command:Reids:Group:Del"..msg_chat_id..":"..senderr,"true") 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FRADM.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(FRADM.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k.." ⇿『 "..v.." 』->『 "..Commands.." 』\n"
else
Command = Command..""..k.." ⇿『 "..v.." 』\n"
...
if Redis:get(FRADM.."Status:Link"..msg.chat_id) then
Statuslink = '✅' else Statuslink = '❌'
end
if Redis:get(FRADM.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '✅' else StatusWelcome = '❌'
end
if Redis:get(FRADM.."Status:Id"..msg.chat_id) then
StatusId = '✅' else StatusId = '❌'
end
if Redis:get(FRADM.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '✅' else StatusIdPhoto = '❌'
end
if Redis:get(FRADM.."Status:Reply"..msg.chat_id) then
StatusReply = '✅' else StatusReply = '❌'
end
if Redis:get(FRADM.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '✅' else StatusReplySudo = '❌'
end
if Redis:get(FRADM.."Status:BanId"..msg.chat_id)  then
StatusBanId = '✅' else StatusBanId = '❌'
end
if Redis:get(FRADM.."Status:SetId"..msg.chat_id) then
StatusSetId = '✅' else StatusSetId = '❌'
end
if Redis:get(FRADM.."Status:Games"..msg.chat_id) then
StatusGames = '✅' else StatusGames = '❌'
end
if Redis:get(FRADM.."Status:KickMe"..msg.chat_id) then
Statuskickme = '✅' else Statuskickme = '❌'
end
if Redis:get(FRADM.."Status:AddMe"..msg.chat_id) then
...
if Redis:sismember(FRADM.."Devss:Groups",rep_idd) then
devQ = "المطور الثانوي ،" 
else 
devQ = "" 
end
if Redis:sismember(FRADM.."Dev:Groups",rep_idd) then
dev = "المطور ،" 
else 
dev = "" 
end
if Redis:sismember(FRADM.."Ownerss:Group"..msg_chat_id, rep_idd) then
crrQ = "المالك ،" 
else 
crrQ = "" 
end
if Redis:sismember(FRADM.."SuperCreator:Group"..msg_chat_id, rep_idd) then
crr = "منشئ اساسي ،" 
else 
crr = "" 
end
if Redis:sismember(FRADM..'Creator:Group'..msg_chat_id, rep_idd) then
cr = "منشئ ،" 
else 
cr = "" 
end
if Redis:sismember(FRADM..'Manger:Group'..msg_chat_id, rep_idd) then
own = "مدير ،" 
else 
own = "" 
end
if Redis:sismember(FRADM..'Admin:Group'..msg_chat_id, rep_idd) then
mod = "ادمن ،" 
else 
mod = "" 
end
if Redis:sismember(FRADM..'Special:Group'..msg_chat_id, rep_idd) then
vip = "مميز ،" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(FRADM.."Devss:Groups",rep_idd)  then
Rink = 2
elseif Redis:sismember(FRADM.."Dev:Groups",rep_idd)  then
Rink = 3
elseif Redis:sismember(FRADM.."Ownerss:Group"..msg_chat_id, rep_idd) then
Rink = 4
elseif Redis:sismember(FRADM.."SuperCreator:Group"..msg_chat_id, rep_idd) then
Rink = 5
elseif Redis:sismember(FRADM.."Creator:Group"..msg_chat_id, rep_idd) then
Rink = 6
elseif Redis:sismember(FRADM.."Manger:Group"..msg_chat_id, rep_idd) then
Rink = 7
elseif Redis:sismember(FRADM.."Admin:Group"..msg_chat_id, rep_idd) then
Rink = 8
elseif Redis:sismember(FRADM.."Special:Group"..msg_chat_id, rep_idd) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(FRADM.."Devss:Groups",rep_idd)
Redis:srem(FRADM.."Dev:Groups",rep_idd)
Redis:srem(FRADM.."Ownerss:Group"..msg_chat_id, rep_idd)
Redis:srem(FRADM.."SuperCreator:Group"..msg_chat_id, rep_idd)
Redis:srem(FRADM.."Creator:Group"..msg_chat_id, rep_idd)
Redis:srem(FRADM.."Manger:Group"..msg_chat_id, rep_idd)
Redis:srem(FRADM.."Admin:Group"..msg_chat_id, rep_idd)
Redis:srem(FRADM.."Special:Group"..msg_chat_id, rep_idd)
...
if Redis:sismember(FRADM.."Devss:Groups",UserId_Info.id) then
devQ = "المطور الثانوي ،" 
else 
devQ = "" 
end
if Redis:sismember(FRADM.."Dev:Groups",UserId_Info.id) then
dev = "المطور ،" 
else 
dev = "" 
end
if Redis:sismember(FRADM.."Ownerss:Group"..msg_chat_id, UserId_Info.id) then
crrQ = "المالك ،" 
else 
crrQ = "" 
end
if Redis:sismember(FRADM.."SuperCreator:Group"..msg_chat_id, UserId_Info.id) then
crr = "منشئ اساسي ،" 
else 
crr = "" 
end
if Redis:sismember(FRADM..'Creator:Group'..msg_chat_id, UserId_Info.id) then
cr = "منشئ ،" 
else 
cr = "" 
end
if Redis:sismember(FRADM..'Manger:Group'..msg_chat_id, UserId_Info.id) then
own = "مدير ،" 
else 
own = "" 
end
if Redis:sismember(FRADM..'Admin:Group'..msg_chat_id, UserId_Info.id) then
mod = "ادمن ،" 
else 
mod = "" 
end
if Redis:sismember(FRADM..'Special:Group'..msg_chat_id, UserId_Info.id) then
vip = "مميز ،" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(FRADM.."Devss:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(FRADM.."Dev:Groups",UserId_Info.id)  then
Rink = 3
elseif Redis:sismember(FRADM.."Ownerss:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(FRADM.."SuperCreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(FRADM.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(FRADM.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
elseif Redis:sismember(FRADM.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 8
elseif Redis:sismember(FRADM.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(FRADM.."Devss:Groups",UserId_Info.id)
Redis:srem(FRADM.."Dev:Groups",UserId_Info.id)
Redis:srem(FRADM.."Ownerss:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FRADM.."SuperCreator:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FRADM.."Creator:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FRADM.."Manger:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FRADM.."Admin:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FRADM.."Special:Group"..msg_chat_id, UserId_Info.id)
elseif msg.Devss then
if Rink == 2 or Rink < 2 then
return send(msg_chat_id,msg_id,"\n* ◍ لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  
end
...
Redis:del(FRADM.."SuperCreator:Group"..msg_chat_id)
Redis:del(FRADM.."Creator:Group"..msg_chat_id)
Redis:del(FRADM.."Manger:Group"..msg_chat_id)
Redis:del(FRADM.."Admin:Group"..msg_chat_id)
--Redis:del(FRADM.."Special:Group"..msg_chat_id)
...
Redis:hset(FRADM.."Spam:Group:User"..msg_chat_id ,"Num:Spam",Numbardel)  
...
Redis:del(FRADM..'Num:Message:User'..msg.chat_id..':'..senderr)
...
Redis:del(FRADM..'Num:Message:Edit'..msg.chat_id..senderr)
...
Redis:del(FRADM..'Num:Add:Memp'..msg.chat_id..':'..senderr)
...
send(msg_chat_id,msg_id,' ◍ عدد رسائلك هنا *~ '..(Redis:get(FRADM..'Num:Message:User'..msg.chat_id..':'..senderr) or 1)..'*',"md",true)  
...
send(msg_chat_id,msg_id,' ◍ عدد التعديلات هنا *~ '..(Redis:get(FRADM..'Num:Message:Edit'..msg.chat_id..senderr) or 0)..'*',"md",true)  
...
send(msg_chat_id,msg_id,' ◍ عدد جهاتك المضافه هنا *~ '..(Redis:get(FRADM.."Num:Add:Memp"..msg.chat_id..":"..senderr) or 0)..'*',"md",true)  
...
Redis:setex(FRADM.."Redis:Id:Group"..msg.chat_id..""..senderr,240,true)  
return send(msg_chat_id,msg_id,[[*
...
Redis:del(FRADM.."Set:Id:Group"..msg.chat_id)
...
Redis:set(FRADM.."Set:Id:Group"..msg.chat_id,Text_Rand)
...
Redis:setex(FRADM.."Redis:Id:Groups"..msg.chat_id..""..senderr,240,true)  
return send(msg_chat_id,msg_id,[[*
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
, يمكنك الان الاضافه ،
...
local Info_Members = Redis:smembers(FRADM.."Devss:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ◍ لا يوجد مطورين ثانوين حاليا , ","md",true)  
end
Redis:del(FRADM.."Devss:Groups") 
...
local Info_Members = Redis:smembers(FRADM.."Dev:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"*◍ لا يوجد مطورين حاليا\n√*","md",true)  
end
Redis:del(FRADM.."Dev:Groups") 
...
local Info_Memberss = Redis:smembers(FRADM.."Ownerss:Group"..msg_chat_id) 
if #Info_Memberss == 0 then
return send(msg_chat_id,msg_id," ◍ لا يوجد المالكين حاليا , ","md",true)  
end
Redis:del(FRADM.."Ownerss:Group"..msg_chat_id) 
local Info_Members = bot.getSupergroupMembers(msg_chat_id, "Administrators", "*", 0, 200)
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
if Info_Members.members[k].bot_info == nil then
...
local Info_Members = Redis:smembers(FRADM.."SuperCreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FRADM.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FRADM.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FRADM.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FRADM.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FRADM.."BanAll:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ◍ لا يوجد محظورين عام حاليا , ","md",true)  
end
Redis:del(FRADM.."BanAll:Groups") 
...
local Info_Members = Redis:smembers(FRADM.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ◍ لا يوجد محظورين حاليا , ","md",true)  
end
Redis:del(FRADM.."BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(FRADM.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ◍ لا يوجد مكتومين حاليا , ","md",true)  
end
Redis:del(FRADM.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(FRADM.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(FRADM.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(FRADM.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(FRADM.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(FRADM.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(FRADM.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(FRADM.."List:Manager"..msg_chat_id)
end
...
text = " ◍ قائمه الردود \n══════× َ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳 ×══════\n"
for k,v in pairs(list) do
if Redis:get(FRADM.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(FRADM.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(FRADM.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🧿"
elseif Redis:get(FRADM.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(FRADM.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(FRADM.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو ??"
elseif Redis:get(FRADM.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(FRADM.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
Redis:set(FRADM.."Set:Manager:rd"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FRADM.."Set:Manager:rd"..senderr..":"..msg_chat_id,"true2")
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FRADM.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(FRADM.."Add:Rd:Sudo:Gif"..v)   
Redis:del(FRADM.."Add:Rd:Sudo:vico"..v)   
Redis:del(FRADM.."Add:Rd:Sudo:stekr"..v)     
Redis:del(FRADM.."Add:Rd:Sudo:Text"..v)   
Redis:del(FRADM.."Add:Rd:Sudo:Photo"..v)
Redis:del(FRADM.."Add:Rd:Sudo:Video"..v)
Redis:del(FRADM.."Add:Rd:Sudo:File"..v)
Redis:del(FRADM.."Add:Rd:Sudo:Audio"..v)
Redis:del(FRADM.."Add:Rd:Sudo:video_note"..v)
Redis:del(FRADM.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n══════× َ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳 ×══════\n"
for k,v in pairs(list) do
if Redis:get(FRADM.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(FRADM.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(FRADM.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🧿"
elseif Redis:get(FRADM.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(FRADM.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(FRADM.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(FRADM.."Add:Rd:Sudo:File"..v) then
db = "ملف ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(FRADM.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
Redis:set(FRADM.."Set:Rd"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FRADM.."Set:On"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
BanAll = 'محظور عام ,'
Redis:srem(FRADM.."BanAll:Groups",rep_idd) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,rep_idd).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(FRADM.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,rep_idd).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(FRADM.."SilentGroup:Group"..msg_chat_id,rep_idd) 
else
SilentGroup = ''
end
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
...
BanAll = 'محظور عام ,'
Redis:srem(FRADM.."BanAll:Groups",UserId_Info.id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(FRADM.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(FRADM.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
else
SilentGroup = ''
end
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
Redis:set(FRADM..'GetTexting:DevFRADM'..msg_chat_id..':'..senderr,true)
...
Redis:del(FRADM..'Texting:DevFRADM')
...
Redis:set(FRADM..msg.chat_id..senderr.."replace",true)
...
local list = Redis:smembers(FRADM.."Words:r")
for k,v in pairs(list) do
Redis:del(FRADM.."Word:Replace"..v)
end
Redis:del(FRADM.."Words:r")
...
for k,v in pairs(list) do 
cmdd = Redis:get(FRADM.."Word:Replace"..v)
txx = txx..k.." ⇿ "..v.." ◍ "..cmdd.."\n"
end
...
local list = Redis:smembers(FRADM.."List:Manager:inline"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(FRADM.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
Redis:del(FRADM.."Rd:Manager:inline:v"..v..msg_chat_id)
Redis:del(FRADM.."Rd:Manager:inline:link"..v..msg_chat_id)
Redis:del(FRADM.."List:Manager:inline"..msg_chat_id)
end
...
Redis:set(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") and tonumber(senderr) ~= tonumber(FRADM) then
if Redis:get(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "true" then
Redis:set(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"true1")
Redis:set(FRADM.."Text:Manager:inline"..senderr..":"..msg_chat_id, text)
Redis:del(FRADM.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
Redis:del(FRADM.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
Redis:del(FRADM.."Rd:Manager:inline:text"..text..msg_chat_id)
Redis:del(FRADM.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:sadd(FRADM.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,[[
...
if Redis:get(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id.."") == "true2" then
Redis:del(FRADM.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
Redis:del(FRADM.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
...
Redis:del(FRADM.."Rd:Manager:inline:text"..text..msg_chat_id)
Redis:del(FRADM.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:del(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id.."")
Redis:srem(FRADM.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id," ◍ تم حذف الرد من الردود الانلاين ","md",true)
return false
end
end
if Redis:get(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "true1" and tonumber(senderr) ~= tonumber(FRADM) then
Redis:del(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id)
Redis:set(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(FRADM.."Text:Manager:inline"..senderr..":"..msg_chat_id)
if msg.content.text then 
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FRADM.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then 
Redis:set(FRADM.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
Redis:set(FRADM.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
Redis:set(FRADM.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)
Redis:set(FRADM.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)
elseif msg.content.document then
Redis:set(FRADM.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)
elseif msg.content.animation then
Redis:set(FRADM.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
Redis:set(FRADM.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)
elseif msg.content.video then
Redis:set(FRADM.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)
Redis:set(FRADM.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
...
Redis:set(FRADM.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)
Redis:set(FRADM.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
end
send(msg_chat_id,msg_id," ◍ الان ارسل الكلام داخل الزر","md",true)
return false
end
end
if text and Redis:get(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "set_inline" then
Redis:set(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id, "set_link")
local anubis = Redis:get(FRADM.."Text:Manager:inline"..senderr..":"..msg_chat_id)
Redis:set(FRADM.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id," ◍ الان ارسل الرابط","md",true)
return false
end
if text and Redis:get(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "set_link" then
Redis:del(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id)
local anubis = Redis:get(FRADM.."Text:Manager:inline"..senderr..":"..msg_chat_id)
Redis:set(FRADM.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id," ◍ تم اضافه الرد بنجاح","md",true)
return false
end
if text and not Redis:get(FRADM.."Status:Reply:inline"..msg_chat_id) then
local btext = Redis:get(FRADM.."Rd:Manager:inline:text"..text..msg_chat_id)
local blink = Redis:get(FRADM.."Rd:Manager:inline:link"..text..msg_chat_id)
local anemi = Redis:get(FRADM.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
local veico = Redis:get(FRADM.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
local stekr = Redis:get(FRADM.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
local Texingt = Redis:get(FRADM.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
local photo = Redis:get(FRADM.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = Redis:get(FRADM.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = Redis:get(FRADM.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = Redis:get(FRADM.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
local document = Redis:get(FRADM.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = Redis:get(FRADM.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = Redis:get(FRADM.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = Redis:get(FRADM.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Texingt then 
local UserInfo = bot.getUser(senderr)
local NumMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalMsg = Total_message(NumMsg) 
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(FRADM..'Num:Message:Edit'..msg_chat_id..senderr) or 0
...
Redis:set(FRADM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"true2")
...
for k,v in pairs(list) do
if Redis:get(FRADM.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
db = "متحركه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
db = "بصمه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
db = "ملصق ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
db = "رساله ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
db = "صوره ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
db = "فيديو ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
db = "ملف ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
db = "اغنيه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
db = "بصمه فيديو ◍ "
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
local list = Redis:smembers(FRADM.."List:Manager:inline3am")
for k,v in pairs(list) do
Redis:del(FRADM.."Add:Rd:Manager:Gif:inline3am"..v) 
Redis:del(FRADM.."Add:Rd:Manager:Vico:inline3am"..v) 
Redis:del(FRADM.."Add:Rd:Manager:Stekrs:inline3am"..v) 
Redis:del(FRADM.."Add:Rd:Manager:Text:inline3am"..v) 
Redis:del(FRADM.."Add:Rd:Manager:Photo:inline3am"..v)
Redis:del(FRADM.."Add:Rd:Manager:Photoc:inline3am"..v)
Redis:del(FRADM.."Add:Rd:Manager:Video:inline3am"..v)
Redis:del(FRADM.."Add:Rd:Manager:Videoc:inline3am"..v)
Redis:del(FRADM.."Add:Rd:Manager:File:inline3am"..v)
Redis:del(FRADM.."Add:Rd:Manager:video_note:inline3am"..v)
Redis:del(FRADM.."Add:Rd:Manager:Audio:inline3am"..v)
Redis:del(FRADM.."Add:Rd:Manager:Audioc:inline3am"..v)
Redis:del(FRADM.."Rd:Manager:inline3am:v"..v)
Redis:del(FRADM.."Rd:Manager:inline3am:link"..v)
Redis:del(FRADM.."List:Manager:inline3am")
end
return send(msg_chat_id,msg_id," ◍ تم مسح قائمه الانلاين","md",true)
end
if text and Redis:get(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "set_link" then
Redis:del(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id)
local anubis = Redis:get(FRADM.."Text:Manager:inline3am"..senderr..":")
Redis:set(FRADM.."Rd:Manager:inline3am:link"..anubis, text)
send(msg_chat_id,msg_id," ◍ تم اضافه الرد بنجاح","md",true)
return false
end
if text and Redis:get(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "set_inline" then
Redis:set(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id, "set_link")
local anubis = Redis:get(FRADM.."Text:Manager:inline3am"..senderr..":")
Redis:set(FRADM.."Rd:Manager:inline3am:text"..anubis, text)
send(msg_chat_id,msg_id," ◍ الان ارسل الرابط","md",true)
return false
end
if Redis:get(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "true1" and tonumber(senderr) ~= tonumber(FRADM) then
Redis:del(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id)
Redis:set(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(FRADM.."Text:Manager:inline3am"..senderr..":")
if msg.content.text then 
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FRADM.."Add:Rd:Manager:Text:inline3am"..anubis, text)
elseif msg.content.sticker then 
Redis:set(FRADM.."Add:Rd:Manager:Stekrs:inline3am"..anubis, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
Redis:set(FRADM.."Add:Rd:Manager:Vico:inline3am"..anubis, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
Redis:set(FRADM.."Add:Rd:Manager:Audio:inline3am"..anubis, msg.content.audio.audio.remote.id)
Redis:set(FRADM.."Add:Rd:Manager:Audioc:inline3am"..anubis, msg.content.caption.text)
elseif msg.content.document then
Redis:set(FRADM.."Add:Rd:Manager:File:inline3am"..anubis, msg.content.document.document.remote.id)
elseif msg.content.animation then
Redis:set(FRADM.."Add:Rd:Manager:Gif:inline3am"..anubis, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
Redis:set(FRADM.."Add:Rd:Manager:video_note:inline3am"..anubis, msg.content.video_note.video.remote.id)
elseif msg.content.video then
Redis:set(FRADM.."Add:Rd:Manager:Video:inline3am"..anubis, msg.content.video.video.remote.id)
Redis:set(FRADM.."Add:Rd:Manager:Videoc:inline3am"..anubis, msg.content.caption.text)
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FRADM.."Add:Rd:Manager:Photo:inline3am"..anubis, idPhoto)
Redis:set(FRADM.."Add:Rd:Manager:Photoc:inline3am"..anubis, msg.content.caption.text)
end
send(msg_chat_id,msg_id," ◍ الان ارسل الكلام داخل الزر","md",true)
return false
end
...
if text and text:match("^(.*)$") then
if Redis:get(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id.."") == "true2" then
if not Redis:sismember(FRADM.."List:Manager:inline3am", text) then
 Redis:del(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id.."")
 return send(msg_chat_id,msg_id," ◍ لا يوجد رد لهذه الكلمه","md",true)
end
Redis:del(FRADM.."Add:Rd:Manager:Gif:inline3am"..text) 
Redis:del(FRADM.."Add:Rd:Manager:Vico:inline3am"..text) 
Redis:del(FRADM.."Add:Rd:Manager:Stekrs:inline3am"..text) 
Redis:del(FRADM.."Add:Rd:Manager:Text:inline3am"..text) 
Redis:del(FRADM.."Add:Rd:Manager:Photo:inline3am"..text)
Redis:del(FRADM.."Add:Rd:Manager:Photoc:inline3am"..text)
Redis:del(FRADM.."Add:Rd:Manager:Video:inline3am"..text)
Redis:del(FRADM.."Add:Rd:Manager:Videoc:inline3am"..text)
Redis:del(FRADM.."Add:Rd:Manager:File:inline3am"..text)
Redis:del(FRADM.."Add:Rd:Manager:video_note:inline3am"..text)
Redis:del(FRADM.."Add:Rd:Manager:Audio:inline3am"..text)
Redis:del(FRADM.."Add:Rd:Manager:Audioc:inline3am"..text)
Redis:del(FRADM.."Rd:Manager:inline3am:text"..text)
Redis:del(FRADM.."Rd:Manager:inline3am:link"..text)
Redis:del(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id.."")
Redis:srem(FRADM.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id," ◍ تم حذف الرد من الردود الانلاين العامه","md",true)
return false
end
end
if text and text:match("^(.*)$") and tonumber(senderr) ~= tonumber(FRADM) then
if Redis:get(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "true" then
Redis:set(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,"true1")
Redis:set(FRADM.."Text:Manager:inline3am"..senderr..":", text)
Redis:del(FRADM.."Add:Rd:Manager:Gif:inline3am"..text) 
Redis:del(FRADM.."Add:Rd:Manager:Vico:inline3am"..text) 
Redis:del(FRADM.."Add:Rd:Manager:Stekrs:inline3am"..text) 
Redis:del(FRADM.."Add:Rd:Manager:Text:inline3am"..text) 
...
Redis:del(FRADM.."Rd:Manager:inline3am:text"..text)
Redis:del(FRADM.."Rd:Manager:inline3am:link"..text)
Redis:sadd(FRADM.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:set(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:get(FRADM.."Status:Reply:inline3am"..msg_chat_id) then
local btext = Redis:get(FRADM.."Rd:Manager:inline3am:text"..text)
local blink = Redis:get(FRADM.."Rd:Manager:inline3am:link"..text)
local anemi = Redis:get(FRADM.."Add:Rd:Manager:Gif:inline3am"..text) 
local veico = Redis:get(FRADM.."Add:Rd:Manager:Vico:inline3am"..text) 
local stekr = Redis:get(FRADM.."Add:Rd:Manager:Stekrs:inline3am"..text) 
local Texingt = Redis:get(FRADM.."Add:Rd:Manager:Text:inline3am"..text) 
local photo = Redis:get(FRADM.."Add:Rd:Manager:Photo:inline3am"..text)
local photoc = Redis:get(FRADM.."Add:Rd:Manager:Photoc:inline3am"..text)
local video = Redis:get(FRADM.."Add:Rd:Manager:Video:inline3am"..text)
local videoc = Redis:get(FRADM.."Add:Rd:Manager:Videoc:inline3am"..text)
local document = Redis:get(FRADM.."Add:Rd:Manager:File:inline3am"..text)
local audio = Redis:get(FRADM.."Add:Rd:Manager:Audio:inline3am"..text)
local audioc = Redis:get(FRADM.."Add:Rd:Manager:Audioc:inline3am"..text)
local video_note = Redis:get(FRADM.."Add:Rd:Manager:video_note:inline3am"..text)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FRADM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,"true2")
return send(msg_chat_id,msg_id," ◍ ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
end 
...
text = " ◍ قائمه الردود الانلاين \n══════× َ𝙏ِ𝘪َِ𝘎َِ𝘦َِ𝘳 ×══════\n"
for k,v in pairs(list) do
if Redis:get(FRADM.."Add:Rd:Manager:Gif:inline3am"..v) then
db = "متحركه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Vico:inline3am"..v) then
db = "بصمه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Stekrs:inline3am"..v) then
db = "ملصق ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Text:inline3am"..v) then
db = "رساله ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Photo:inline3am"..v) then
db = "صوره ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Video:inline3am"..v) then
db = "فيديو ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:File:inline3am"..v) then
db = "ملف ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:Audio:inline3am"..v) then
db = "اغنيه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Manager:video_note:inline3am"..v) then
db = "بصمه فيديو ◍ "
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and senderr ~= FRADM then
local test = Redis:get(FRADM.."Text:Sudo:Bot"..senderr..":"..msg_chat_id)
if Redis:get(FRADM.."Set:Rd:mz"..senderr..":"..msg_chat_id) == "true1" then
Redis:del(FRADM.."Set:Rd:mz"..senderr..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FRADM.."Add:Rd:Sudo:mz:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(FRADM.."Add:Rd:Sudo:mz:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(FRADM.."Add:Rd:Sudo:mz:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(FRADM.."Add:Rd:Sudo:mz:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(FRADM.."Add:Rd:Sudo:mz:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(FRADM.."Add:Rd:Sudo:mz:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(FRADM.."Add:Rd:Sudo:mz:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(FRADM.."Add:Rd:Sudo:mz:Video"..test, msg.content.video.video.remote.id)  
Redis:set(FRADM.."Add:Rd:Sudo:mz:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(FRADM.."Add:Rd:Sudo:mz:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FRADM.."Add:Rd:Sudo:mz:Photo"..test, idPhoto)  
Redis:set(FRADM.."Add:Rd:Sudo:mz:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(FRADM.."Set:Rd:mz"..senderr..":"..msg_chat_id) == "true" then
Redis:set(FRADM.."Set:Rd:mz"..senderr..":"..msg_chat_id, "true1")
Redis:set(FRADM.."Text:Sudo:Bot"..senderr..":"..msg_chat_id, text)
Redis:sadd(FRADM.."List:Rd:Sudo:mz", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(FRADM.."Set:On:mz"..senderr..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(FRADM..''..v..text)
end
Redis:del(FRADM.."Set:On:mz"..senderr..":"..msg_chat_id)
Redis:srem(FRADM.."List:Rd:Sudo:mz", text)
...
local listmz = Redis:smembers(FRADM.."List:Rd:Sudo:mz")
...
if x then
local anemi = Redis:get(FRADM.."Add:Rd:Sudo:mz:Gif"..x)   
local veico = Redis:get(FRADM.."Add:Rd:Sudo:mz:vico"..x)   
local stekr = Redis:get(FRADM.."Add:Rd:Sudo:mz:stekr"..x)     
local Text = Redis:get(FRADM.."Add:Rd:Sudo:mz:Text"..x)   
local photo = Redis:get(FRADM.."Add:Rd:Sudo:mz:Photo"..x)
local photoc = Redis:get(FRADM.."Add:Rd:Sudo:mz:Photoc"..x)
local video = Redis:get(FRADM.."Add:Rd:Sudo:mz:Video"..x)
local videoc = Redis:get(FRADM.."Add:Rd:Sudo:mz:Videoc"..x)
local document = Redis:get(FRADM.."Add:Rd:Sudo:mz:File"..x)
local audio = Redis:get(FRADM.."Add:Rd:Sudo:mz:Audio"..x)
local audioc = Redis:get(FRADM.."Add:Rd:Sudo:mz:Audioc"..x)
local video_note = Redis:get(FRADM.."Add:Rd:Sudo:mz:video_note"..x)
if Text then 
local UserInfo = bot.getUser(senderr)
local NumMsg = Redis:get(FRADM..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalMsg = Total_message(NumMsg)
...
Redis:sadd(FRADM.."Spam:Group"..senderr,text) 
end
if photo then
...
Redis:set(FRADM.."Set:Rd:mz"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FRADM.."Set:On:mz"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:sismember(FRADM.."Spam:Group"..senderr,text) then
Redis:del(FRADM.."Spam:Group"..senderr) 
end
...
local list = Redis:smembers(FRADM.."List:Rd:Sudo:mz")
for k,v in pairs(list) do
Redis:del(FRADM.."Add:Rd:Sudo:mz:Gif"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:vico"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:stekr"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:Text"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:Photo"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:Photoc"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:Video"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:Videoc"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:File"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:Audio"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:Audioc"..v)
Redis:del(FRADM.."Add:Rd:Sudo:mz:video_note"..v)
Redis:del(FRADM.."List:Rd:Sudo:mz")
end
...
for k,v in pairs(list) do
if Redis:get(FRADM.."Add:Rd:Sudo:mz:Gif"..v) then
db = "متحركه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:vico"..v) then
db = "بصمه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:stekr"..v) then
db = "ملصق ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:Text"..v) then
db = "رساله ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:Photo"..v) then
db = "صوره ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:Video"..v) then
db = "فيديو ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:File"..v) then
db = "ملف ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:Audio"..v) then
db = "اغنيه ◍ "
elseif Redis:get(FRADM.."Add:Rd:Sudo:mz:video_note"..v) then
db = "بصمه فيديو ◍ "
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
Redis:del(FRADM..senderr..msg.chat_id.."num")
...
Redis:set(FRADM.."hms:"..testhms.."chat_id", msg_chat_id)
Redis:set(FRADM.."hms:"..testhms.."to", Message_Reply.sender_id.user_id)
Redis:set(FRADM.."hms:"..testhms.."msg_id",msg.reply_to_message_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FRADM.."Num:User:Pv")   
local x = 0
for k,v in pairs(list) do  
local Get_Chat = bot.getChat(v)
...
x = x + 1
Redis:srem(FRADM..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = bot.getChat(v)
if Get_Chat.id then
local statusMem = bot.getChatMember(Get_Chat.id,FRADM)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
send(Get_Chat.id,0,'* ◍ البوت عضو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(FRADM..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(FRADM..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(FRADM..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(FRADM..'ChekBotAdd',v)
bot.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:del(FRADM.."Num:Add:Games"..msg.chat_id..senderr)
...
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تن','تنزيل الكل')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مس','مسح تعديلاتي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ن','نقاطي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'س','اسالني')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ل','لغز')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مع','معاني')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ح','حزوره')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رف','رفع القيود')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الغ','الغاء حظر')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ث','تثبيت')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','كشف')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تاك للكل')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنز','تنزيل جميع الرتب')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قق','قفل الاشعارات')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف','فتح الاشعارات')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مر','مسح رد')
Redis:set(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','اضف امر')
...
Redis:sadd(FRADM.."Command:List:Group"..msg_chat_id.."",v)
end
return send(msg_chat_id,msg_id,[[*
...
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تن','تنزيل الكل')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مس','مسح تعديلاتي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ن','نقاطي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'س','اسالني')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ل','لغز')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مع','مغاني')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ح','حزوره')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رف','رفع القيود')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الغ','الغاء حظر')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ث','تثبيت')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','كشف')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تاك للكل')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنزل','تنزيل جميع الرتب')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قق','قفل الاشعارات')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف','فتح الاشعارات')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مر','مسح رد')
Redis:del(FRADM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','اضف امر')
return send(msg_chat_id,msg_id,[[*
 ◍ تم استعاده الاوامر
*]],"md")
end
...
Redis:set(FRADM.."hms:"..msg_user_send_id, testhms[1])
return send(msg_user_send_id,msg_id,' ◍ ارسل الهمسه الان',"md",true)  
end
elseif not text:match("(.*)start(.*)") and Redis:get(FRADM.."hms:"..msg_user_send_id) then
local testhms = Redis:get(FRADM.."hms:"..msg_user_send_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FRADM.."hms:"..testhms.."text:", text)
...
local photo = bot.getUserProfilePhotos(FRADM)
local ban = bot.getUser(FRADM)
local bain = bot.getUser(senderr)
Usperos = (Redis:scard(FRADM..'Num:User:Pv') or 0)
Redis:sadd(FRADM..'Num:User:Pv',senderr)  
if not msg.Asasy then
if not Redis:get(FRADM.."Start:Bot") then
...
local CmdStart = '*\n.. ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ'.. 
'\n🎤╖ أهلآ بك عزيزي أنا بوت '..(Redis:get(FRADM.."Name:Bot") or "تايجر")..
...
return bot.sendText(msg_chat_id,msg_id,Redis:get(FRADM.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
local reply_markup = bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
...
Redis:set(FRADM.."broadcast",true)
...
Redis:setex(FRADM.."Change:Start:Bot"..senderr,300,true) 
...
if not msg.Asasy then
if Redis:get(FRADM.."TwaslBot") and not Redis:sismember(FRADM.."BaN:In:Tuasl",senderr) then
...
Redis:setex(FRADM.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(FRADM.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(FRADM..'BaN:In:Tuasl',Info_User)  
return send(msg_chat_id,msg_id,Reply_Status(Info_User,' ◍ تم حظره من تواصل البوت\n√').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(FRADM..'BaN:In:Tuasl',Info_User)  
...
Redis:sadd(FRADM.."eza3a",Token.."&"..FRADM)
Redis:set("@"..UserBot,FRADM.."&".."@"..UserBot.."$@"..UserSudo.."+"..Token)
Fx.FRADMbots.run(CallBackLua)