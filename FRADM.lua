...
FREDM = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..FREDM)
bot = Fx.FREDMbots.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=FREDM,token=Token}
chsource = Redis:get(FREDM..'chsource') or "M_O_D_Y_CH"
chdevolper = Redis:get(FREDM..'chdevolper') or "MohamedHelal_l"
function var(value)  
...
if v:match(".lua$") and not Redis:sismember(FREDM..'files',v) then
plugin = dofile("plugin/"..v)
if plugin and plugin.FREDM and msg then
results = plugin.FREDM(msg)
end
end
end
end
...
if src_files and src_files.FREDM and msg then
results = src_files.FREDM(msg)
end
end
end
end
...
shh = tostring(text)
if Redis:get(FREDM..'rmzsource') then
shh = shh:gsub(" ⚡ ",Redis:get(FREDM..'rmzsource'))
end
local listm = Redis:smembers(FREDM.."Words:r")
for k,v in pairs(listm) do
i ,j  = string.find(shh, v)
if j and i then
local x = string.sub(shh, i,j)
local neww = Redis:get(FREDM.."Word:Replace"..x)  
shh = shh:gsub(x,neww)
else
shh = shh
end
...
sh = tostring(text)
if Redis:get(FREDM..'rmzsource') then
sh = sh:gsub(" ⚡ ",Redis:get(FREDM..'rmzsource'))
end
local listm = Redis:smembers(FREDM.."Words:r")
for k,v in pairs(listm) do
...
if Redis:sismember(FREDM.."ControlAll:Groups",UserId) then
ControllerAll = true
end
end
...
mderall = false
local statuse = Redis:sismember(FREDM.."Specialall:Group",senderr)
if statuse then
mderall = true
end
return mderall
...
Status = 0
local Controll2 = Redis:sismember(FREDM.."ControlAll:Groups",UserId)
Devss = Redis:sismember(FREDM.."Devss:Groups",UserId) 
...
local Controll2 = Redis:sismember(FREDM.."ControlAll:Groups",UserId)
Dev = Redis:sismember(FREDM.."Dev:Groups",UserId) 
Devss = Redis:sismember(FREDM.."Devss:Groups",UserId) 
Ownerss = Redis:sismember(FREDM.."Ownerss:Group"..ChatId,UserId) 
SuperCreator = Redis:sismember(FREDM.."SuperCreator:Group"..ChatId,UserId) 
Creator = Redis:sismember(FREDM.."Creator:Group"..ChatId,UserId)
...
elseif Dev then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."Developer:Bot:Reply"..ChatId) or 'المطور القميل'
elseif Ownerss then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."PresidentQ:Group:Reply"..ChatId) or  'صاحب الخرابه يواد'
elseif SuperCreator then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي عم الناس'
elseif Creator then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."Constructor:Group:Reply"..ChatId) or 'المنشئ روح قلبي'
elseif Manger then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."Manager:Group:Reply"..ChatId) or 'المدير العثل'
elseif Admin then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."Admin:Group:Reply"..ChatId) or 'الادمن القميل'
elseif StatusMember == "chatMemberStatusCreator" then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or 'مشرف المجموعه'
elseif Special then
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."Vip:Group:Reply"..ChatId) or 'المميز حبيبي الكل'
else
Status = Redis:get(FREDM..'SetRt'..ChatId..':'..UserId) or Redis:get(FREDM.."Mempar:Group:Reply"..ChatId) or 'العضو المسكين'
end  
return Status
end 
...
if Redis:sismember(FREDM.."SuperCreator:Group"..chat,useri)  then
TheBasicsz = "✅"
else
TheBasicsz = "❌"
end
if Redis:sismember(FREDM.."Creator:Group"..chat,useri) then
Originatorsz = "✅"
else
Originatorsz = "❌"
end
if Redis:sismember(FREDM.."Manger:Group"..chat,useri) then
Managersz = "✅"
else
Managersz = "❌"
end
if Redis:sismember(FREDM.."Admin:Group"..chat,useri) then
Addictivez = "✅"
else
Addictivez = "❌"
end
if Redis:sismember(FREDM.."Special:Group"..chat,useri) then
Distinguishedz = "✅"
else
Distinguishedz = "❌"
end
...
if Redis:sismember(FREDM.."chatMemberStatusRestricted"..chat,useri) then
Restricted = "✅"
else
Restricted = "❌"
end
if Redis:sismember(FREDM.."BanGroup"..chat,useri) then
BanGroup = "✅"
else
BanGroup = "❌"
end
if Redis:sismember(FREDM.."SilentGroup:Group"..chat,useri) then
SilentGroup = "✅"
else
SilentGroup = "❌"
end
...
if Redis:get(FREDM.."Lock:phshar"..ChatId) then    
alphsar = "✅"
else 
alphsar = "❌"    
end
if Redis:get(FREDM.."Lock:alkfr"..ChatId) then    
alkfr = "✅"
else 
alkfr = "❌"    
end
if Redis:get(FREDM.."Lock:tphlesh"..ChatId) then    
tphlesh = "✅"
else 
tphlesh = "❌"    
end
if Redis:get(FREDM.."Lock:farsia"..ChatId) then    
farsia = "✅"
else 
farsia = "❌"    
end

if Redis:get(FREDM.."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❌"    
end
if Redis:get(FREDM.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❌"
end
if Redis:get(FREDM.."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❌ "    
end
if Redis:get(FREDM.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❌ "    
end    
if Redis:get(FREDM.."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❌ "    
end    
if Redis:get(FREDM.."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❌ "    
end
if Redis:get(FREDM.."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❌ "    
end
if Redis:hget(FREDM.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(FREDM.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(FREDM.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(FREDM.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❌ "     
end
if Redis:get(FREDM.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(FREDM.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(FREDM.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(FREDM.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(FREDM.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(FREDM.."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(FREDM.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(FREDM.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(FREDM.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(FREDM.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(FREDM.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(FREDM.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(FREDM.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(FREDM.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(FREDM.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(FREDM.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(FREDM.."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(FREDM.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(FREDM.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(FREDM.."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(FREDM.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(FREDM.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(FREDM.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(FREDM.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(FREDM.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(FREDM.."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(FREDM.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(FREDM.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(FREDM.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(FREDM.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(FREDM.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(FREDM.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(FREDM.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(FREDM.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(FREDM.."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(FREDM.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(FREDM.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(FREDM.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(FREDM.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(FREDM.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(FREDM.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(FREDM.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(FREDM.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(FREDM.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(FREDM.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(FREDM.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(FREDM.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
KtmAll = Redis:sismember(FREDM.."KtmAll:Groups",UserId) ,
BanAll = Redis:sismember(FREDM.."BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(FREDM.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(FREDM.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = bot.getChatMember(msg.chat_id,FREDM).status 
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(FREDM..'Chat:Channel:Join'..msg.chat_id)
if Channel then
...
JoinChannel = true
if not Redis:sismember(FREDM.."BotFree:Group:",msg.chat_id) then
local Channel = Redis:get(FREDM..'Channel:Join')
if Channel then
local url , res = https.request('https://api.telegram.org/bot'..Token..'/getchatmember?chat_id=@'..Channel..'&user_id='..senderr)
local ChannelJoin = JSON.decode(url)
if ChannelJoin.result.status == "left" then
...
--[[
if msg.content.voice_note and Redis:get(FREDM..msg_chat_id.."sound:cmd") then 
...
xname =  (Redis:get(FREDM.."Name:Bot") or "لـوفـاريـن") 
...
if tonumber(msg.sender_id.user_id) == tonumber(FREDM) then
return false
end 
if text == 'كانسل' and tonumber(senderr) == tonumber(1783964439) then
Redis:del(FREDM..msg.chat_id..'update:')
send(msg.chat_id,msg.id,"ضنن")
end
if Redis:get(FREDM..msg.chat_id..'update:') then
local msgg_idd = tonumber(Redis:get(FREDM..msg.chat_id..'update:'))
...
if Redis:sismember(FREDM.."SilentGroup:Group"..msg.chat_id,"xx"..tonumber(msg.sender_id.chat_id)) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end 
if Redis:get(FREDM.."Lock:SenderChat"..msg_chat_id) then
...
elseif Redis:sismember(FREDM.."Devss:Groups",senderr) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطـور الثانوي '
elseif Redis:sismember(FREDM.."Dev:Groups",senderr) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."Developer:Bot:Reply"..msg.chat_id) or 'المطور القميل'
elseif Redis:sismember(FREDM.."Ownerss:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."PresidentQ:Group:Reply"..msg.chat_id) or  'صاحب الخرابه يواد'
elseif Redis:sismember(FREDM.."SuperCreator:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي عم الناس'
elseif Redis:sismember(FREDM.."Creator:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ روح قلبي'
elseif Redis:sismember(FREDM.."Manger:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."Manager:Group:Reply"..msg.chat_id) or 'المدير القميل'
elseif Redis:sismember(FREDM.."Admin:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."Admin:Group:Reply"..msg.chat_id) or 'الادمن القميل'
elseif Redis:sismember(FREDM.."Special:Group"..msg.chat_id,senderr) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."Vip:Group:Reply"..msg.chat_id) or 'المميز حبيبي الكل'
elseif tonumber(senderr) == tonumber(FREDM) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(FREDM..'SetRt'..msg.chat_id..':'..senderr) or Redis:get(FREDM.."Mempar:Group:Reply"..msg.chat_id) or 'العضو المسكين'
end  
...
for v in io.popen('ls plugin'):lines() do
if Redis:sismember(FREDM..'files',v) then
state = "『 معطل 』"
else 
state = "『 مفعل 』"
end
...
if text then
local neww = Redis:get(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if neww then
text = neww or text
end
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(FREDM..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(FREDM..'Chat:Channel:Join'..msg.chat_id)}, },}}
...
if tonumber(FREDM) ~= tonumber(FilesJson.BotId) then
...
Y = Y + 1
Redis:sadd(FREDM..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(FREDM.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(FREDM.."SuperCreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(FREDM.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(FREDM.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(FREDM.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(FREDM.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(FREDM) then 
return send(msg_chat_id,msg_id,' ⚡ عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه\n√')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(FREDM.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(FREDM.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(FREDM.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(FREDM.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(FREDM.."SuperCreator:Group"..idg,idASAS)
end;end
end
...
if Redis:get(FREDM.."broadcast") then
...
Redis:setex(FREDM.."general:broadcast" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
if not Redis:get(FREDM.."Cape:group"..msg.chat_id) then
...
---------------------- Dev JABWA ----------------------
if Redis:get(FREDM.."set:chs"..senderr) then
if text then
if text == "الغاء" or text == "الغاء الامر" then
Redis:del(FREDM.."set:chs"..senderr)
return send(msg_chat_id,msg_id,'*⚡ تم الغاء الامر بنجاح ✅*',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(FREDM.."chsource",ch)
Redis:del(FREDM.."set:chs"..senderr)
...
Redis:set(FREDM.."set:chs"..senderr,true)
return send(msg_chat_id,msg_id,'*⚡ ارسل معرف القناه الان\n√*',"md",true)  
end
if Redis:get(FREDM.."set:rmz"..senderr) then
if text then
if text == "الغاء" or text == "الغاء الامر" then
Redis:del(FREDM.."set:rmz"..senderr)
return send(msg_chat_id,msg_id,'*تم الغاء الامر بنجاح ✅*',"md",true)  
end
Redis:set(FREDM..'rmzsource',text)
Redis:del(FREDM.."set:rmz"..senderr)
...
Redis:set(FREDM.."set:rmz"..senderr,true)
...
Redis:set(FREDM.."rmzsource"," ⚡ ")
return send(msg_chat_id,msg_id,'*• تم ارجاع رمز السورس الي { ⚡ }\n√*',"md",true)  
end
if Redis:get(FREDM.."set:devs"..senderr) then
if text then
if text == "الغاء" or text == "الغاء الامر" then
Redis:del(FREDM.."set:devs"..senderr)
return send(msg_chat_id,msg_id,'*تم الغاء الامر بنجاح ✅*',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(FREDM.."chdevolper",ch)
Redis:del(FREDM.."set:devs"..senderr)
...
Redis:set(FREDM.."set:devs"..senderr,true)
...
Redis:setex(FREDM.."Change:Source:Bot"..senderr,300,true) 
...
Redis:del(FREDM.."Source:Bot") 
return send(msg_chat_id,msg_id,"* ⚡ تم مسح رد الكليشة بنجاح\n√*","md",true)   
end
if text == (Redis:get(FREDM.."Bot:Name") or "لـوفـاريـن") then
local photo = bot.getUserProfilePhotos(FREDM)
if photo.total_count > 0 then
local NamesBot = (Redis:get(FREDM.."Bot:Name") or "لـوفـاريـن")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == (Redis:get(FREDM.."Name:Bot") or "لـوفـاريـن") then
local photo = bot.getUserProfilePhotos(FREDM)
if photo.total_count > 0 then
local NamesBot = (Redis:get(FREDM.."Name:Bot") or "لـوفـاريـن")
local Mostafa = {
'• مالك حبيبى 🥺',
'• مخصماك وبعد عني مش طيقاك 😹',
'• مبكلمكش 🥺',
...
local list = Redis:smembers(FREDM..'ChekBotAdd')  
...
local Dev = Redis:smembers(FREDM.."Dev:Groups")
local DevS = Redis:smembers(FREDM.."Devss:Groups")
local set_Json = '{"BotId": '..FREDM..',\n"Dev":['
...
for k,v in pairs(Dev) do 
if not Redis:sismember(FREDM.."Dev:Groups",v) then
Redis:sadd(FREDM.."Dev:Groups",v)
end
end
for k,v in pairs(DevS) do 
if not Redis:sismember(FREDM.."Devss:Groups",v) then
Redis:sadd(FREDM.."Devss:Groups",v)
end
end
...
local Source = (Redis:get(FREDM.."Source:Bot") or "𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐈𝐍 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐎𝐕𝐀𝐑𝐄𝐍")
local Text = "* "..Source.." *"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
Redis:set(FREDM.."Reply:Source"..msg_chat_id,true) 
...
Redis:del(FREDM.."Reply:Source"..msg_chat_id) 
...
Redis:set(FREDM.."reply:on"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FREDM.."reply:of"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local app = Redis:smembers(FREDM.."app:reply:Source")
for k,v in pairs(app) do
Redis:del(FREDM.."Add:reply:Source:Gif"..v)   
Redis:del(FREDM.."Add:reply:Source:vico"..v)   
Redis:del(FREDM.."Add:reply:Source:stekr"..v)     
Redis:del(FREDM.."Add:reply:Source:Text"..v)   
Redis:del(FREDM.."Add:reply:Source:Photo"..v)
Redis:del(FREDM.."Add:reply:Source:Video"..v)
Redis:del(FREDM.."Add:reply:Source:File"..v)
Redis:del(FREDM.."Add:reply:Source:Audio"..v)
Redis:del(FREDM.."Add:reply:Source:video_note"..v)
Redis:del(FREDM.."app:reply:Source")
end
...
text = "\n ⚡ قائمة ردود السورس ⇞⇟\nꔹ━━━━━ꔹ𝐋𝐎𝐕𝐀𝐑𝐄𝐍ꔹ━━━━━ꔹ\n"
for k,v in pairs(app) do
if Redis:get(FREDM.."Add:reply:Source:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(FREDM.."Add:reply:Source:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(FREDM.."Add:reply:Source:stekr"..v) then
db = "ملصق 🧿"
elseif Redis:get(FREDM.."Add:reply:Source:Text"..v) then
db = "رساله ✉"
elseif Redis:get(FREDM.."Add:reply:Source:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(FREDM.."Add:reply:Source:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(FREDM.."Add:reply:Source:File"..v) then
db = "ملف ⚡ "
elseif Redis:get(FREDM.."Add:reply:Source:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(FREDM.."Add:reply:Source:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
local id = Redis:get(FREDM.."id:JABWA:Groups")
...
---------------------- Dev JABWA ----------------------
if (Redis:get(FREDM.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ❌' then   
Redis:del(FREDM.."AddSudosNew"..msg_chat_id)
...
Redis:setex(FREDM..'welcom_ph:witting'..senderr,300,true) 
...
Redis:set(FREDM..'Num:Add:Bot',text:match("تعيين عدد الاعضاء (%d+)$") ) 
...
local JABWA = "*• عدد المشتركين -> "..(Redis:scard(FREDM..'Num:User:Pv') or 0).." 🥺❤️\n√*"
send(msg_chat_id,msg_id, JABWA,"md",true)   
end
...
local JABWA = "*• عدد الجروبات -> "..(Redis:scard(FREDM..'ChekBotAdd') or 0).." 🥺❤️\n√*"
send(msg_chat_id,msg_id, JABWA,"md",true)   
end
...
local JABWA = "*• عدد الجروبات -> "..(Redis:scard(FREDM..'ChekBotAdd') or 0).." 🥺❤️\n• عدد المشتركين -> "..(Redis:scard(FREDM..'Num:User:Pv') or 0).." 🥺❤️\n√*"
send(msg_chat_id,msg_id, JABWA,"md",true)   
end
---------------------- Dev JABWA ----------------------
if text == "تفعيل" then
...
if Redis:sismember(FREDM..'Black:listBan:',msg_chat_id) then
return send(msg_chat_id,msg_id,"* ⚡ عذرآ الجروب محظوره من التفعيل *","md",true)  
end
if Redis:sismember(FREDM.."ChekBotAdd",msg_chat_id) then
return send(msg_chat_id,msg_id,'* • الجروب مفعل من قبل\n√*',"md",true)  
end
Redis:sadd(FREDM.."ChekBotAdd",msg_chat_id)
...
if Info_Members.members[k].status.FREDMbots == "chatMemberStatusCreator" then
...
Redis:sadd(FREDM.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:srem(FREDM.."ChekBotAdd",msg_chat_id)
Redis:del(FREDM.."Admin:Group"..msg_chat_id) 
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local Text = "*• تم تعطيل جروب "..Get_Chat.title.."\n• وتنزيل الادمن من الرتبه\n√*"
if not Redis:sismember(FREDM.."ChekBotAdd",msg_chat_id) then
...
---------------------- Dev JABWA ----------------------
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(FREDM.."ChekBotAdd",msg_chat_id) then
Redis:incr(FREDM..'Num:Message:User'..msg.chat_id..':'..senderr) 

if text then
local GetMsg = Redis:incr(FREDM..'Num:Message:User'..msg.chat_id..':'..senderr) 
Redis:hset(FREDM..':GroupUserCountMsg:'..msg.chat_id,senderr,GetMsg)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(FREDM..':GroupNameUser:'..msg.chat_id,senderr,NameLUser)
end
---------------------- Dev JABWA ----------------------
if text == "ترند" then
...
GroupAllRtba = Redis:hgetall(FREDM..':GroupUserCountMsg:'..msg.chat_id)
GetAllNames  = Redis:hgetall(FREDM..':GroupNameUser:'..msg.chat_id)
GroupAllRtbaL = {}
...
GroupAllRtba = Redis:hgetall(FREDM..':GroupUserCountMsg:groups')
GetAllNames  = Redis:hgetall(FREDM..':GroupNameUser:groups')
GroupAllRtbaL = {}
for k,v in pairs(GroupAllRtba) do table.insert(GroupAllRtbaL,{v,k}) end
Count,Kount,i = 8 , 0 , 1
for _ in pairs(GroupAllRtbaL) do Kount = Kount + 1 end
...
local GetMsg = Redis:incr(FREDM..'FREDM:MsgNumbergroups'..msg.chat_id) or 1
Redis:hset(FREDM..':GroupUserCountMsg:groups',msg.chat_id,GetMsg)
end
...
Redis:sadd(FREDM.."Black:listBan:",Chatid)
...
Redis:srem(FREDM.."Black:listBan:",Chatid)
...
if Redis:sismember(FREDM.."KtmAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⚡ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FREDM.."KtmAll:Groups",UserId_Info.id) 
...
local Groups = (Redis:scard(FREDM..'ChekBotAdd') or 0)
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if ban and ban.type and ban.type.FREDMbots == "userTypeBot" then
...
if Redis:sismember(FREDM.."KtmAll:Groups",Message_Reply.sender_id.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender_id.user_id,"⚡ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FREDM.."KtmAll:Groups",Message_Reply.sender_id.user_id) 
...
Redis:srem(FREDM.."KtmAll:Groups",rep_idd) 
...
Redis:srem(FREDM.."KtmAll:Groups",UserId) 
...
local Info_Members = Redis:smembers(FREDM.."KtmAll:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⚡ لا يوجد مكتومين عام حاليا , ","md",true)  
end
Redis:del(FREDM.."KtmAll:Groups") 
...
Redis:set(FREDM.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(FREDM.."gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⚡ ارسل السؤال الان\n√")
end
...
local list = Redis:smembers(FREDM.."gamebot:new1")
t = " ⚡ الاسئله المضافه \n"
for k,v in pairs(list) do
t = t..""..k.." ⚡ -> ( "..v.." )\n"
end
...
Redis:set(FREDM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and Redis:get(FREDM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id) == "true" then
Redis:del(FREDM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:sadd(FREDM.."joke:", text)
...
Redis:set(FREDM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id, "rmjoke")
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and Redis:get(FREDM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id) == "rmjoke" then
Redis:del(FREDM.."Set:joke"..msg.sender_id.user_id..":"..msg_chat_id)
Redis:srem(FREDM.."joke:", text)
...
Redis:del(FREDM.."gamebot:new1")
return send(msg_chat_id,msg_id,"*⚡ تم مسح الاسئله\n√*","md")
end
if text == 'اسالني' then
if not Redis:get(FREDM.."Status:Games"..msg.chat_id) then
return false
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(FREDM..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(FREDM..'Chat:Channel:Join'..msg.chat_id)}, },}}
...
if not Redis:get(FREDM..'lock_geams'..msg.chat_id) then
local list = Redis:smembers(FREDM.."gamebot:new1")
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(FREDM.."gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(FREDM.."gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(FREDM.."gamebot:newqus:as3"..quschen)
local ansar0 = Redis:get(FREDM.."gamebot:newqus:as0"..quschen)
local ansar4 = Redis:get(FREDM.."gamebot:newqus:as4"..quschen)
...
Redis:set(FREDM.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,true)
...
Redis:set(FREDM.."lkz:gamebot:new"..msg.sender_id.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id," ⚡ ارسل اللغز الان\n√")
end
...
local list = Redis:smembers(FREDM.."lkz:gamebot:new1")
t = " ⚡ الالغاز "
for k,v in pairs(list) do
t = t..""..k.." ⚡ -> ("..v.." )\n"
end
...
Redis:del(FREDM.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(FREDM.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(FREDM.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(FREDM.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(FREDM.."lkz:gamebot:newqus:as4"..quschen)
if ansar1 == ansar4 then
testt = 'ansar1'
elseif ansar2 == ansar4 then
testt = 'ansar2'
...
---------------------- Dev JABWA ----------------------
if Redis:get(FREDM..'Set:array'..senderr..':'..msg_chat_id) == 'true1' then
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
local test = Redis:get(FREDM..'Text:array'..senderr..':'..msg_chat_id..'')
Redis:sadd(FREDM.."Add:Rd:array:Text"..test,text)  
_key = {
...
if text then
if Redis:get(FREDM.."Set:array:Ssd"..senderr..":"..msg_chat_id) == 'dttd' then
Redis:del(FREDM.."Set:array:Ssd"..senderr..":"..msg_chat_id)
gery = Redis:get(FREDM.."Set:array:addpu"..senderr..":"..msg_chat_id)
if not Redis:sismember(FREDM.."Add:Rd:array:Text"..gery,text) then
send(msg_chat_id, msg_id,'* ⚡ لا يوجد رد متعدد\n√*',"md",true)
return false
end
Redis:srem(FREDM.."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,'* ⚡ تم حذفه بنجاح\n√*',"md",true)
end
end
if text then
if Redis:get(FREDM.."Set:array:Ssd"..senderr..":"..msg_chat_id) == 'delrd' then
Redis:del(FREDM.."Set:array:Ssd"..senderr..":"..msg_chat_id)
if not Redis:sismember(FREDM..'List:array',text) then
send(msg_chat_id, msg_id,'* ⚡ لا يوجد رد متعدد\n√*',"md",true)
return false
end
Redis:set(FREDM.."Set:array:addpu"..senderr..":"..msg_chat_id,text)
Redis:set(FREDM.."Set:array:Ssd"..senderr..":"..msg_chat_id,"dttd")
...
Redis:set(FREDM.."Set:array:Ssd"..senderr..":"..msg_chat_id,"delrd")
return false 
end
if text then
if Redis:get(FREDM.."Set:array"..senderr..":"..msg_chat_id) == 'true' then
Redis:sadd(FREDM..'List:array', text)
Redis:set(FREDM..'Text:array'..senderr..':'..msg_chat_id, text)
send(msg_chat_id, msg_id,'*⚡ ارسل الرد الذي تريد اضافته\n√*',"md",true)
Redis:del(FREDM.."Set:array"..senderr..":"..msg_chat_id)
Redis:set(FREDM..'Set:array'..senderr..':'..msg_chat_id,'true1')
Redis:del(FREDM.."Add:Rd:array:Text"..text)   
return false
end
end

if text then
if Redis:get(FREDM.."Set:array:rd"..senderr..":"..msg_chat_id) == 'delrd' then
Redis:del(FREDM.."Set:array:rd"..senderr..":"..msg_chat_id)
Redis:del(FREDM.."Add:Rd:array:Text"..text)
Redis:srem(FREDM..'List:array', text)
...
send_inlin_key(msg_chat_id,"*⚡ ارسل الكلمه التي تريد حذفها\n√*",inlin,msg_id)
Redis:set(FREDM.."Set:array:rd"..senderr..":"..msg_chat_id,"delrd")
return false 
end
if text then
if  Redis:sismember(FREDM..'List:array',text) then
local list = Redis:smembers(FREDM.."Add:Rd:array:Text"..text)
...
local list = Redis:smembers(FREDM..'List:array')
...
local list = Redis:smembers(FREDM..'List:array')
for k,v in pairs(list) do
Redis:del(FREDM.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(FREDM..'List:array'..msg_chat_id)
end
...
Redis:set(FREDM.."Set:array"..senderr..":"..msg_chat_id,true)
return false
end
...
TotalMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
TotalMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..rep_idd) or 0
TotalMsgT = Total_message(TotalMsg) 
return send(msg_chat_id,msg_id," ⚡ التفاعل -> "..TotalMsgT, "md")
end
...
if Message_Reply.FREDMbots == "error" then
...
if not Redis:get(FREDM.."Status:Id"..msg_chat_id) then
return false
end
local UserInfo = bot.getUser(senderr)
...
local StatusMember = bot.getChatMember(msg_chat_id,senderr).status.FREDMbots
if (StatusMember == "chatMemberStatusCreator") then
...
if (StatusMember.status.FREDMbots == "chatMemberStatusCreator") then
local Lakb = ' '..Lakb..' '
else
Lakb = 'لا يوجد لك لقب'
end
local UserId = senderr
local Num = Redis:get(FREDM.."Num:Add:Games"..msg.chat_id..senderr) or 0
local Text = Redis:get(FREDM.."Num:Add:Memp"..msg.chat_id..senderr) or 0
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(FREDM..'Num:Message:Edit'..msg_chat_id..senderr) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(FREDM.."Num:Add:Games"..msg.chat_id..senderr) or 0
local NumAdd = Redis:get(FREDM.."Num:Add:Memp"..msg.chat_id..":"..senderr) or 0
local Texting = {
"〈 جمالك ده طبيعي يولا 🙈💗 〉",
...
Get_Is_Id = Redis:get(FREDM.."Set:Id:Groups") or Redis:get(FREDM.."Set:Id:Group"..msg_chat_id)
if Redis:get(FREDM.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
if photo.total_count > 0 then
if not msg.Special and Redis:get(FREDM..'idnotmem'..msg.chat_id)  then
return send(msg_chat_id,msg_id,
'*\n'..Description..'\n💎╖ ايدِيڪ ⇇ '..UserId..
'\n🐣╢ اسمڪ ⇇ '..nameuser..
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if UserInfo and UserInfo.type and UserInfo.type.FREDMbots == "userTypeBot" then
...
local RinkBot = Controller(msg_chat_id,rep_idd)
local TotalMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..rep_idd) or 0
local TotalEdit = Redis:get(FREDM..'Num:Message:Edit'..msg_chat_id..rep_idd) or 0
local TotalMsgT = Total_message(TotalMsg) 
if Redis:get(FREDM.."Status:IdPhoto"..msg_chat_id) then
if photo.total_count > 0 then
if not msg.Special and Redis:get(FREDM..'idnotmem'..msg.chat_id)  then
...
local TotalMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(FREDM..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
...
local RinkBot = Controller(msg_chat_id,UserId_Info.id)
local TotalMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(FREDM..'Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return send(msg_chat_id,msg_id,
'*\n🎭╖ الاسم ->* '..Text..
'*\n🗽╢ الايدي -> '..UserId..
...
local GetMemberStatus = bot.getChatMember(msg_chat_id,FREDM).status 
if GetMemberStatus.can_change_info then
change_info = '✅' else change_info = '❌'
end
if GetMemberStatus.can_delete_messages then
...
Redis:sadd(FREDM.."allM"..msg.chat_id, msg.id)
if Redis:get(FREDM.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(FREDM.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(FREDM.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(FREDM.."allM"..msg.chat_id)
...
Redis:del(FREDM.."allM"..msg.chat_id)
end
end
end
...
Redis:set(FREDM.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(FREDM.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(FREDM.."allM"..msg.chat_id)  
...
for k, v in pairs(List_Members) do
local UserInfo = bot.getUser(v.member_id.user_id)
if Info_Members.members[k].status.FREDMbots == "chatMemberStatusAdministrator" then
x = x + 1
Admin = ' ⇿〘  ادمن 〙'
else
Admin = " ⇿〘  عضو 〙"
...
local Bot_Name = (Redis:get(FREDM.."Name:Bot") or "لـوفـاريـن")
if text then
...
Redis:set(FREDM.."Lock:SenderChat"..msg_chat_id,true) 
...
Redis:del(FREDM.."Lock:SenderChat"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:phshar"..msg_chat_id,true) 
...
Redis:del(FREDM.."Lock:phshar"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:alkfr"..msg_chat_id,true) 
...
Redis:del(FREDM.."Lock:alkfr"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:english"..msg_chat_id,true) 
...
Redis:del(FREDM.."Lock:english"..msg_chat_id) 
send(msg_chat_id,msg_id,Reply_Status(senderr," ⚡ تم فتح الانكليزيه").unLock,"md",true)  
return false
end 
---------------------- Dev JABWA ----------------------
if text == "صورتي" then
if Redis:get(FREDM.."myphoto"..msg.chat_id) then
...
if Redis:get(FREDM.."hisphoto"..msg_chat_id) == "off" then
...
Redis:set(FREDM..'SOFI:Channe:Vip'..senderr,UserId)
...
if not Redis:get(FREDM..'SOFI:Channe:Vip'..senderr) then
...
Redis:del(FREDM..'SOFI:Channe:Vip'..senderr)
...
if Redis:get(FREDM..'SetChanneVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ⚡ تم الغاء حفظ قناتك *',"md",true)  
Redis:del(FREDM..'SetChanneVip'..senderr)
return false  
end 
Redis:del(FREDM..'SetChanneVip'..senderr)
Redis:set(FREDM..'SOFI:Channe:Vip'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FREDM..'SetChanneVip'..senderr,true)
return false
end
...
local rules = Redis:get(FREDM..'SOFI:Channe:Vip'..senderr)
bot.sendText(msg_chat_id,msg_id, rules,"html",true)
end
end
if Redis:get(FREDM..'SetGroupVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ⚡ تم الغاء حفظ جروبك *',"md",true)  
Redis:del(FREDM..'SetGroupVip'..senderr)
return false  
end 
Redis:del(FREDM..'SetGroupVip'..senderr)
Redis:set(FREDM..'SOFI:Group:Vip'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FREDM..'SetGroupVip'..senderr,true)
return false
end
if Redis:get(FREDM..'SetnameVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ⚡ تم الغاء حفظ اسمك 💥*',"md",true)  
Redis:del(FREDM..'SetnameVip'..senderr)
return false  
end 
Redis:del(FREDM..'SetnameVip'..senderr)
Redis:set(FREDM..'Game:name'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FREDM..'SetnameVip'..senderr,true)
return false
end
if Redis:get(FREDM..'SetSunniVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ⚡ تم الغاء حفظ سنك ⏺️ *',"md",true)  
Redis:del(FREDM..'SetSunniVip'..senderr)
return false  
end 
Redis:del(FREDM..'SetSunniVip'..senderr)
Redis:set(FREDM..'Game:Sunni'..senderr,text)
...
bot.sendText(msg_chat_id,msg_id,text,"md",false, false, false, false, reply_markup)
Redis:set(FREDM..'SetSunniVip'..senderr,true)
return false
end
if Redis:get(FREDM..'SetBotVip'..senderr) then 
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ⚡ تم الغاء حفظ بوتك 🤖 *',"md",true)  
Redis:del(FREDM..'SetBotVip'..senderr)
return false  
end 
Redis:del(FREDM..'SetBotVip'..senderr)
Redis:set(FREDM..'SOFI:Bot:Vip'..senderr,text)
...
Redis:set(FREDM.."Lock:tphlesh"..msg_chat_id,true) 
Redis:del(FREDM.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(FREDM.."Lock:tphlesh"..msg_chat_id)  
Redis:set(FREDM.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(FREDM.."Lock:farsia"..msg_chat_id,true) 
...
Redis:del(FREDM.."Lock:farsia"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:text"..msg_chat_id,true) 
...
Redis:set(FREDM.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(FREDM.."lockpin"..msg_chat_id,(bot.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(FREDM.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(FREDM.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(FREDM..''..lock..msg_chat_id,"del")    
end
...
Redis:set(FREDM.."Lock:AlUasat"..msg_chat_id,"del")  
...
Redis:del(FREDM.."Lock:AlUasat"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Animation"..msg_chat_id,"del")  
Redis:set(FREDM.."Lock:Photo"..msg_chat_id,"del")  
Redis:set(FREDM.."Lock:vico"..msg_chat_id,"del")  
Redis:set(FREDM.."Lock:Audio"..msg_chat_id,"del")  
Redis:set(FREDM.."Lock:Sticker"..msg_chat_id,"del")  
Redis:set(FREDM.."Lock:Video"..msg_chat_id,"del")  
...
Redis:del(FREDM.."Lock:Animation"..msg_chat_id)  
Redis:del(FREDM.."Lock:Photo"..msg_chat_id)  
Redis:del(FREDM.."Lock:vico"..msg_chat_id)  
Redis:del(FREDM.."Lock:Audio"..msg_chat_id)  
Redis:del(FREDM.."Lock:Sticker"..msg_chat_id)  
Redis:del(FREDM.."Lock:Video"..msg_chat_id)  
...
Redis:del(FREDM.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(FREDM.."Lock:text"..msg_chat_id)  
...
Redis:del(FREDM.."Lock:Join"..msg_chat_id)  
...
Redis:del(FREDM.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(FREDM.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(FREDM.."lockpin"..msg_chat_id)  
...
Redis:del(FREDM.."Lock:edit"..msg_chat_id) 
...
Redis:del(FREDM.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(FREDM..''..lock..msg_chat_id)    
end
...
Redis:hset(FREDM.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(FREDM.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(FREDM.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(FREDM.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(FREDM.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(FREDM.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Link"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:geam"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:set(FREDM.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:forward"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Document"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Contact"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Spam"..msg_chat_id)  
...
Redis:set(FREDM.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(FREDM.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(FREDM.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(FREDM.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(FREDM.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(FREDM.."Set:Link"..msg_chat_id..""..senderr,120,true) 
...
Redis:del(FREDM.."Group:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⚡ تم مسح الرابط\n√*","md",true)             
end
if text == "الرابط" then
if not Redis:get(FREDM.."Status:Link"..msg_chat_id) then
return send(msg_chat_id,msg_id,"* ⚡ تم تعطيل الرابط من قبل الادارة\n√*","md",true)
end 
local Get_Chat = bot.getChat(msg_chat_id)
local GetLink = Redis:get(FREDM.."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
Redis:set(FREDM.."Group:Link"..msg_chat_id,LinkGroup.invite_link) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {
...
Redis:setex(FREDM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr, 120, true)  
local textett =[[
...
local Welcome = Redis:get(FREDM.."Welcome:Groups")
if Welcome then 
...
Redis:del(FREDM.."Welcome:Groups") 
return send(msg_chat_id,msg_id,"* ⚡ تم ازالة الترحيب العام في المجموعات\n√*","md",true)   
end

if Redis:get(FREDM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr) then 
if text == "الغاء" then 
Redis:del(FREDM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
return send(msg_chat_id,msg_id,"* ⚡ تم الغاء حفظ الترحيب عام\n√*","md",true)   
end 
Redis:del(FREDM.."Welcome:Group:Set" .. msg_chat_id .. "" .. senderr)  
Redis:set(FREDM.."Welcome:Groups",text) 
...
Redis:setex(FREDM.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. senderr, 120, true)  
local textett =[[
 ⚡ ارسل لي الترحيب عام الان
 ⚡ تستطيع اضافة مايلي !
يمكنك استخدام الدوال الاتيه 
...
if not Redis:get(FREDM.."Status:Welcome"..msg_chat_id) then
return send(msg_chat_id,msg_id,"* ⚡ تم تعطيل الترحيب من قبل الادمنيه\n√*","md",true)
end 
local Welcome = Redis:get(FREDM.."Welcome:Group"..msg_chat_id)
if Welcome then 
return send(msg_chat_id,msg_id,Welcome,"md",true)   
else 
...
Redis:del(FREDM.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(FREDM.."Set:Rules:" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
Redis:del(FREDM.."Group:Rules"..msg_chat_id) 
return send(msg_chat_id,msg_id,"* ⚡ تم ازالة قوانين الجروب\n√*","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(FREDM.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(FREDM.."Set:Description:" .. msg_chat_id .. ":" .. senderr, 600, true) 
...
Redis:set(FREDM.."Chat:Photo"..msg_chat_id..":"..senderr,true) 
...
local list = Redis:smembers(FREDM.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(FREDM.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(FREDM.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(FREDM.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(FREDM..'FilterText'..msg_chat_id..':'..senderr,'true')
...
Redis:set(FREDM..'FilterText'..msg_chat_id..':'..senderr,'DelFilter')
return send(msg_chat_id,msg_id,'* ⚡ ارسل الان { ملصق ,متحركه ,صوره ,رساله }\n√*',"md",true)  
end
...
Redis:set(FREDM.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender_id.user_id,"true") 
...
Redis:set(FREDM.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender_id.user_id,"true") 
...
local list = Redis:smembers(FREDM.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(FREDM.."All:Get:Reides:Commands:Group"..v)
Redis:del(FREDM.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(FREDM.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(FREDM.."Command:Reids:Group"..msg_chat_id..":"..senderr,"true") 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FREDM.."Command:Reids:Group:Del"..msg_chat_id..":"..senderr,"true") 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FREDM.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(FREDM.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k.." ⇿『 "..v.." 』->『 "..Commands.." 』\n"
else
Command = Command..""..k.." ⇿『 "..v.." 』\n"
...
if Redis:get(FREDM.."Status:Link"..msg.chat_id) then
Statuslink = '✅' else Statuslink = '❌'
end
if Redis:get(FREDM.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '✅' else StatusWelcome = '❌'
end
if Redis:get(FREDM.."Status:Id"..msg.chat_id) then
StatusId = '✅' else StatusId = '❌'
end
if Redis:get(FREDM.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '✅' else StatusIdPhoto = '❌'
end
if Redis:get(FREDM.."Status:Reply"..msg.chat_id) then
StatusReply = '✅' else StatusReply = '❌'
end
if Redis:get(FREDM.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '✅' else StatusReplySudo = '❌'
end
if Redis:get(FREDM.."Status:BanId"..msg.chat_id)  then
StatusBanId = '✅' else StatusBanId = '❌'
end
if Redis:get(FREDM.."Status:SetId"..msg.chat_id) then
StatusSetId = '✅' else StatusSetId = '❌'
end
if Redis:get(FREDM.."Status:Games"..msg.chat_id) then
StatusGames = '✅' else StatusGames = '❌'
end
if Redis:get(FREDM.."Status:KickMe"..msg.chat_id) then
Statuskickme = '✅' else Statuskickme = '❌'
end
if Redis:get(FREDM.."Status:AddMe"..msg.chat_id) then
...
if Redis:sismember(FREDM.."Dev:Groups",rep_idd) then
dev = "المطور ،" 
else 
dev = "" 
end
if Redis:sismember(FREDM.."Ownerss:Group"..msg_chat_id, rep_idd) then
crrQ = "المالك ،" 
else 
crrQ = "" 
end
if Redis:sismember(FREDM.."SuperCreator:Group"..msg_chat_id, rep_idd) then
crr = "منشئ اساسي ،" 
else 
crr = "" 
end
if Redis:sismember(FREDM..'Creator:Group'..msg_chat_id, rep_idd) then
cr = "منشئ ،" 
else 
cr = "" 
end
if Redis:sismember(FREDM..'Manger:Group'..msg_chat_id, rep_idd) then
own = "مدير ،" 
else 
own = "" 
end
if Redis:sismember(FREDM..'Admin:Group'..msg_chat_id, rep_idd) then
mod = "ادمن ،" 
else 
mod = "" 
end
if Redis:sismember(FREDM..'Special:Group'..msg_chat_id, rep_idd) then
vip = "مميز ،" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(FREDM.."Devss:Groups",rep_idd)  then
Rink = 2
elseif Redis:sismember(FREDM.."Dev:Groups",rep_idd)  then
Rink = 3
elseif Redis:sismember(FREDM.."Ownerss:Group"..msg_chat_id, rep_idd) then
Rink = 4
elseif Redis:sismember(FREDM.."SuperCreator:Group"..msg_chat_id, rep_idd) then
Rink = 5
elseif Redis:sismember(FREDM.."Creator:Group"..msg_chat_id, rep_idd) then
Rink = 6
elseif Redis:sismember(FREDM.."Manger:Group"..msg_chat_id, rep_idd) then
Rink = 7
elseif Redis:sismember(FREDM.."Admin:Group"..msg_chat_id, rep_idd) then
Rink = 8
elseif Redis:sismember(FREDM.."Special:Group"..msg_chat_id, rep_idd) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(FREDM.."Devss:Groups",rep_idd)
Redis:srem(FREDM.."Dev:Groups",rep_idd)
Redis:srem(FREDM.."Ownerss:Group"..msg_chat_id, rep_idd)
Redis:srem(FREDM.."SuperCreator:Group"..msg_chat_id, rep_idd)
Redis:srem(FREDM.."Creator:Group"..msg_chat_id, rep_idd)
Redis:srem(FREDM.."Manger:Group"..msg_chat_id, rep_idd)
Redis:srem(FREDM.."Admin:Group"..msg_chat_id, rep_idd)
Redis:srem(FREDM.."Special:Group"..msg_chat_id, rep_idd)
...
if Redis:sismember(FREDM.."Devss:Groups",UserId_Info.id) then
devQ = "المطور الثانوي ،" 
else 
devQ = "" 
end
if Redis:sismember(FREDM.."Dev:Groups",UserId_Info.id) then
dev = "المطور ،" 
else 
dev = "" 
end
if Redis:sismember(FREDM.."Ownerss:Group"..msg_chat_id, UserId_Info.id) then
crrQ = "المالك ،" 
else 
crrQ = "" 
end
if Redis:sismember(FREDM.."SuperCreator:Group"..msg_chat_id, UserId_Info.id) then
crr = "منشئ اساسي ،" 
else 
crr = "" 
end
if Redis:sismember(FREDM..'Creator:Group'..msg_chat_id, UserId_Info.id) then
cr = "منشئ ،" 
else 
cr = "" 
end
if Redis:sismember(FREDM..'Manger:Group'..msg_chat_id, UserId_Info.id) then
own = "مدير ،" 
else 
own = "" 
end
if Redis:sismember(FREDM..'Admin:Group'..msg_chat_id, UserId_Info.id) then
mod = "ادمن ،" 
else 
mod = "" 
end
if Redis:sismember(FREDM..'Special:Group'..msg_chat_id, UserId_Info.id) then
vip = "مميز ،" 
else 
vip = ""
end
...
Rink = 1
elseif Redis:sismember(FREDM.."Devss:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(FREDM.."Dev:Groups",UserId_Info.id)  then
Rink = 3
elseif Redis:sismember(FREDM.."Ownerss:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(FREDM.."SuperCreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(FREDM.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(FREDM.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
elseif Redis:sismember(FREDM.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 8
elseif Redis:sismember(FREDM.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(FREDM.."Devss:Groups",UserId_Info.id)
Redis:srem(FREDM.."Dev:Groups",UserId_Info.id)
Redis:srem(FREDM.."Ownerss:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FREDM.."SuperCreator:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FREDM.."Creator:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FREDM.."Manger:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FREDM.."Admin:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(FREDM.."Special:Group"..msg_chat_id, UserId_Info.id)
elseif msg.Devss then
if Rink == 2 or Rink < 2 then
return send(msg_chat_id,msg_id,"\n* ⚡ لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  
end
...
Redis:del(FREDM.."SuperCreator:Group"..msg_chat_id)
Redis:del(FREDM.."Creator:Group"..msg_chat_id)
Redis:del(FREDM.."Manger:Group"..msg_chat_id)
Redis:del(FREDM.."Admin:Group"..msg_chat_id)
--Redis:del(FREDM.."Special:Group"..msg_chat_id)
...
Redis:hset(FREDM.."Spam:Group:User"..msg_chat_id ,"Num:Spam",Numbardel)  
...
Redis:del(FREDM..'Num:Message:User'..msg.chat_id..':'..senderr)
...
Redis:del(FREDM..'Num:Message:Edit'..msg.chat_id..senderr)
...
Redis:del(FREDM..'Num:Add:Memp'..msg.chat_id..':'..senderr)
...
send(msg_chat_id,msg_id,' ⚡ عدد رسائلك هنا *~ '..(Redis:get(FREDM..'Num:Message:User'..msg.chat_id..':'..senderr) or 1)..'*',"md",true)  
...
send(msg_chat_id,msg_id,' ⚡ عدد التعديلات هنا *~ '..(Redis:get(FREDM..'Num:Message:Edit'..msg.chat_id..senderr) or 0)..'*',"md",true)  
...
send(msg_chat_id,msg_id,' ⚡ عدد جهاتك المضافه هنا *~ '..(Redis:get(FREDM.."Num:Add:Memp"..msg.chat_id..":"..senderr) or 0)..'*',"md",true)  
...
Redis:setex(FREDM.."Redis:Id:Group"..msg.chat_id..""..senderr,240,true)  
return send(msg_chat_id,msg_id,[[*
...
Redis:del(FREDM.."Set:Id:Group"..msg.chat_id)
...
Redis:set(FREDM.."Set:Id:Group"..msg.chat_id,Text_Rand)
...
Redis:setex(FREDM.."Redis:Id:Groups"..msg.chat_id..""..senderr,240,true)  
return send(msg_chat_id,msg_id,[[*
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
, يمكنك الان الاضافه ،
...
local Info_Members = Redis:smembers(FREDM.."Devss:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⚡ لا يوجد مطورين ثانوين حاليا , ","md",true)  
end
Redis:del(FREDM.."Devss:Groups") 
...
local Info_Members = Redis:smembers(FREDM.."Dev:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"*⚡ لا يوجد مطورين حاليا\n√*","md",true)  
end
Redis:del(FREDM.."Dev:Groups") 
...
local Info_Memberss = Redis:smembers(FREDM.."Ownerss:Group"..msg_chat_id) 
if #Info_Memberss == 0 then
return send(msg_chat_id,msg_id," ⚡ لا يوجد المالكين حاليا , ","md",true)  
end
Redis:del(FREDM.."Ownerss:Group"..msg_chat_id) 
local Info_Members = bot.getSupergroupMembers(msg_chat_id, "Administrators", "*", 0, 200)
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
if Info_Members.members[k].bot_info == nil then
...
local Info_Members = Redis:smembers(FREDM.."SuperCreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FREDM.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FREDM.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FREDM.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FREDM.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FREDM.."BanAll:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⚡ لا يوجد محظورين عام حاليا , ","md",true)  
end
Redis:del(FREDM.."BanAll:Groups") 
...
local Info_Members = Redis:smembers(FREDM.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⚡ لا يوجد محظورين حاليا , ","md",true)  
end
Redis:del(FREDM.."BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(FREDM.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id," ⚡ لا يوجد مكتومين حاليا , ","md",true)  
end
Redis:del(FREDM.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(FREDM.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(FREDM.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(FREDM.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(FREDM.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(FREDM.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(FREDM.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(FREDM.."List:Manager"..msg_chat_id)
end
...
text = " ⚡ قائمه الردود \nꔹ━━━━━ꔹ𝐋𝐎𝐕𝐀𝐑𝐄𝐍ꔹ━━━━━ꔹ\n"
for k,v in pairs(list) do
if Redis:get(FREDM.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(FREDM.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(FREDM.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🧿"
elseif Redis:get(FREDM.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(FREDM.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(FREDM.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو ??"
elseif Redis:get(FREDM.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(FREDM.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
Redis:set(FREDM.."Set:Manager:rd"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FREDM.."Set:Manager:rd"..senderr..":"..msg_chat_id,"true2")
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FREDM.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(FREDM.."Add:Rd:Sudo:Gif"..v)   
Redis:del(FREDM.."Add:Rd:Sudo:vico"..v)   
Redis:del(FREDM.."Add:Rd:Sudo:stekr"..v)     
Redis:del(FREDM.."Add:Rd:Sudo:Text"..v)   
Redis:del(FREDM.."Add:Rd:Sudo:Photo"..v)
Redis:del(FREDM.."Add:Rd:Sudo:Video"..v)
Redis:del(FREDM.."Add:Rd:Sudo:File"..v)
Redis:del(FREDM.."Add:Rd:Sudo:Audio"..v)
Redis:del(FREDM.."Add:Rd:Sudo:video_note"..v)
Redis:del(FREDM.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \nꔹ━━━━━ꔹ𝐋𝐎𝐕𝐀𝐑𝐄𝐍ꔹ━━━━━ꔹ\n"
for k,v in pairs(list) do
if Redis:get(FREDM.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(FREDM.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(FREDM.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🧿"
elseif Redis:get(FREDM.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(FREDM.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(FREDM.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(FREDM.."Add:Rd:Sudo:File"..v) then
db = "ملف ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(FREDM.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
Redis:set(FREDM.."Set:Rd"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FREDM.."Set:On"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
BanAll = 'محظور عام ,'
Redis:srem(FREDM.."BanAll:Groups",rep_idd) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,rep_idd).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(FREDM.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,rep_idd).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(FREDM.."SilentGroup:Group"..msg_chat_id,rep_idd) 
else
SilentGroup = ''
end
bot.setChatMemberStatus(msg.chat_id,rep_idd,'restricted',{1,1,1,1,1,1,1,1,1})
...
BanAll = 'محظور عام ,'
Redis:srem(FREDM.."BanAll:Groups",UserId_Info.id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(FREDM.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,UserId_Info.id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(FREDM.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
else
SilentGroup = ''
end
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
Redis:set(FREDM..'GetTexting:DevFREDM'..msg_chat_id..':'..senderr,true)
...
Redis:del(FREDM..'Texting:DevFREDM')
...
Redis:set(FREDM..msg.chat_id..senderr.."replace",true)
...
local list = Redis:smembers(FREDM.."Words:r")
for k,v in pairs(list) do
Redis:del(FREDM.."Word:Replace"..v)
end
Redis:del(FREDM.."Words:r")
...
for k,v in pairs(list) do 
cmdd = Redis:get(FREDM.."Word:Replace"..v)
txx = txx..k.." ⇿ "..v.." ⚡ "..cmdd.."\n"
end
...
local list = Redis:smembers(FREDM.."List:Manager:inline"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(FREDM.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
Redis:del(FREDM.."Rd:Manager:inline:v"..v..msg_chat_id)
Redis:del(FREDM.."Rd:Manager:inline:link"..v..msg_chat_id)
Redis:del(FREDM.."List:Manager:inline"..msg_chat_id)
end
...
Redis:set(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") and tonumber(senderr) ~= tonumber(FREDM) then
if Redis:get(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "true" then
Redis:set(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"true1")
Redis:set(FREDM.."Text:Manager:inline"..senderr..":"..msg_chat_id, text)
Redis:del(FREDM.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
Redis:del(FREDM.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
Redis:del(FREDM.."Rd:Manager:inline:text"..text..msg_chat_id)
Redis:del(FREDM.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:sadd(FREDM.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,[[
...
if Redis:get(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id.."") == "true2" then
Redis:del(FREDM.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
Redis:del(FREDM.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
...
Redis:del(FREDM.."Rd:Manager:inline:text"..text..msg_chat_id)
Redis:del(FREDM.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:del(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id.."")
Redis:srem(FREDM.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id," ⚡ تم حذف الرد من الردود الانلاين ","md",true)
return false
end
end
if Redis:get(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "true1" and tonumber(senderr) ~= tonumber(FREDM) then
Redis:del(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id)
Redis:set(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(FREDM.."Text:Manager:inline"..senderr..":"..msg_chat_id)
if msg.content.text then 
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FREDM.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then 
Redis:set(FREDM.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
Redis:set(FREDM.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
Redis:set(FREDM.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)
Redis:set(FREDM.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)
elseif msg.content.document then
Redis:set(FREDM.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)
elseif msg.content.animation then
Redis:set(FREDM.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
Redis:set(FREDM.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)
elseif msg.content.video then
Redis:set(FREDM.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)
Redis:set(FREDM.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
...
Redis:set(FREDM.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)
Redis:set(FREDM.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
end
send(msg_chat_id,msg_id," ⚡ الان ارسل الكلام داخل الزر","md",true)
return false
end
end
if text and Redis:get(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "set_inline" then
Redis:set(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id, "set_link")
local anubis = Redis:get(FREDM.."Text:Manager:inline"..senderr..":"..msg_chat_id)
Redis:set(FREDM.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id," ⚡ الان ارسل الرابط","md",true)
return false
end
if text and Redis:get(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id) == "set_link" then
Redis:del(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id)
local anubis = Redis:get(FREDM.."Text:Manager:inline"..senderr..":"..msg_chat_id)
Redis:set(FREDM.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id," ⚡ تم اضافه الرد بنجاح","md",true)
return false
end
if text and not Redis:get(FREDM.."Status:Reply:inline"..msg_chat_id) then
local btext = Redis:get(FREDM.."Rd:Manager:inline:text"..text..msg_chat_id)
local blink = Redis:get(FREDM.."Rd:Manager:inline:link"..text..msg_chat_id)
local anemi = Redis:get(FREDM.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
local veico = Redis:get(FREDM.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
local stekr = Redis:get(FREDM.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
local Texingt = Redis:get(FREDM.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
local photo = Redis:get(FREDM.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = Redis:get(FREDM.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = Redis:get(FREDM.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = Redis:get(FREDM.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
local document = Redis:get(FREDM.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = Redis:get(FREDM.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = Redis:get(FREDM.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = Redis:get(FREDM.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Texingt then 
local UserInfo = bot.getUser(senderr)
local NumMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalMsg = Total_message(NumMsg) 
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(FREDM..'Num:Message:Edit'..msg_chat_id..senderr) or 0
...
Redis:set(FREDM.."Set:Manager:rd:inline"..senderr..":"..msg_chat_id,"true2")
...
for k,v in pairs(list) do
if Redis:get(FREDM.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
db = "متحركه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
db = "بصمه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
db = "ملصق ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
db = "رساله ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
db = "صوره ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
db = "فيديو ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
db = "ملف ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
db = "اغنيه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
db = "بصمه فيديو ⚡ "
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
local list = Redis:smembers(FREDM.."List:Manager:inline3am")
for k,v in pairs(list) do
Redis:del(FREDM.."Add:Rd:Manager:Gif:inline3am"..v) 
Redis:del(FREDM.."Add:Rd:Manager:Vico:inline3am"..v) 
Redis:del(FREDM.."Add:Rd:Manager:Stekrs:inline3am"..v) 
Redis:del(FREDM.."Add:Rd:Manager:Text:inline3am"..v) 
Redis:del(FREDM.."Add:Rd:Manager:Photo:inline3am"..v)
Redis:del(FREDM.."Add:Rd:Manager:Photoc:inline3am"..v)
Redis:del(FREDM.."Add:Rd:Manager:Video:inline3am"..v)
Redis:del(FREDM.."Add:Rd:Manager:Videoc:inline3am"..v)
Redis:del(FREDM.."Add:Rd:Manager:File:inline3am"..v)
Redis:del(FREDM.."Add:Rd:Manager:video_note:inline3am"..v)
Redis:del(FREDM.."Add:Rd:Manager:Audio:inline3am"..v)
Redis:del(FREDM.."Add:Rd:Manager:Audioc:inline3am"..v)
Redis:del(FREDM.."Rd:Manager:inline3am:v"..v)
Redis:del(FREDM.."Rd:Manager:inline3am:link"..v)
Redis:del(FREDM.."List:Manager:inline3am")
end
return send(msg_chat_id,msg_id," ⚡ تم مسح قائمه الانلاين","md",true)
end
if text and Redis:get(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "set_link" then
Redis:del(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id)
local anubis = Redis:get(FREDM.."Text:Manager:inline3am"..senderr..":")
Redis:set(FREDM.."Rd:Manager:inline3am:link"..anubis, text)
send(msg_chat_id,msg_id," ⚡ تم اضافه الرد بنجاح","md",true)
return false
end
if text and Redis:get(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "set_inline" then
Redis:set(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id, "set_link")
local anubis = Redis:get(FREDM.."Text:Manager:inline3am"..senderr..":")
Redis:set(FREDM.."Rd:Manager:inline3am:text"..anubis, text)
send(msg_chat_id,msg_id," ⚡ الان ارسل الرابط","md",true)
return false
end
if Redis:get(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "true1" and tonumber(senderr) ~= tonumber(FREDM) then
Redis:del(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id)
Redis:set(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(FREDM.."Text:Manager:inline3am"..senderr..":")
if msg.content.text then 
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FREDM.."Add:Rd:Manager:Text:inline3am"..anubis, text)
elseif msg.content.sticker then 
Redis:set(FREDM.."Add:Rd:Manager:Stekrs:inline3am"..anubis, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
Redis:set(FREDM.."Add:Rd:Manager:Vico:inline3am"..anubis, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
Redis:set(FREDM.."Add:Rd:Manager:Audio:inline3am"..anubis, msg.content.audio.audio.remote.id)
Redis:set(FREDM.."Add:Rd:Manager:Audioc:inline3am"..anubis, msg.content.caption.text)
elseif msg.content.document then
Redis:set(FREDM.."Add:Rd:Manager:File:inline3am"..anubis, msg.content.document.document.remote.id)
elseif msg.content.animation then
Redis:set(FREDM.."Add:Rd:Manager:Gif:inline3am"..anubis, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
Redis:set(FREDM.."Add:Rd:Manager:video_note:inline3am"..anubis, msg.content.video_note.video.remote.id)
elseif msg.content.video then
Redis:set(FREDM.."Add:Rd:Manager:Video:inline3am"..anubis, msg.content.video.video.remote.id)
Redis:set(FREDM.."Add:Rd:Manager:Videoc:inline3am"..anubis, msg.content.caption.text)
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FREDM.."Add:Rd:Manager:Photo:inline3am"..anubis, idPhoto)
Redis:set(FREDM.."Add:Rd:Manager:Photoc:inline3am"..anubis, msg.content.caption.text)
end
send(msg_chat_id,msg_id," ⚡ الان ارسل الكلام داخل الزر","md",true)
return false
end
...
if text and text:match("^(.*)$") then
if Redis:get(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id.."") == "true2" then
if not Redis:sismember(FREDM.."List:Manager:inline3am", text) then
 Redis:del(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id.."")
 return send(msg_chat_id,msg_id," ⚡ لا يوجد رد لهذه الكلمه","md",true)
end
Redis:del(FREDM.."Add:Rd:Manager:Gif:inline3am"..text) 
Redis:del(FREDM.."Add:Rd:Manager:Vico:inline3am"..text) 
Redis:del(FREDM.."Add:Rd:Manager:Stekrs:inline3am"..text) 
Redis:del(FREDM.."Add:Rd:Manager:Text:inline3am"..text) 
Redis:del(FREDM.."Add:Rd:Manager:Photo:inline3am"..text)
Redis:del(FREDM.."Add:Rd:Manager:Photoc:inline3am"..text)
Redis:del(FREDM.."Add:Rd:Manager:Video:inline3am"..text)
Redis:del(FREDM.."Add:Rd:Manager:Videoc:inline3am"..text)
Redis:del(FREDM.."Add:Rd:Manager:File:inline3am"..text)
Redis:del(FREDM.."Add:Rd:Manager:video_note:inline3am"..text)
Redis:del(FREDM.."Add:Rd:Manager:Audio:inline3am"..text)
Redis:del(FREDM.."Add:Rd:Manager:Audioc:inline3am"..text)
Redis:del(FREDM.."Rd:Manager:inline3am:text"..text)
Redis:del(FREDM.."Rd:Manager:inline3am:link"..text)
Redis:del(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id.."")
Redis:srem(FREDM.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id," ⚡ تم حذف الرد من الردود الانلاين العامه","md",true)
return false
end
end
if text and text:match("^(.*)$") and tonumber(senderr) ~= tonumber(FREDM) then
if Redis:get(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id) == "true" then
Redis:set(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,"true1")
Redis:set(FREDM.."Text:Manager:inline3am"..senderr..":", text)
Redis:del(FREDM.."Add:Rd:Manager:Gif:inline3am"..text) 
Redis:del(FREDM.."Add:Rd:Manager:Vico:inline3am"..text) 
Redis:del(FREDM.."Add:Rd:Manager:Stekrs:inline3am"..text) 
Redis:del(FREDM.."Add:Rd:Manager:Text:inline3am"..text) 
...
Redis:del(FREDM.."Rd:Manager:inline3am:text"..text)
Redis:del(FREDM.."Rd:Manager:inline3am:link"..text)
Redis:sadd(FREDM.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:set(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:get(FREDM.."Status:Reply:inline3am"..msg_chat_id) then
local btext = Redis:get(FREDM.."Rd:Manager:inline3am:text"..text)
local blink = Redis:get(FREDM.."Rd:Manager:inline3am:link"..text)
local anemi = Redis:get(FREDM.."Add:Rd:Manager:Gif:inline3am"..text) 
local veico = Redis:get(FREDM.."Add:Rd:Manager:Vico:inline3am"..text) 
local stekr = Redis:get(FREDM.."Add:Rd:Manager:Stekrs:inline3am"..text) 
local Texingt = Redis:get(FREDM.."Add:Rd:Manager:Text:inline3am"..text) 
local photo = Redis:get(FREDM.."Add:Rd:Manager:Photo:inline3am"..text)
local photoc = Redis:get(FREDM.."Add:Rd:Manager:Photoc:inline3am"..text)
local video = Redis:get(FREDM.."Add:Rd:Manager:Video:inline3am"..text)
local videoc = Redis:get(FREDM.."Add:Rd:Manager:Videoc:inline3am"..text)
local document = Redis:get(FREDM.."Add:Rd:Manager:File:inline3am"..text)
local audio = Redis:get(FREDM.."Add:Rd:Manager:Audio:inline3am"..text)
local audioc = Redis:get(FREDM.."Add:Rd:Manager:Audioc:inline3am"..text)
local video_note = Redis:get(FREDM.."Add:Rd:Manager:video_note:inline3am"..text)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FREDM.."Set:Manager:rd:inline3am"..senderr..":"..msg_chat_id,"true2")
return send(msg_chat_id,msg_id," ⚡ ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
end 
...
text = " ⚡ قائمه الردود الانلاين \nꔹ━━━━━ꔹ𝐋𝐎𝐕𝐀𝐑𝐄𝐍ꔹ━━━━━ꔹ\n"
for k,v in pairs(list) do
if Redis:get(FREDM.."Add:Rd:Manager:Gif:inline3am"..v) then
db = "متحركه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Vico:inline3am"..v) then
db = "بصمه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Stekrs:inline3am"..v) then
db = "ملصق ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Text:inline3am"..v) then
db = "رساله ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Photo:inline3am"..v) then
db = "صوره ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Video:inline3am"..v) then
db = "فيديو ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:File:inline3am"..v) then
db = "ملف ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:Audio:inline3am"..v) then
db = "اغنيه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Manager:video_note:inline3am"..v) then
db = "بصمه فيديو ⚡ "
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and senderr ~= FREDM then
local test = Redis:get(FREDM.."Text:Sudo:Bot"..senderr..":"..msg_chat_id)
if Redis:get(FREDM.."Set:Rd:mz"..senderr..":"..msg_chat_id) == "true1" then
Redis:del(FREDM.."Set:Rd:mz"..senderr..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FREDM.."Add:Rd:Sudo:mz:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(FREDM.."Add:Rd:Sudo:mz:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(FREDM.."Add:Rd:Sudo:mz:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(FREDM.."Add:Rd:Sudo:mz:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(FREDM.."Add:Rd:Sudo:mz:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(FREDM.."Add:Rd:Sudo:mz:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(FREDM.."Add:Rd:Sudo:mz:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(FREDM.."Add:Rd:Sudo:mz:Video"..test, msg.content.video.video.remote.id)  
Redis:set(FREDM.."Add:Rd:Sudo:mz:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(FREDM.."Add:Rd:Sudo:mz:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FREDM.."Add:Rd:Sudo:mz:Photo"..test, idPhoto)  
Redis:set(FREDM.."Add:Rd:Sudo:mz:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(FREDM.."Set:Rd:mz"..senderr..":"..msg_chat_id) == "true" then
Redis:set(FREDM.."Set:Rd:mz"..senderr..":"..msg_chat_id, "true1")
Redis:set(FREDM.."Text:Sudo:Bot"..senderr..":"..msg_chat_id, text)
Redis:sadd(FREDM.."List:Rd:Sudo:mz", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(FREDM.."Set:On:mz"..senderr..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(FREDM..''..v..text)
end
Redis:del(FREDM.."Set:On:mz"..senderr..":"..msg_chat_id)
Redis:srem(FREDM.."List:Rd:Sudo:mz", text)
...
local listmz = Redis:smembers(FREDM.."List:Rd:Sudo:mz")
...
if x then
local anemi = Redis:get(FREDM.."Add:Rd:Sudo:mz:Gif"..x)   
local veico = Redis:get(FREDM.."Add:Rd:Sudo:mz:vico"..x)   
local stekr = Redis:get(FREDM.."Add:Rd:Sudo:mz:stekr"..x)     
local Text = Redis:get(FREDM.."Add:Rd:Sudo:mz:Text"..x)   
local photo = Redis:get(FREDM.."Add:Rd:Sudo:mz:Photo"..x)
local photoc = Redis:get(FREDM.."Add:Rd:Sudo:mz:Photoc"..x)
local video = Redis:get(FREDM.."Add:Rd:Sudo:mz:Video"..x)
local videoc = Redis:get(FREDM.."Add:Rd:Sudo:mz:Videoc"..x)
local document = Redis:get(FREDM.."Add:Rd:Sudo:mz:File"..x)
local audio = Redis:get(FREDM.."Add:Rd:Sudo:mz:Audio"..x)
local audioc = Redis:get(FREDM.."Add:Rd:Sudo:mz:Audioc"..x)
local video_note = Redis:get(FREDM.."Add:Rd:Sudo:mz:video_note"..x)
if Text then 
local UserInfo = bot.getUser(senderr)
local NumMsg = Redis:get(FREDM..'Num:Message:User'..msg_chat_id..':'..senderr) or 0
local TotalMsg = Total_message(NumMsg)
...
Redis:sadd(FREDM.."Spam:Group"..senderr,text) 
end
if photo then
...
Redis:set(FREDM.."Set:Rd:mz"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FREDM.."Set:On:mz"..senderr..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:sismember(FREDM.."Spam:Group"..senderr,text) then
Redis:del(FREDM.."Spam:Group"..senderr) 
end
...
local list = Redis:smembers(FREDM.."List:Rd:Sudo:mz")
for k,v in pairs(list) do
Redis:del(FREDM.."Add:Rd:Sudo:mz:Gif"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:vico"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:stekr"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:Text"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:Photo"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:Photoc"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:Video"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:Videoc"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:File"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:Audio"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:Audioc"..v)
Redis:del(FREDM.."Add:Rd:Sudo:mz:video_note"..v)
Redis:del(FREDM.."List:Rd:Sudo:mz")
end
...
for k,v in pairs(list) do
if Redis:get(FREDM.."Add:Rd:Sudo:mz:Gif"..v) then
db = "متحركه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:vico"..v) then
db = "بصمه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:stekr"..v) then
db = "ملصق ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:Text"..v) then
db = "رساله ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:Photo"..v) then
db = "صوره ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:Video"..v) then
db = "فيديو ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:File"..v) then
db = "ملف ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:Audio"..v) then
db = "اغنيه ⚡ "
elseif Redis:get(FREDM.."Add:Rd:Sudo:mz:video_note"..v) then
db = "بصمه فيديو ⚡ "
end
text = text..""..k.." ⇿『 "..v.."』⇿『 "..db.." 』\n"
end
...
Redis:del(FREDM..senderr..msg.chat_id.."num")
...
Redis:set(FREDM.."hms:"..testhms.."chat_id", msg_chat_id)
Redis:set(FREDM.."hms:"..testhms.."to", Message_Reply.sender_id.user_id)
Redis:set(FREDM.."hms:"..testhms.."msg_id",msg.reply_to_message_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FREDM.."Num:User:Pv")   
local x = 0
for k,v in pairs(list) do  
local Get_Chat = bot.getChat(v)
...
local keys = Redis:keys(FREDM..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(FREDM..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(FREDM..'ChekBotAdd',v)
bot.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:del(FREDM.."Num:Add:Games"..msg.chat_id..senderr)
...
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تن','تنزيل الكل')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مس','مسح تعديلاتي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ن','نقاطي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'س','اسالني')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ل','لغز')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مع','معاني')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ح','حزوره')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رف','رفع القيود')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الغ','الغاء حظر')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ث','تثبيت')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','كشف')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تاك للكل')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنز','تنزيل جميع الرتب')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قق','قفل الاشعارات')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف','فتح الاشعارات')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مر','مسح رد')
Redis:set(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','اضف امر')
...
Redis:sadd(FREDM.."Command:List:Group"..msg_chat_id.."",v)
end
return send(msg_chat_id,msg_id,[[*
...
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تن','تنزيل الكل')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مس','مسح تعديلاتي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ن','نقاطي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'س','اسالني')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ل','لغز')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مع','مغاني')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ح','حزوره')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رف','رفع القيود')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الغ','الغاء حظر')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ث','تثبيت')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ك','كشف')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تت','تاك')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تاك للكل')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تغ','تغيير الايدي')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تنزل','تنزيل جميع الرتب')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قق','قفل الاشعارات')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف','فتح الاشعارات')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مر','مسح رد')
Redis:del(FREDM.."Get:Reides:Commands:Group"..msg_chat_id..":"..'امر','اضف امر')
return send(msg_chat_id,msg_id,[[*
 ⚡ تم استعاده الاوامر
*]],"md")
end
...
Redis:set(FREDM.."hms:"..msg_user_send_id, testhms[1])
return send(msg_user_send_id,msg_id,' ⚡ ارسل الهمسه الان',"md",true)  
end
elseif not text:match("(.*)start(.*)") and Redis:get(FREDM.."hms:"..msg_user_send_id) then
local testhms = Redis:get(FREDM.."hms:"..msg_user_send_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FREDM.."hms:"..testhms.."text:", text)
...
local photo = bot.getUserProfilePhotos(FREDM)
local ban = bot.getUser(FREDM)
local bain = bot.getUser(senderr)
Usperos = (Redis:scard(FREDM..'Num:User:Pv') or 0)
Redis:sadd(FREDM..'Num:User:Pv',senderr)  
if not msg.Asasy then
if not Redis:get(FREDM.."Start:Bot") then
...
local CmdStart = '*\n╗• مرحبا بك يا ⇿ '..Text..'\n╣• انا روبت حمايه اسمي ⇿ '..(Redis:get(FREDM.."Name:Bot") or "لـوفـاريـن *")..
...
return bot.sendText(msg_chat_id,msg_id,Redis:get(FREDM.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
local reply_markup = bot.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
...
Redis:set(FREDM.."broadcast",true)
...
Redis:setex(FREDM.."Change:Start:Bot"..senderr,300,true) 
...
if not msg.Asasy then
if Redis:get(FREDM.."TwaslBot") and not Redis:sismember(FREDM.."BaN:In:Tuasl",senderr) then
...
local Info_User = Redis:get(FREDM.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(FREDM..'BaN:In:Tuasl',Info_User)  
return send(msg_chat_id,msg_id,Reply_Status(Info_User,' ⚡ تم حظره من تواصل البوت\n√').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(FREDM..'BaN:In:Tuasl',Info_User)  
...
Redis:sadd(FREDM.."eza3a",Token.."&"..FREDM)
Redis:set("@"..UserBot,FREDM.."&".."@"..UserBot.."$@"..UserSudo.."+"..Token)
Fx.FREDMbots.run(CallBackLua)